import { g as B, f as N, h as E, s as _, i as C, j as m, N as w, k as V, l as u, F as j, S as M, C as H, m as L, T as U, n as f, p as F, q as I, t as S, u as O, v as P, w as D, x as G, y as W, z as K, A as q, B as J, D as Q, E as X, G as Y, H as Z, I as ee, J as te, d as re, c as oe, b as ie, K as ae, a as ne, L as le } from "./runtime-dom.esm-bundler-D2b0Kur0.js";
function se(e, t) {
  t === void 0 && (t = {});
  var r = t.insertAt;
...
function x(e, t) {
  ...
  if (V(r)) {
    ...
    (!e.render || e.render === w) && !e.ssrRender && !r.ssrRender && u(r.template) && (r.ssrRender = ge(r.template));
...
function g(e, t, r, o) {
  ...
  switch (l && (t.props = xe(t, c, l)), i) {
    ...
    case M:
      ...
      break;
    case j:
      t.slotScopeIds && (o = (o ? o + " " : "") + t.slotScopeIds.join(" ")), e("<!--[-->"), y(
        e,
        n,
        r,
        o
...
function ve(e, t, r, o) {
  ...
  if (o && (p += ` ${o}`), e(p + ">"), !I(i)) {
    let h = !1;
    a && (a.innerHTML ? (h = !0, e(a.innerHTML)) : a.textContent ? (h = !0, e(f(a.textContent))) : i === "textarea" && a.value && (h = !0, e(f(a.value)))), h || (l & 8 ? e(f(n)) : l & 16 && y(
      e,
      n,
      r,
      o
