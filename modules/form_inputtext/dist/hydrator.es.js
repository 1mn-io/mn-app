...
var S = { regex: { rules: { class: { pattern: /^\.([a-zA-Z][\w-]*)$/, resolve(r) {
  ...
  var l, i, d, a, c, s, g;
  let { preset: u, options: f } = o, p, h, v, b, $, P, W;
  if (y(u) && f.transform !== "strict") {
    let { primitive: q, semantic: F, extend: N } = u, j = F || {}, { colorScheme: L } = j, E = z(j, ["colorScheme"]), D = N || {}, { colorScheme: V } = D, M = z(D, ["colorScheme"]), A = L || {}, { dark: H } = A, Q = z(A, ["dark"]), U = V || {}, { dark: Z } = U, J = z(U, ["dark"]), T = y(q) ? this._toVariables({ primitive: q }, f) : {}, _ = y(E) ? this._toVariables({ semantic: E }, f) : {}, Y = y(Q) ? this._toVariables({ light: Q }, f) : {}, bo = y(H) ? this._toVariables({ dark: H }, f) : {}, oo = y(M) ? this._toVariables({ semantic: M }, f) : {}, Po = y(J) ? this._toVariables({ light: J }, f) : {}, To = y(Z) ? this._toVariables({ dark: Z }, f) : {}, [hr, br] = [(l = T.declarations) != null ? l : "", T.tokens], [vr, yr] = [(i = _.declarations) != null ? i : "", _.tokens || []], [kr, $r] = [(d = Y.declarations) != null ? d : "", Y.tokens || []], [Cr, xr] = [(a = bo.declarations) != null ? a : "", bo.tokens || []], [wr, Br] = [(c = oo.declarations) != null ? c : "", oo.tokens || []], [Sr, Rr] = [(s = Po.declarations) != null ? s : "", Po.tokens || []], [_r, Or] = [(g = To.declarations) != null ? g : "", To.tokens || []];
    p = this.transformCSS(r, hr, "light", "variable", f, t, n), h = br;
    let Pr = this.transformCSS(r, `${vr}${kr}`, "light", "variable", f, t, n), Tr = this.transformCSS(r, `${Cr}`, "dark", "variable", f, t, n);
    v = `${Pr}${Tr}`, b = [.../* @__PURE__ */ new Set([...yr, ...$r, ...xr])];
    ...
    $ = `${zr}${Nr}`, P = [.../* @__PURE__ */ new Set([...Br, ...Rr, ...Or])], W = B(u.css, { dt: K });
  }
  return { primitive: { css: p, tokens: h }, semantic: { css: v, tokens: b }, global: { css: $, tokens: P }, style: W };
}, getPreset({ name: r = "", preset: o = {}, options: e, params: t, set: n, defaults: l, selector: i }) {
  var d, a, c;
  let s, g, u;
  if (y(o) && e.transform !== "strict") {
    let f = r.replace("-directive", ""), p = o, { colorScheme: h, extend: v, css: b } = p, $ = z(p, ["colorScheme", "extend", "css"]), P = v || {}, { colorScheme: W } = P, q = z(P, ["colorScheme"]), F = h || {}, { dark: N } = F, j = z(F, ["dark"]), L = W || {}, { dark: E } = L, D = z(L, ["dark"]), V = y($) ? this._toVariables({ [f]: R(R({}, $), q) }, e) : {}, M = y(j) ? this._toVariables({ [f]: R(R({}, j), D) }, e) : {}, A = y(N) ? this._toVariables({ [f]: R(R({}, N), E) }, e) : {}, [H, Q] = [(d = V.declarations) != null ? d : "", V.tokens || []], [U, Z] = [(a = M.declarations) != null ? a : "", M.tokens || []], [J, T] = [(c = A.declarations) != null ? c : "", A.tokens || []], _ = this.transformCSS(f, `${H}${U}`, "light", "variable", e, n, l, i), Y = this.transformCSS(f, J, "dark", "variable", e, n, l, i);
    s = `${_}${Y}`, g = [.../* @__PURE__ */ new Set([...Q, ...Z, ...T])], u = B(b, { dt: K });
  }
...
var ke = 0;
function $e(r) {
  var o = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {}, e = lo(!1), t = lo(r), n = lo(null), l = te() ? window.document : void 0, i = o.document, d = i === void 0 ? l : i, a = o.immediate, c = a === void 0 ? !0 : a, s = o.manual, g = s === void 0 ? !1 : s, u = o.name, f = u === void 0 ? "style_".concat(++ke) : u, p = o.id, h = p === void 0 ? void 0 : p, v = o.media, b = v === void 0 ? void 0 : v, $ = o.nonce, P = $ === void 0 ? void 0 : $, W = o.first, q = W === void 0 ? !1 : W, F = o.onMounted, N = F === void 0 ? void 0 : F, j = o.onUpdated, L = j === void 0 ? void 0 : j, E = o.onLoad, D = E === void 0 ? void 0 : E, V = o.props, M = V === void 0 ? {} : V, A = function() {
  }, H = function(Z) {
    var J = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
    if (d) {
      var T = Io(Io({}, M), J), _ = T.name || f, Y = T.id || h, bo = T.nonce || P;
      n.value = d.querySelector('style[data-primevue-style-id="'.concat(_, '"]')) || d.getElementById(Y) || d.createElement("style"), n.value.isConnected || (t.value = Z || r, So(n.value, {
        ...
        media: b,
        nonce: bo
      }), q ? d.head.prepend(n.value) : d.head.appendChild(n.value), ne(n.value, "data-primevue-style-id", _), So(n.value, T), n.value.onload = function(oo) {
        return D?.(oo, {
          name: _
        });
...
`, rf = { root: Au, header: Iu, headerCell: Wu, columnTitle: Fu, row: Eu, bodyCell: Vu, footerCell: Mu, columnFooter: Hu, footer: Uu, columnResizer: Yu, resizeIndicator: Gu, sortIcon: Xu, loadingIcon: Ku, nodeToggleButton: qu, paginatorTop: Qu, paginatorBottom: Zu, colorScheme: Ju, css: of }, ef = { mask: { background: "{content.background}", color: "{text.muted.color}" }, icon: { size: "2rem" } }, tf = { loader: ef }, nf = Object.defineProperty, af = Object.defineProperties, df = Object.getOwnPropertyDescriptors, Go = Object.getOwnPropertySymbols, lf = Object.prototype.hasOwnProperty, cf = Object.prototype.propertyIsEnumerable, Xo = (r, o, e) => o in r ? nf(r, o, { enumerable: !0, configurable: !0, writable: !0, value: e }) : r[o] = e, Ko, sf = (Ko = ((r, o) => {
  ...
  return r;
})({}, bt), af(Ko, df({ components: { accordion: Ue, autocomplete: rt, avatar: dt, badge: pt, blockui: yt, breadcrumb: xt, button: St, card: zt, carousel: It, cascadeselect: Ut, checkbox: Xt, chip: on, colorpicker: an, confirmdialog: cn, confirmpopup: pn, contextmenu: $n, datatable: Mn, dataview: qn, datepicker: ha, dialog: Ca, divider: Ra, dock: Pa, drawer: Da, editor: Va, fieldset: Ga, fileupload: ri, floatlabel: ii, galleria: $i, iconfield: xi, iftalabel: Si, image: Ti, imagecompare: Ni, inlinemessage: Ii, inplace: Ei, inputchips: Ui, inputgroup: Gi, inputnumber: Qi, inputotp: od, inputtext: ed, knob: dd, listbox: md, megamenu: Bd, menu: Td, menubar: Id, message: Xd, metergroup: rl, multiselect: ul, orderlist: pl, organizationchart: yl, overlaybadge: $l, paginator: Sl, panel: Nl, panelmenu: Wl, password: Ul, picklist: Xl, popover: Ql, progressbar: rc, progressspinner: tc, radiobutton: ic, rating: cc, ripple: uc, scrollpanel: mc, select: Bc, selectbutton: _c, skeleton: Tc, slider: Ac, speeddial: Wc, splitbutton: Ec, splitter: Uc, stepper: os, steps: is, tabmenu: fs, tabs: ks, tabview: Rs, tag: Ts, terminal: Ls, textarea: As, tieredmenu: Hs, timeline: qs, toast: iu, togglebutton: uu, toggleswitch: mu, toolbar: bu, tooltip: ku, tree: _u, treeselect: Du, treetable: rf, virtualscroller: tf }, css: Cn }))), no = {
...
const Of = /* @__PURE__ */ Fr({
  ...
  setup(r) {
    ...
    }), r._p.f.listen("msg", async (e) => {
      e.type == "get_value" && r._p.f.call("msg", {
        type: e.type,
