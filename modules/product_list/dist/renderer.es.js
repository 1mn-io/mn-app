...
function pt(t, r) {
  let e = "";
  for (let a in t) {
    if (dt(a) || F(a) || r === "textarea" && a === "value" || // force as property (not rendered in SSR)
    a.startsWith("."))
      continue;
    const o = t[a];
    a.startsWith("^") && (a = a.slice(1)), a === "class" ? e += ` class="${wt(o)}"` : a === "style" ? e += ` style="${ht(o)}"` : a === "className" ? o != null && (e += ` class="${g(String(o))}"`) : e += gt(a, o, r);
  }
  return e;
}
function gt(t, r, e) {
...
function ft(t, r, e, a, o) {
  t("<!--teleport start-->");
  const i = o.appContext.provides[_], n = i.__teleportBuffers || (i.__teleportBuffers = {}), l = n[e] || (n[e] = []), c = l.length;
  let p;
  if (a)
