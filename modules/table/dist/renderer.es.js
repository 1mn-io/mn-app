import { h as B, i as z, g as N, j as E, k as _, l as b, N as w, m as V, p as u, F as j, S as M, C as H, q as L, T as O, v as f, x as S, y as P, z as U, A as F, B as I, n as D, D as G, E as K, G as W, H as q, I as J, J as Q, K as X, L as Y, M as Z, O as ee, P as te, d as re, a as oe, e as ie, t as ae, b as ne, s as le, Q as se } from "./style-inject.es-2b6UrUlG.js";
...
function pe(e, t) {
  ...
  for (const o in e) {
    if (de(o) || I(o) || t === "textarea" && o === "value")
      continue;
    const i = e[o];
    o === "class" ? r += ` class="${ue(i)}"` : o === "style" ? r += ` style="${ge(i)}"` : o === "className" ? r += ` class="${String(i)}"` : r += fe(o, i, t);
  }
  return r;
}
function fe(e, t, r) {
...
function x(e, t) {
  const r = e.type, { getBuffer: o, push: i } = C();
  if (V(r)) {
    let a = y(e);
    if (!r.props)
    ...
    (!e.render || e.render === w) && !e.ssrRender && !r.ssrRender && u(r.template) && (r.ssrRender = me(r.template));
...
function m(e, t, r, o) {
  ...
  switch (l && (t.props = xe(t, c, l)), i) {
    ...
    case j:
      ...
      break;
    default:
      a & 1 ? ye(e, t, r, o) : a & 6 ? e(T(t, r, o)) : a & 64 ? ze(e, t, r, o) : a & 128 && m(e, t.ssContent, r, o);
  }
}
function v(e, t, r, o) {
...
function ye(e, t, r, o) {
  ...
  if (o && (p += ` ${o}`), e(p + ">"), !U(i)) {
    let g = !1;
    a && (a.innerHTML ? (g = !0, e(a.innerHTML)) : a.textContent ? (g = !0, e(f(a.textContent))) : i === "textarea" && a.value && (g = !0, e(f(a.value)))), g || (l & 8 ? e(f(n)) : l & 16 && v(
      e,
      n,
      r,
      o
