import { q as B, p as N, h as E, s as _, u as z, x as w, N as y, y as V, z as u, F as M, S as j, C as U, A as H, B as L, D as g, E as O, G as P, H as C, I as F, J as I, n as D, K as W, L as G, M as K, O as q, P as J, Q, R as X, U as Y, V as Z, W as rr, X as er, d as tr, c as or, a as ar, t as ir, o as nr, Y as lr } from "./runtime-dom.esm-bundler-ChC2ihda.js";
function sr(r, e) {
  e === void 0 && (e = {});
  var t = e.insertAt;
...
function pr(r, e) {
  let t = "";
  for (let o in r) {
    if (dr(o) || F(o) || e === "textarea" && o === "value" || // force as property (not rendered in SSR)
    o.startsWith("."))
      continue;
    const a = r[o];
    o.startsWith("^") && (o = o.slice(1)), o === "class" || o === "className" ? t += ` class="${ur(a)}"` : o === "style" ? t += ` style="${hr(a)}"` : t += gr(o, a, e);
  }
  return t;
}
function gr(r, e, t) {
...
function x(r, e) {
  ...
  if (V(t)) {
    ...
    (!r.render || r.render === y) && !r.ssrRender && !t.ssrRender && u(t.template) && (t.ssrRender = vr(t.template));
...
function v(r, e, t, o) {
  ...
  switch (l && (e.props = xr(e, c, l)), a) {
    ...
    case M:
      ...
      break;
    default:
      i & 1 ? kr(r, e, t, o) : i & 6 ? r(T(e, t, o)) : i & 64 ? _r(r, e, t, o) : i & 128 && v(r, e.ssContent, t, o);
  }
}
function b(r, e, t, o) {
...
function kr(r, e, t, o) {
  ...
  if (o && (p += ` ${o}`), r(p + ">"), !P(a)) {
    let h = !1;
    i && (i.innerHTML ? (h = !0, r(i.innerHTML)) : i.textContent ? (h = !0, r(g(i.textContent))) : a === "textarea" && i.value && (h = !0, r(g(i.value)))), h || (l & 8 ? r(g(n)) : l & 16 && b(
      r,
      n,
      t,
      o
...
async function A(r, e = {}) {
  ...
  t.appContext = r._context, r.provide(_, e);
