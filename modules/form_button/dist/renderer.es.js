import { B as E, A as N, C as z, D as v, E as C, F as b, N as y, G as V, H as u, I as M, S as j, J as U, K as H, T as L, L as p, m as O, M as P, O as S, P as F, Q as I, s as W, y as D, R as G, U as K, V as J, W as Q, X, Y, Z, _ as q, $ as ee, a0 as te, x as re, d as ie, c as oe, a1 as ne } from "./runtime-dom.esm-bundler-D2AW2I37.js";
function se(e, t) {
  t === void 0 && (t = {});
  var i = t.insertAt;
...
function me(e, t, i, r, o) {
  e("<!--teleport start-->");
  const n = o.appContext.provides[v], s = n.__teleportBuffers || (n.__teleportBuffers = {}), a = s[i] || (s[i] = []), d = a.length;
  let c;
  if (r)
...
async function B(e, t = {}) {
  ...
  i.appContext = e._context, e.provide(v, t);
