import { p as B, s as _, m as N, l as E, q as z, v as u, N as b, w as j, x as g, F as V, S as M, C as U, y as H, T as L, z as w, A as C, B as O, D as P, E as F, G as I, n as D, g as G, H as W, I as K, J as q, K as J, L as Q, M as X, O as Y, P as Z, Q as tt, R as et, d as rt, c as at, e as it, t as ot, b as nt, U as st } from "./runtime-dom.esm-bundler-RESc_Ie8.js";
function lt(t, e) {
  e === void 0 && (e = {});
  var r = e.insertAt;
...
function ct(t, e) {
  let r = "";
  for (let a in t) {
    if (pt(a) || I(a) || e === "textarea" && a === "value" || // force as property (not rendered in SSR)
    a.startsWith("."))
      continue;
    const i = t[a];
    a.startsWith("^") && (a = a.slice(1)), a === "class" || a === "className" ? r += ` class="${gt(i)}"` : a === "style" ? r += ` style="${ft(i)}"` : r += wt(a, i, e);
  }
  return r;
}
function wt(t, e, r) {
...
function k(t, e) {
  ...
  if (j(r)) {
    ...
    (!t.render || t.render === b) && !t.ssrRender && !r.ssrRender && g(r.template) && (r.ssrRender = vt(r.template));
...
function v(t, e, r, a) {
  ...
  switch (s && (e.props = kt(e, d, s)), i) {
    ...
    case V:
      ...
      break;
    default:
      o & 1 ? xt(t, e, r, a) : o & 6 ? t(T(e, r, a)) : o & 64 ? _t(t, e, r, a) : o & 128 && v(t, e.ssContent, r, a);
  }
}
function m(t, e, r, a) {
