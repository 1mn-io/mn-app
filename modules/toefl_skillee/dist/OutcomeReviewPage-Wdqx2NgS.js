...
const Je = { class: "min-h-screen bg-[#f0f2f5] flex flex-col font-sans" }, Ke = {
...
}, Ye = { class: "bg-[#00796B] min-h-[60px] flex flex-col md:flex-row justify-between items-center px-4 md:px-6 py-3 md:py-0 shrink-0 shadow-md z-30 gap-3" }, Xe = { class: "flex items-center gap-3 text-white w-full md:w-auto justify-between md:justify-start" }, Ze = {
  key: 0,
  class: "flex items-center gap-2"
}, et = {
  key: 1,
  class: "flex items-center gap-2"
}, tt = { class: "text-[14px] md:text-[16px] font-bold uppercase tracking-wider truncate px-2" }, st = {
  key: 0,
  class: "flex items-center gap-1 sm:gap-2 w-full md:w-auto overflow-x-auto pb-1 md:pb-0 no-scrollbar"
}, rt = ["onClick"], ot = { class: "flex flex-grow overflow-hidden relative" }, lt = {
  key: 0,
  class: "fixed inset-y-0 left-0 w-[280px] sm:w-[320px] bg-white border-r border-gray-200 flex flex-col z-40 shadow-2xl md:shadow-sm md:relative overflow-hidden shrink-0"
...
}, zt = ["onClick"], Dt = { class: "flex items-center gap-3 sm:gap-4" }, Pt = { class: "text-[15px] sm:text-[17px] font-medium" }, Ut = {
  key: 0,
  class: "flex items-center gap-2 self-end sm:self-auto"
}, Et = {
  key: 0,
  class: "bg-green-100 text-green-700 text-[9px] sm:text-[10px] font-black px-2 py-1 rounded-full uppercase tracking-widest"
}, Ft = {
  key: 1,
  class: "bg-blue-100 text-blue-700 text-[9px] sm:text-[10px] font-black px-2 py-1 rounded-full uppercase tracking-widest"
}, Ot = {
  key: 1,
  class: "flex items-center gap-2 self-end sm:self-auto"
}, $t = {
...
}, Rt = { class: "bg-blue-50 px-4 sm:px-6 py-2 sm:py-3 border-b border-blue-100 text-blue-800 text-[11px] sm:text-[12px] font-black uppercase flex justify-between items-center" }, Gt = { class: "p-6 sm:p-8 text-[15px] sm:text-[17px] leading-relaxed italic text-gray-700 whitespace-pre-wrap font-medium" }, Qt = {
  key: 0,
  class: "flex flex-col items-center gap-4 mb-6"
}, Vt = ["src"], Wt = {
  key: 1,
  class: "w-full mb-6 p-5 bg-gradient-to-br from-gray-50 to-white rounded-xl border border-blue-100 shadow-sm relative overflow-hidden"
}, Jt = { class: "text-[15px] text-gray-800 not-italic leading-relaxed" }, Kt = { key: 2 }, Yt = {
  key: 3,
  class: "text-gray-400"
}, Xt = { class: "flex-grow bg-white overflow-y-auto flex flex-col p-4 sm:p-8" }, Zt = {
  key: 0,
  class: "max-w-3xl mx-auto w-full h-full flex flex-col justify-center items-center text-center space-y-8"
}, es = { class: "p-8 bg-blue-50 rounded-3xl border border-blue-100 shadow-sm w-full" }, ts = { class: "flex flex-col gap-3" }, ss = ["disabled"], rs = { class: "text-[12px] text-gray-400 font-medium" }, os = {
  key: 1,
  class: "max-w-3xl mx-auto w-full"
}, ls = { class: "flex items-center justify-between mb-6 pb-4 border-b border-gray-100" }, as = {
  key: 0,
  class: "text-[#00796B] text-[14px] font-bold"
}, ns = {
  key: 1,
  class: "text-green-600 text-[14px] font-bold"
}, is = {
  key: 2,
  class: "text-[#00796B] text-[14px] font-bold"
}, us = {
  key: 3,
  class: "text-red-600 text-[14px] font-bold"
}, ds = {
  key: 4,
  class: "text-gray-400 text-[14px] font-bold"
}, cs = {
  key: 0,
  class: "mb-8"
  ...
  key: 0,
  class: "space-y-3"
}, Ps = { class: "bg-green-50/50 p-3 rounded-lg border border-green-100" }, Us = { class: "text-[13px] text-gray-700 leading-relaxed font-medium" }, Es = { class: "bg-red-50/50 p-3 rounded-lg border border-red-100" }, Fs = { class: "text-[13px] text-gray-700 leading-relaxed font-medium" }, Os = {
  key: 1,
  class: "text-[14px] text-gray-700 leading-relaxed font-medium bg-white p-4 rounded-lg border border-gray-100 shadow-sm"
}, $s = {
  key: 2,
  class: "mt-4"
}, Hs = { class: "space-y-3" }, Rs = ["innerHTML"], Gs = { class: "shrink-0 pt-1" }, Qs = { class: "px-2 h-5 rounded-full bg-blue-600 text-white flex items-center justify-center font-black text-[8px]" }, Vs = ["innerHTML"], Ws = {
  key: 1,
  class: "h-full min-h-[100px] flex flex-col items-center justify-center text-gray-400 italic text-[13px] text-center gap-2"
}, Js = { class: "flex flex-wrap justify-center gap-4 mt-6" }, Ks = ["onMouseenter", "onClick"], Ys = { class: "text-[10px] font-bold text-gray-600 uppercase" }, Xs = { class: "grid grid-cols-1 sm:grid-cols-2 gap-8 pt-4 border-t border-gray-100" }, Zs = { class: "space-y-4" }, er = { class: "space-y-2" }, tr = { class: "space-y-4" }, sr = { class: "space-y-2" }, rr = { class: "bg-gray-50 px-6 py-4 border-b border-gray-200 flex justify-between items-center" }, or = { class: "flex items-center gap-2" }, lr = {
  key: 0,
  class: "bg-green-100 text-green-700 px-3 py-1 rounded-full text-[10px] font-black uppercase"
}, ar = {
  key: 1,
  class: "bg-red-100 text-red-700 px-3 py-1 rounded-full text-[10px] font-black uppercase"
}, nr = {
  key: 2,
  class: "bg-gray-100 text-gray-500 px-3 py-1 rounded-full text-[10px] font-black uppercase"
}, ir = { class: "p-6 sm:p-8 space-y-6" }, ur = {
  key: 0,
  class: "bg-green-50 p-4 rounded-xl border border-green-100"
  ...
  setup(me) {
    const O = Qe(), _ = Ve(), T = oe("testData"), le = oe("syncAllData"), _e = oe("isGlobalLoading"), j = A(!0), $ = A(!1), ae = A(600), X = A(!1), f = A(_.query.section || "reading"), g = A({ mIdx: -1, tIdx: 0, qIdx: 0 }), q = M(() => !!_.params.uuid), y = A({}), H = A(!1), ye = ["reading", "listening", "speaking", "writing"], B = M(() => T?.value?.find((t) => t.type.toLowerCase() === f.value.toLowerCase()) || null), i = M(() => {
      const t = B.value;
      if (!t) return null;
    ...
    const he = () => {
      ...
      if (!H.value) {
        ...
        try {
          ...
          le ? (console.log("[Practice] Triggering syncAllData for section:", f.value), await le(f.value, !0)) : console.error("[Practice] syncAllData not found in injection context!"), console.log("[Practice] Redirecting to outcome page for test:", _.params.testId), O.push({ name: "outcome", params: { testId: _.params.testId } });
        } catch (t) {
      ...
      const a = [
        ...
        { key: "organization", label: "Organization", color: "#3b82f6", max: 1.2 },
        { key: "grammar", label: "Grammar", color: "#f59e0b", max: 1.2 },
        { key: "vocabulary", label: "Vocabulary", color: "#8b5cf6", max: 0.9 },
        { key: "coherence", label: "Coherence", color: "#14b8a6", max: 0.9 }
      ];
      let n = 0;
      const d = 125.6637;
      let v = 0;
      ...
      return { segments: a.map((S) => {
        ...
        v += z;
        const V = S.max / m * d, J = z / S.max * V, K = -n;
        return n += J, {
          ...S,
          score: Number(z.toFixed(2)).toString(),
          max: Number(S.max.toFixed(2)).toString(),
          feedback: k.feedback || k.what_you_did_well || "No specific feedback.",
          what_you_did_well: k.what_you_did_well,
          what_was_the_issues: k.what_was_the_issues,
          how_to_improve: k.how_to_improve,
          dasharray: `${J} ${d}`,
          dashoffset: K
        };
      ...
      const n = "fluency_and_coherence" in e ? [
        ...
        { key: "vocabulary_lexicology", label: "Vocabulary Lexicology", color: "#3b82f6", max: 1.2 },
        { key: "pronunciation", label: "Pronunciation", color: "#f59e0b", max: 0.9 },
        { key: "grammatical_accuracy", label: "Grammatical Accuracy", color: "#8b5cf6", max: 0.9 },
        { key: "organization_and_delivery", label: "Organization & Delivery", color: "#14b8a6", max: 0.9 },
        { key: "topic_development", label: "Topic Development", color: "#f97316", max: 0.9 }
      ] : [
        { key: "delivery", label: "Delivery", color: "#ef4444", max: 2 },
        { key: "language_use", label: "Language Use", color: "#3b82f6", max: 2 },
        { key: "topic_development", label: "Topic Development", color: "#f59e0b", max: 2 }
      ];
      let d = 0;
      const v = 125.6637;
      let m = 0;
      ...
      return { segments: n.map((h) => {
        ...
        m += V;
        const J = h.max / I * v, K = V / h.max * J, De = -d;
        return d += K, {
          ...h,
    ...
    }), we = M(() => Z.value ? "Overall Writing Performance" : ee.value ? "Overall Speaking Performance" : "Performance Metrics"), E = A(null), ue = (t) => {
      E.value?.key === t.key ? E.value = null : (E.value = t, P.value = null);
    }, b = M(() => E.value || P.value), de = () => {
      ...
      if (!t || t === "undefined") {
        const e = localStorage.getItem("toefl_test_data");
        if (e)
          try {
            const r = JSON.parse(e), a = Array.isArray(r) ? r[0] : r.sections ? r.sections[0] : r;
            t = a?.test_id || a?.id || a?.testId || a?._id;
          } catch {
          }
      }
      t && t !== "undefined" ? O.push({
        name: "outcome",
        params: { testId: String(t).replace(/['"]/g, "").trim() },
        query: { finished: f.value.toLowerCase() }
      }) : O.push("/start");
    }, Ce = (t) => {
      f.value = t, g.value = { mIdx: 0, tIdx: 0, qIdx: 0 }, O.replace({
        query: {
          ..._.query,
          section: t
        }
      ...
      if (!t) return [];
      const e = [];
      return t.modules ? t.modules.forEach((r, a) => {
        r.tasks.forEach((n, d) => {
          n.questions && n.questions.length > 0 && n.questions.forEach((v, m) => {
            e.push({ mIdx: a, tIdx: d, qIdx: m });
          });
        });
      }) : t.tasks && t.tasks.forEach((r, a) => {
        r.questions && r.questions.length > 0 ? r.questions.forEach((n, d) => {
      ...
      if (a.modules)
        for (let d = 0; d <= t; d++) {
          const v = a.modules[d], m = d === t ? e : v.tasks.length - 1;
          for (let I = 0; I <= m; I++) {
            const S = v.tasks[I], h = d === t && I === e ? r : S.questions.length - 1;
            n += h + 1;
          }
        }
      else if (a.tasks)
        for (let d = 0; d <= e; d++) {
          const v = a.tasks[d];
          d === e ? n += r + 1 : n += v.questions?.length || 1;
        }
      return n;
    }, se = (t, e, r) => {
      ...
      const d = B.value;
      if (d?.modules)
        n = d.modules[t]?.tasks[e]?.questions[r]?.user_result;
      else if (d?.tasks) {
        const k = d.tasks[e];
        n = k.questions ? k.questions[r]?.user_result : k.user_result;
      }
      let v = a ? "border-[#00796B] ring-2 ring-[#00796B]/20 scale-105 z-10 " : "border-gray-200 hover:border-gray-300 ";
      ...
      $.value = window.innerWidth < 1024, $.value && (j.value = !1);
    };
    D(u, (t) => {
    ...
    const Ne = (t) => {
      ...
      const e = t.strengths;
      return e ? Array.isArray(e) ? e : typeof e == "string" ? e.includes(";") ? e.split(";").map((r) => r.trim()).filter(Boolean) : e.includes(",") ? e.split(",").map((r) => r.trim()).filter(Boolean) : [e] : ["Good attempt"] : ["Good attempt"];
    }, ze = (t) => {
      if (!t) return ["More detail needed"];
      const e = t.weaknesses || t.improvements;
    ...
    return (t, e) => (o(), l("div", Je, [
      Ee(_e) ? (o(), l("div", Ke, [...e[6] || (e[6] = [
      ...
      s("header", Ye, [
        s("div", Xe, [
          q.value ? (o(), l("div", et, [
            ...
            e[10] || (e[10] = s("div", { class: "bg-white/20 px-3 py-1 rounded text-[11px] font-black uppercase tracking-widest flex items-center gap-2" }, [
              s("div", { class: "w-1.5 h-1.5 bg-red-500 rounded-full animate-pulse" }),
              w(" Practice Mode ")
            ], -1))
          ])) : (o(), l("div", Ze, [
            s("button", {
            ...
            s("button", {
              onClick: e[0] || (e[0] = (r) => j.value = !j.value),
              class: "hover:bg-white/10 p-2 rounded transition-colors flex items-center gap-2",
      ...
      s("div", ot, [
        Fe($e, { name: "sidebar" }, {
          default: Oe(() => [
            j.value && !q.value ? (o(), l("aside", lt, [
              ...
              e[13] || (e[13] = s("div", { class: "p-4 border-t border-gray-200 bg-gray-50 flex flex-col gap-2" }, [
                s("div", { class: "flex items-center gap-4 text-[11px] text-gray-600" }, [
                  s("div", { class: "flex items-center gap-1.5" }, [
                    s("div", { class: "w-3 h-3 rounded bg-green-500" }),
                    w(" Correct / Scored ")
                  ]),
                  s("div", { class: "flex items-center gap-1.5" }, [
                    s("div", { class: "w-3 h-3 rounded bg-red-500" }),
                    w(" Incorrect ")
                  ]),
                  s("div", { class: "flex items-center gap-1.5" }, [
                    s("div", { class: "w-3 h-3 rounded bg-gray-200 border border-gray-300" }),
                    w(" Unanswered ")
                  ])
                ])
              ], -1))
        ...
        i.value ? (o(), l("div", gt, [
          s("div", {
            style: Y({ width: $.value ? "100%" : ae.value + "px" }),
            class: "bg-gray-50 overflow-y-auto border-b md:border-b-0 md:border-r border-gray-200 flex flex-col p-4 sm:p-8 shrink-0"
          }, [
            s("div", bt, [
              q.value ? p("", !0) : (o(), l("div", mt, [
                s("button", {
                  onClick: qe,
                  class: "flex items-center gap-2 px-5 py-2 rounded-lg border border-gray-200 text-[12px] font-bold text-gray-600 hover:bg-gray-50 transition-colors shadow-sm disabled:opacity-30 disabled:cursor-not-allowed bg-white",
                  disabled: ce.value
                }, [...e[14] || (e[14] = [
                  s("svg", {
                    class: "w-4 h-4",
                ...
                s("div", wt, [
                  i.value.passageHTML || i.value.transcript ? (o(), l("div", {
                    ...
                    i.value.instructions ? (o(), l("div", qt, [
                      ...
                      s("ul", St, [
                        (o(!0), l(x, null, C(i.value.instructions, (r) => (o(), l("li", { key: r }, c(r), 1))), 128))
                      ])
                    ])) : p("", !0)
              ...
              s("div", Bt, [
                ...
                u.value?.options && u.value.options.length > 0 ? (o(), l("div", Nt, [
                  (o(!0), l(x, null, C(u.value.options, (r, a) => (o(), l("div", {
                    key: a,
                    ...
                    q.value ? (o(), l("div", Ot, [
                      y.value[u.value.uuid] === r ? (o(), l("div", $t, [...e[20] || (e[20] = [
                        s("svg", {
                  ...
                  s("div", {
                    class: N(["bg-white border-2 rounded-2xl overflow-hidden shadow-lg", q.value ? "border-blue-500/50" : "border-blue-500/30"])
                  }, [
                    s("div", Rt, [
                      s("span", null, c(q.value ? "Your Answer" : "Your Response"), 1)
                    ]),
                    s("div", Gt, [
                      q.value ? He((o(), l("textarea", {
                        key: 0,
                        ...
                        u.value?.user_result?.transcript || i.value?.user_result?.transcript ? (o(), l("div", Wt, [
                          ...
                          e[22] || (e[22] = s("div", { class: "text-[10px] text-blue-600 font-black uppercase tracking-widest mb-3 flex items-center gap-2" }, [
                            s("svg", {
                              ...
                              s("path", { d: "M7 4a3 3 0 016 0v4a3 3 0 11-6 0V4zm4 10.93A7.001 7.001 0 0017 8a1 1 0 10-2 0A5 5 0 015 8a1 1 0 00-2 0 7.001 7.001 0 006 6.93V17H6a1 1 0 100 2h8a1 1 0 100-2h-3v-2.07z" })
                            ]),
                            w(" AI Audio Transcript ")
                          ], -1)),
                          s("p", Jt, '"' + c(u.value?.user_result?.transcript || i.value?.user_result?.transcript) + '"', 1)
                        ])) : p("", !0),
                        !ve(F()) && F() ? (o(), l("div", Kt, c(F()), 1)) : p("", !0),
                        !F() && !u.value?.user_result?.transcript && !i.value?.user_result?.transcript ? (o(), l("div", Yt, " No response recorded. ")) : p("", !0)
                      ], 64))
                    ])
                  ], 2)
                ]))
          ...
          $.value ? p("", !0) : (o(), l("div", {
            key: 0,
            onMousedown: Te,
            class: "w-1 cursor-col-resize bg-gray-200 hover:bg-[#00796B] transition-colors relative z-10"
          }, null, 32)),
          s("div", Xt, [
            q.value ? (o(), l("div", Zt, [
              s("div", es, [
                ...
                s("div", ts, [
                  ne.value ? (o(), l("button", {
                    ...
                    onClick: ke,
                    disabled: H.value,
                    class: "w-full py-4 bg-[#00796B] hover:bg-[#00695C] text-white rounded-xl font-bold text-[18px] transition-all shadow-md active:scale-95 disabled:opacity-50"
                  }, c(H.value ? "Submitting..." : "Submit Task"), 9, ss)) : (o(), l("button", {
                    key: 0,
                    onClick: he,
              ...
              s("div", ls, [
                s("div", null, [
                  ...
                  u.value?.user_result?.status === "Scored" || i.value?.user_result?.status === "Scored" ? (o(), l("div", as, "Scored")) : (u.value?.user_result?.data || i.value?.user_result?.data) == 1 ? (o(), l("div", ns, "Correct")) : U.value ? (o(), l("div", is, "Scored")) : (u.value?.user_result?.data || i.value?.user_result?.data) == -1 ? (o(), l("div", us, "Incorrect")) : (o(), l("div", ds, "Unanswered"))
                ]),
                ...
                f.value === "speaking" || f.value === "writing" ? (o(), l(x, { key: 0 }, [
                  s("div", xs, [
                    ...
                    s("div", gs, [
                      ...
                      s("div", ms, " Score: " + c(U.value?.totalScore || u.value?.user_result?.score || u.value?.user_result?.overall_score || i.value?.user_result?.score || i.value?.user_result?.overall_score || 0) + "/6.0 ", 1)
                    ])
                  ]),
                  s("div", _s, [
                    s("div", ys, [
                    ...
                    U.value ? (o(), l("div", ks, [
                      ...
                      s("div", Cs, [
                        (o(), l("svg", Ms, [
                          ...
                          (o(!0), l(x, null, C(U.value.segments, (r, a) => (o(), l("path", {
                            key: a,
                            d: "M 10 50 A 40 40 0 0 1 90 50",
                            fill: "none",
                            stroke: r.color,
                            ...
                            onMouseenter: (n) => P.value = r,
                            onMouseleave: e[4] || (e[4] = (n) => P.value = null),
                            onClick: (n) => ue(r)
                          }, null, 40, qs))), 128))
                        ])),
                        s("div", Ss, [
                          w(c(U.value.totalScore), 1),
                          e[31] || (e[31] = s("span", { class: "text-[14px] text-gray-400" }, "/6.0", -1))
                        ])
                      ]),
                      s("div", Is, [
                        b.value ? (o(), l(x, { key: 0 }, [
                          s("div", Ls, [
                            s("div", {
                              ...
                              style: Y({ color: b.value.color })
                            }, [
                              s("span", {
                                class: "w-3 h-3 rounded-full",
                                style: Y({ backgroundColor: b.value.color })
                              }, null, 4),
                              w(" " + c(b.value.label) + " ", 1),
                          ...
                          s("div", zs, [
                            b.value.what_you_did_well ? (o(), l("div", Ds, [
                              s("div", Ps, [
                                ...
                                s("div", Us, c(b.value.what_you_did_well), 1)
                              ]),
                              s("div", Es, [
                            ...
                            ])) : (o(), l("div", Os, c(b.value.feedback), 1)),
                            b.value.how_to_improve ? (o(), l("div", $s, [
                              ...
                              s("div", Hs, [
                                typeof b.value.how_to_improve == "string" ? (o(!0), l(x, { key: 0 }, C(b.value.how_to_improve.split(`
`).filter((r) => r.trim()), (r, a) => (o(), l("div", {
                                  ...
                                  e[36] || (e[36] = s("div", { class: "shrink-0 pt-0.5" }, [
                                    s("div", { class: "w-2 h-2 rounded-full bg-blue-400 mt-1.5" })
                                  ], -1)),
                                  s("div", {
                                    class: "text-gray-600 font-medium leading-relaxed",
                                    innerHTML: W(r)
                                  }, null, 8, Rs)
                                ]))), 128)) : typeof b.value.how_to_improve == "object" ? (o(!0), l(x, { key: 1 }, C(b.value.how_to_improve, (r, a, n) => (o(), l("div", {
                                  key: a,
                                  ...
                                  s("div", {
                                    class: "text-gray-600 font-medium leading-relaxed",
                                    innerHTML: W(String(r))
                                  }, null, 8, Vs)
                                ]))), 128)) : p("", !0)
                              ])
                            ])) : p("", !0)
                          ])
                        ], 64)) : (o(), l("div", Ws, [...e[38] || (e[38] = [
                          s("svg", {
                          ...
                          w(" Click or hover over a color segment on the gauge to see detailed step-by-step feedback. ", -1)
                        ])]))
                      ]),
                      s("div", Js, [
                        (o(!0), l(x, null, C(U.value.segments, (r) => (o(), l("div", {
                          key: r.key,
                          ...
                          onMouseenter: (a) => P.value = r,
                          onMouseleave: e[5] || (e[5] = (a) => P.value = null),
                          onClick: (a) => ue(r)
                        }, [
                          s("div", {
                            class: "w-3 h-3 rounded-full",
                            style: Y({ backgroundColor: r.color })
                          }, null, 4),
                          s("span", Ys, c(r.label), 1)
                        ], 42, Ks))), 128))
                      ])
                    ])) : p("", !0),
                    s("div", Xs, [
                      s("div", Zs, [
                        ...
                        s("ul", er, [
                          (o(!0), l(x, null, C(Ne(u.value?.user_result || i.value?.user_result), (r) => (o(), l("li", {
                            key: r,
                      ...
                      s("div", tr, [
                        ...
                        s("ul", sr, [
                          (o(!0), l(x, null, C(ze(u.value?.user_result || i.value?.user_result), (r) => (o(), l("li", {
                            key: r,
