...
const q = { class: "min-h-screen bg-white text-slate-900 font-sans antialiased selection:bg-purple-200" }, D = {
...
}, F = { class: "max-w-7xl mx-auto px-6 py-1 md:py-5" }, G = { class: "flex flex-col md:flex-row md:items-end justify-between gap-10 mb-14" }, X = { class: "space-y-4" }, P = { class: "text-slate-600 font-normal text-xs uppercase tracking-wider" }, R = { class: "flex items-center gap-1 bg-slate-100 p-1 rounded-lg border border-slate-200 mb-10 sticky top-4 z-40 backdrop-blur-md overflow-x-auto no-scrollbar" }, Y = ["onClick"], J = {
  key: 0,
  class: "w-3.5 h-3.5",
  fill: "none",
  stroke: "currentColor",
  ...
  __name: "QuestionList",
  setup(T) {
    const c = v("testData"), x = v("isGlobalLoading"), k = v("clearSectionAnswers"), h = z(), y = N(), p = I("reading"), g = L(() => c?.value ? (Array.isArray(c.value) ? c.value : c.value.sections || []).map((e) => {
      const s = [];
      let d = 1;
      const l = (o) => {
      ...
      t("div", F, [
        t("header", G, [
          t("div", X, [
            ...
            t("p", P, "Test ID: " + u(f(y).params.testId), 1)
          ]),
          t("button", {
        ...
        t("nav", R, [
          (r(!0), n(_, null, B(g.value, (s) => (r(), n("button", {
            ...
            style: A(p.value === s.type ? { backgroundColor: "#00796B", color: "white" } : {})
          }, [
            s.type === "reading" ? (r(), n("svg", J, [...e[9] || (e[9] = [
              t("path", {
                "stroke-linecap": "round",
                "stroke-linejoin": "round",
                "stroke-width": "2",
            ...
            ])])) : s.type === "listening" ? (r(), n("svg", O, [...e[10] || (e[10] = [
              t("path", {
                "stroke-linecap": "round",
                "stroke-linejoin": "round",
                "stroke-width": "2",
            ...
            ])])) : s.type === "speaking" ? (r(), n("svg", U, [...e[11] || (e[11] = [
              t("path", {
                "stroke-linecap": "round",
                "stroke-linejoin": "round",
                "stroke-width": "2",
...
}), ce = /* @__PURE__ */ Q(pe, [["__scopeId", "data-v-95f9bc94"]]), ge = /* @__PURE__ */ j({
  __name: "ListPage",
  setup(T) {
    return (c, x) => (r(), V(ce));
  }
