...
let _data = {
    l:  [
      {
        "id": "7d4e9be6-66c0-46cb-9911-76148974d9d0",
        "type": "sample",
        "data": {
          "data": "",
          "api":{
            "a":{
              "url": 'https://fastapi.dryutil.1mn.io/client/api/i/test/toefl?typ=createdata',
              "header":{
            ...
            "b":{
              "url":  'https://fastapi.dryutil.1mn.io/client/api/i/test/toefl?typ=getdata',
              "header":{
                "Authorization":"eyJhbGciOiJSUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6ImYwZTNlMDRiLTVkNDAtNDg1ZS05OGU4LWEzOTI3NWU3MzM0OCIsInNlY3VyaXR5Ijp7InBhcnR5IjpbInBhcnR5XzEiLCJwYXJ0eV8yIl19LCJzdWIiOiJmMGUzZTA0Yi01ZDQwLTQ4NWUtOThlOC1hMzkyNzVlNzMzNDgiLCJpYXQiOjE3NjU4MTI4Mjh9.OoClnPtlxI71L-e555nbNSmenmGufxewp78SlmdZCNxeuauXao5RRvqwOKQ77SJFqJXk0ng6GZ7VOgYECdEf-3k1UGX7w1NE_D5A6SP3UkVsSG8orYACFuvTyesbFwkpnEhdu0PBd6n8wuLkgU6nZ1bLDzKVg1zd8fFeJrwmUqk"
              },
            },
            "c":{
              "url":  'https://fastapi.dryutil.1mn.io/client/api/i/test/toefl?typ=eval_data',
              "header":{
                "Authorization":"eyJhbGciOiJSUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6ImYwZTNlMDRiLTVkNDAtNDg1ZS05OGU4LWEzOTI3NWU3MzM0OCIsInNlY3VyaXR5Ijp7InBhcnR5IjpbInBhcnR5XzEiLCJwYXJ0eV8yIl19LCJzdWIiOiJmMGUzZTA0Yi01ZDQwLTQ4NWUtOThlOC1hMzkyNzVlNzMzNDgiLCJpYXQiOjE3NjU4MTI4Mjh9.OoClnPtlxI71L-e555nbNSmenmGufxewp78SlmdZCNxeuauXao5RRvqwOKQ77SJFqJXk0ng6GZ7VOgYECdEf-3k1UGX7w1NE_D5A6SP3UkVsSG8orYACFuvTyesbFwkpnEhdu0PBd6n8wuLkgU6nZ1bLDzKVg1zd8fFeJrwmUqk"
              },
            },
            "d":{
              "url":  'https://fastapi.dryutil.1mn.io/client/api/i/test/toefl?typ=updatedata',
            ...
            "e":{
              //"url":  'https://fastapi.dryutil.1mn.io/client/api/i/test/toefl?typ=updatedata',
              "url": "https://fastapi.dryutil.1mn.io/client/api/i/test/toefl?typ=getprompt",
            ...
            "f":{
              //"url":  'http://localhost:8000/client/api/i/skillee/toefl_practice?typ=createtest',
              "url": "https://fastapi.dryutil.1mn.io/client/api/i/test/toefl?typ=createtest",
