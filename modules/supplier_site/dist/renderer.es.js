import { s as j } from "./style-inject.es-CQKlVflb.js";
import { g as A, s as z, c as M, a as B, b as _, i as f, N as b, e as E, f as g, F as V, S as U, C as F, h as H, T as I, j as w, k as S, m as L, l as O, n as P, o as D, p as G, q as K, r as W, t as q, u as J, v as Q, w as X, x as Y, y as Z, z as tt, A as rt, B as et, d as at, D as it, E as ot, G as nt } from "./runtime-dom.esm-bundler-flriJ5oA.js";
...
function ct(t, r) {
  let e = "";
  for (const a in t) {
    if (lt(a) || D(a) || r === "textarea" && a === "value")
      continue;
    const i = t[a];
    a === "class" ? e += ` class="${pt(i)}"` : a === "style" ? e += ` style="${wt(i)}"` : a === "className" ? e += ` class="${String(i)}"` : e += dt(a, i, r);
  }
  return e;
}
function dt(t, r, e) {
  if (!q(r))
    return "";
  const a = e && (e.indexOf("-") > 0 || J(e)) ? t : Q[t] || t.toLowerCase();
  return X(a) ? Y(r) ? ` ${a}` : "" : Z(a) ? r === "" ? ` ${a}` : ` ${a}="${w(r)}"` : (console.warn(
...
function gt(t) {
  if (!S(t) && tt(t)) {
    const r = {};
    for (const e in t)
      e.startsWith(":--") ? r[e.slice(1)] = rt(t[e]) : r[e] = t[e];
    return r;
  }
  return t;
}
function ht(t, r, e, a, i) {
  t("<!--teleport start-->");
  const o = i.appContext.provides[_], n = o.__teleportBuffers || (o.__teleportBuffers = {}), s = n[e] || (n[e] = []), c = s.length;
  let p;
  if (a)
    r(t), p = "<!--teleport start anchor--><!--teleport anchor-->";
  else {
    const { getBuffer: d, push: l } = C();
...
function C() {
  ...
  return {
    ...
    push(e) {
      ...
      r.push(e), t = a, (f(e) || S(e) && e.hasAsync) && (r.hasAsync = !0);
    }
  };
}
function T(t, r = null, e) {
  const a = t.component = ft(
    t,
    r,
    null
  ), i = mt(
...
function k(t, r) {
  const e = t.type, { getBuffer: a, push: i } = C();
  if (E(e)) {
    let o = y(t);
    if (!e.props)
    ...
    (!t.render || t.render === b) && !t.ssrRender && !e.ssrRender && g(e.template) && (e.ssrRender = vt(e.template));
    const o = t.ssrRender || e.ssrRender;
    if (o) {
...
function m(t, r, e, a) {
  const { type: i, shapeFlag: o, children: n, dirs: s, props: c } = r;
  switch (s && (r.props = ut(r, c, s)), i) {
    case I:
      t(w(n));
      break;
    case F:
    ...
    case U:
      ...
      break;
    case V:
      r.slotScopeIds && (a = (a ? a + " " : "") + r.slotScopeIds.join(" ")), t("<!--[-->"), x(
        t,
        n,
        e,
        a
      ...
      break;
    default:
      o & 1 ? xt(t, r, e, a) : o & 6 ? t(T(r, e, a)) : o & 64 ? yt(t, r, e, a) : o & 128 && m(t, r.ssContent, e, a);
  }
}
function x(t, r, e, a) {
...
function xt(t, r, e, a) {
  const i = r.type;
  let { props: o, children: n, shapeFlag: s, scopeId: c } = r, p = `<${i}`;
  o && (p += ct(o, i)), c && (p += ` ${c}`);
  let d = e, l = r;
  for (; d && l === d.subTree; )
  ...
  if (a && (p += ` ${a}`), t(p + ">"), !O(i)) {
    let h = !1;
    o && (o.innerHTML ? (h = !0, t(o.innerHTML)) : o.textContent ? (h = !0, t(w(o.textContent))) : i === "textarea" && o.value && (h = !0, t(w(o.value)))), h || (s & 8 ? t(w(n)) : s & 16 && x(
      t,
      n,
      e,
      a
...
async function $(t, r = {}) {
  if (kt(t))
    return $(M({ render: () => t }), r);
  const e = B(t._component, t._props);
  e.appContext = t._context, t.provide(_, r);
  const a = await T(e), i = await N(a);
  if (await zt(r), r.__watcherHandles)
...
async function zt(t) {
  if (t.__teleportBuffers) {
    ...
    for (const r in t.__teleportBuffers)
      t.teleports[r] = await N(
        await Promise.all([t.__teleportBuffers[r]])
      );
  }
}
et();
const _t = ["id"], St = /* @__PURE__ */ at({
  __name: "index",
  props: {
    _p: {},
    _pp: {}
