import { H as or, d as Ft, I as z, J as nr, K as ir, L as zt, M as U, O as Bt, P as qt, Q as mt, R as sr, U as lr, V as le, W as nt, E as k, X as dr, Y as cr, D as E, Z as e, _ as et, a as V, $ as $t, p as ht, F as O, a0 as T, a1 as C, a2 as pe, a3 as X, a4 as Rt, q as ue, a5 as pr, c as ur } from "./runtime-dom.esm-bundler-DTh02eJ7.js";
...
function hr(t) {
  return t.__esModule || t[Symbol.toStringTag] === "Module" || t.default && $e(t.default);
}
...
const vr = /* @__PURE__ */ Symbol(""), he = /* @__PURE__ */ Symbol(""), de = /* @__PURE__ */ Symbol(""), Fe = /* @__PURE__ */ Symbol(""), oe = /* @__PURE__ */ Symbol("");
const Ze = /#/g, xr = /&/g, br = /\//g, wr = /=/g, yr = /\?/g, qe = /\+/g, kr = /%5B/g, Cr = /%5D/g, We = /%5E/g, _r = /%60/g, Ke = /%7B/g, Ar = /%7C/g, Qe = /%7D/g, Er = /%20/g;
function ce(t) {
  return t == null ? "" : encodeURI("" + t).replace(Ar, "|").replace(kr, "[").replace(Cr, "]");
}
function Rr(t) {
  return ce(t).replace(Ke, "{").replace(Qe, "}").replace(We, "^");
}
function ne(t) {
  return ce(t).replace(qe, "%2B").replace(Er, "+").replace(Ze, "%23").replace(xr, "%26").replace(_r, "`").replace(Ke, "{").replace(Qe, "}").replace(We, "^");
}
function Lr(t) {
...
function zr(t, r, a) {
  ...
  return o > -1 && o === n && bt(r.matched[o], a.matched[n]) && Ye(r.params, a.params) && t(r.query) === t(a.query) && r.hash === a.hash;
}
function bt(t, r) {
...
function Fr(t) {
  ...
  for (let o = 0; o < a.length; ++o) {
    const n = a[o].replace(qe, " "), u = n.indexOf("="), g = Ut(u < 0 ? n : n.slice(0, u)), x = u < 0 ? null : Ut(n.slice(u + 1));
    if (g in r) {
      let l = r[g];
...
function it(t, r, a, o, n, u = (g) => g()) {
  const g = o && (o.enterCallbacks[n] = o.enterCallbacks[n] || []);
  return () => new Promise((x, l) => {
    const f = (p) => {
      p === !1 ? l(xt(H.NAVIGATION_ABORTED, {
        from: a,
        to: r
      })) : p instanceof Error ? l(p) : Ur(p) ? l(xt(H.NAVIGATION_GUARD_REDIRECT, {
        from: r,
        to: p
...
function qr(t, r) {
  ...
  for (let g = 0; g < u; g++) {
    const x = r.matched[g];
    x && (t.matched.find((f) => bt(f, x)) ? o.push(x) : a.push(x));
    const l = t.matched[g];
    l && (r.matched.find((f) => bt(f, l)) || n.push(l));
  }
  return [
    a,
    o,
...
function Kr(t, r, a, o) {
  let n = [], u = [], g = null;
  const x = ({ state: p }) => {
    const h = Je(t, location), R = a.value, I = r.value;
    let B = 0;
    if (p) {
  ...
  function m() {
    if (document.visibilityState === "hidden") {
      ...
      if (!p.state) return;
      p.replaceState(S({}, p.state, { scroll: Zt() }), "");
    }
  }
  function c() {
    for (const p of u) p();
...
function Qr(t) {
  const { history: r, location: a } = window, o = { value: Je(t, a) }, n = { value: r.state };
  n.value || u(o.value, {
    back: null,
    current: o.value,
    forward: null,
  ...
  function g(l, f) {
    u(l, S({}, r.state, be(n.value.back, l, n.value.forward, !0), f, { position: n.value.position }), !0), o.value = l;
  }
  function x(l, f) {
    ...
    u(m.current, m, !0), u(l, S({}, be(o.value, l, null), { position: m.position + 1 }, f), !1), o.value = l;
  }
  return {
    location: o,
    state: n,
...
function aa(t, r) {
  ...
  for (const f of t) {
    ...
    for (let c = 0; c < f.length; c++) {
      ...
      if (p.type === ct.Static)
      ...
      else if (p.type === ct.Param) {
        const { value: R, repeatable: I, optional: B, regexp: P } = p;
        u.push({
          name: R,
          repeatable: I,
          optional: B
        ...
        let _ = I ? `((?:${L})(?:/(?:${L}))*)` : `(${L})`;
        c || (_ = B && f.length < 2 ? `(?:/${_})` : "/" + _), B && (_ += "?"), n += _, h += q.Dynamic, B && (h += q.BonusOptional), I && (h += q.BonusRepeatable), L === ".*" && (h += q.BonusWildcard);
      }
      m.push(h);
    }
    o.push(m);
  ...
  function l(f) {
    ...
    for (const p of t) {
      (!c || !m.endsWith("/")) && (m += "/"), c = !1;
      for (const h of p) if (h.type === ct.Static) m += h.value;
      else if (h.type === ct.Param) {
        const { value: R, repeatable: I, optional: B } = h, P = R in f ? f[R] : "";
...
function sa(t, r) {
  ...
  function u(c, p, h) {
    ...
    if ("alias" in c) {
      ...
      for (const Y of F) P.push(Ce(S({}, I, {
    ...
    for (const F of P) {
      const { path: Y } = F;
      if (p && Y[0] !== "/") {
        const tt = p.record.path, W = tt[tt.length - 1] === "/" ? "" : "/";
        F.path = p.record.path + (Y && W + Y);
      }
      if (L = ia(F, p, B), h ? h.alias.push(L) : (_ = _ || L, _ !== L && _.alias.push(L), R && c.name && !_e(L) && g(c.name)), er(L) && l(L), I.children) {
        const tt = I.children;
        for (let W = 0; W < tt.length; W++) u(tt[W], L, h && h.children[W]);
      }
      h = h || L;
    }
    return _ ? () => {
  ...
  function l(c) {
    const p = ca(c, a);
    a.splice(p, 0, c), c.record.name && !_e(c) && o.set(c.record.name, c);
  }
  function f(c, p) {
    let h, R = {}, I, B;
    if ("name" in c && c.name) {
      if (h = o.get(c.name), !h) throw xt(H.MATCHER_NOT_FOUND, { location: c });
      B = h.record.name, R = S(ke(p.params, h.keys.filter((_) => !_.optional).concat(h.parent ? h.parent.keys.filter((_) => _.optional) : []).map((_) => _.name)), c.params && ke(c.params, h.keys.map((_) => _.name))), I = h.stringify(R);
    } else if (c.path != null)
      I = c.path, h = a.find((_) => _.re.test(I)), h && (R = h.parse(I), B = h.record.name, h.keys.forEach((_) => {
        _.optional && !R[_.name] && delete R[_.name];
      }));
    else {
      if (h = p.name ? o.get(p.name) : a.find((_) => _.re.test(p.path)), !h) throw xt(H.MATCHER_NOT_FOUND, {
        location: c,
        currentLocation: p
      });
      B = h.record.name, R = S({}, p.params, c.params), I = h.stringify(R);
    }
    const P = [];
    let L = h;
    for (; L; )
...
function pa(t) {
  let r = t;
  for (; r = r.parent; ) if (er(r) && tr(t, r) === 0) return r;
}
function er({ record: t }) {
  return !!(t.name || t.components && Object.keys(t.components).length || t.redirect);
}
function Ae(t) {
  const r = zt(de), a = zt(Fe), o = U(() => {
    const l = z(t.to);
    return r.resolve(l);
  }), n = U(() => {
    const { matched: l } = o.value, { length: f } = l, m = l[f - 1], c = a.matched;
    if (!m || !c.length) return -1;
    const p = c.findIndex(bt.bind(null, m));
    if (p > -1) return p;
    const h = Ee(l[f - 2]);
    return f > 1 && Ee(m) === h && c[c.length - 1].path !== h ? c.findIndex(bt.bind(null, l[f - 2])) : p;
  }), u = U(() => n.value > -1 && ma(a.params, o.value.params)), g = U(() => n.value > -1 && n.value === a.matched.length - 1 && Ye(a.params, o.value.params));
  function x(l = {}) {
    if (ga(l)) {
      const f = r[z(t.replace) ? "replace" : "push"](z(t.to)).catch(Pt);
...
const fa = /* @__PURE__ */ Ft({
  ...
  useLink: Ae,
  setup(t, { slots: r }) {
    const a = ir(Ae(t)), { options: o } = zt(de), n = U(() => ({
...
function ma(t, r) {
  for (const a in r) {
    ...
    if (typeof o == "string") {
      if (o !== n) return !1;
    } else if (!J(n) || n.length !== o.length || o.some((u, g) => u.valueOf() !== n[g].valueOf())) return !1;
  }
  return !0;
}
function Ee(t) {
...
const Re = (t, r, a) => t ?? r ?? a, va = /* @__PURE__ */ Ft({
  name: "RouterView",
  inheritAttrs: !1,
  props: {
    name: {
  ...
  setup(t, { attrs: r, slots: a }) {
    const o = zt(oe), n = U(() => t.route || o.value), u = zt(he, 0), g = U(() => {
      let f = z(u);
    ...
    qt(he, U(() => g.value + 1)), qt(vr, x), qt(oe, n);
    const l = mt();
    return sr(() => [
      l.value,
      x.value,
      ...
      m && (m.instances[c] = f, h && h !== m && f && f === p && (m.leaveGuards.size || (m.leaveGuards = h.leaveGuards), m.updateGuards.size || (m.updateGuards = h.updateGuards))), f && m && (!h || !bt(m, h) || !p) && (m.enterCallbacks[c] || []).forEach((I) => I(f));
    }, { flush: "post" }), () => {
      const f = n.value, m = t.name, c = x.value, p = c && c.components[m];
      if (!p) return Le(a.default, {
        Component: p,
        route: f
      });
      const h = c.props[m], R = h ? h === !0 ? f.params : typeof h == "function" ? h(f) : h : null, B = Bt(p, S({}, R, r, {
        onVnodeUnmounted: (P) => {
...
const xa = va;
function ba(t) {
  const r = sa(t.routes, t), a = t.parseQuery || Fr, o = t.stringifyQuery || xe, n = t.history, u = Lt(), g = Lt(), x = Lt(), l = or(at);
  let f = at;
  vt && t.scrollBehavior && "scrollRestoration" in history && (history.scrollRestoration = "manual");
  const m = Wt.bind(null, (s) => "" + s), c = Wt.bind(null, Nr), p = Wt.bind(null, Ut);
  function h(s, b) {
    let v, y;
    return Xe(s) ? (v = r.getRecordMatcher(s), y = b) : y = s, r.addRoute(y, v);
  }
  function R(s) {
  ...
  function _(s, b) {
    if (f !== s) return xt(H.NAVIGATION_CANCELLED, {
      from: b,
      to: s
    });
  }
  ...
  function W(s, b) {
    const v = f = P(s), y = l.value, N = s.state, j = s.force, M = s.replace === !0, A = tt(v, y);
    if (A) return W(S(L(A), {
    ...
    D.redirectedFrom = b;
    let Et;
    return !j && zr(o, y, v) && (Et = xt(H.NAVIGATION_DUPLICATED, {
      to: D,
      from: y
  ...
  function K(s, b) {
    ...
    return v.push(M), ft(v).then(() => {
      v = [];
      for (const A of u.list()) v.push(it(A, s, b));
      return v.push(M), ft(v);
    }).then(() => {
      ...
      return v.push(M), ft(v);
    }).then(() => (s.matched.forEach((A) => A.enterCallbacks = {}), v = Yt(j, "beforeRouteEnter", s, b, wt), v.push(M), ft(v))).then(() => {
      v = [];
  ...
  function Vt() {
    lt || (lt = n.listen((s, b, v) => {
      ...
      f = y;
      const j = l.value;
      vt && Gr(ve(j.fullPath, v.delta), Zt()), K(y, j).catch((M) => rt(M, H.NAVIGATION_ABORTED | H.NAVIGATION_CANCELLED) ? M : rt(M, H.NAVIGATION_GUARD_REDIRECT) ? (W(S(L(M.to), { force: !0 }), y).then((A) => {
  ...
  const _t = /* @__PURE__ */ new Set(), At = {
    ...
    isReady: Z,
    install(s) {
      s.component("RouterLink", ha), s.component("RouterView", xa), s.config.globalProperties.$router = At, Object.defineProperty(s.config.globalProperties, "$route", {
        enumerable: !0,
        get: () => z(l)
      ...
      s.provide(de, At), s.provide(Fe, nr(b)), s.provide(oe, l);
      const v = s.unmount;
      _t.add(s), s.unmount = function() {
        _t.delete(s), _t.size < 1 && (f = at, lt && lt(), lt = null, l.value = at, w = !1, pt = !1), v();
      };
    }
  };
  function ft(s) {
...
const ka = /* @__PURE__ */ rr(wa, [["render", ya]]);
const Ca = (t) => {
  for (const r in t)
...
const Ra = ({
  ...
  "svg",
  {
    ...
    height: g,
    stroke: x,
    "stroke-width": Me(a) || Me(o) || a === !0 || o === !0 ? Number(n || u || Mt["stroke-width"]) * 24 / Number(g) : n || u || Mt["stroke-width"],
    class: _a(
      "lucide",
      l.class,
  ...
  [...r.map((m) => Bt(...m)), ...f.default ? [f.default()] : []]
);
const $ = (t, r) => (a, { slots: o, attrs: n }) => Bt(
  Ra,
  {
    ...n,
    ...a,
...
}, Ho = { class: "grid grid-cols-1 md:grid-cols-2 gap-8" }, To = { class: "h-12 w-12 rounded-full bg-white/10 flex items-center justify-center mb-6" }, jo = { class: "text-2xl font-bold mb-3" }, Do = { class: "text-primary-foreground/70 leading-relaxed" }, Go = { class: "py-24 bg-card/30" }, $o = { class: "container mx-auto px-4 md:px-6" }, Uo = { class: "max-w-4xl mx-auto" }, Fo = { class: "space-y-12 relative before:absolute before:inset-0 before:ml-5 before:-translate-x-px md:before:mx-auto md:before:translate-x-0 before:h-full before:w-0.5 before:bg-gradient-to-b before:from-transparent before:via-border before:to-transparent" }, Zo = { class: "flex items-center justify-center w-10 h-10 rounded-full border border-primary bg-background shadow shrink-0 md:order-1 md:group-odd:-translate-x-1/2 md:group-even:translate-x-1/2 relative z-10 text-primary font-bold" }, qo = { class: "w-[calc(100%-4rem)] md:w-[calc(50%-2.5rem)] p-6 rounded-2xl bg-white border border-border shadow-sm transition-all hover:shadow-md" }, Wo = { class: "font-bold text-lg mb-2" }, Ko = { class: "text-muted-foreground text-sm leading-relaxed" }, Qo = { class: "py-24 bg-white border-y border-border overflow-hidden" }, Yo = { class: "container mx-auto px-4 md:px-6" }, Xo = {
  key: 0,
...
}, ln = { class: "text-3xl md:text-4xl font-bold text-primary mb-1" }, dn = { class: "text-sm font-medium text-muted-foreground uppercase tracking-wider" }, cn = { class: "py-24 bg-card/30" }, pn = { class: "container mx-auto px-4 md:px-6" }, un = { class: "grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl mx-auto" }, fn = { class: "h-10 w-10 rounded-full bg-primary/5 border border-primary/10 flex items-center justify-center shrink-0" }, hn = { class: "font-bold text-lg mb-1" }, gn = { class: "text-muted-foreground text-sm" }, mn = {
  id: "analytics",
  class: "py-24 bg-card border-y border-border"
}, vn = { class: "container mx-auto px-4 md:px-6" }, xn = { class: "grid grid-cols-1 lg:grid-cols-2 gap-12 mb-12" }, bn = { class: "space-y-8" }, wn = { class: "flex flex-wrap gap-2 text-sm font-medium items-center" }, yn = { class: "p-6 bg-white border border-primary/20 rounded-2xl shadow-sm relative overflow-hidden" }, kn = { class: "flex flex-col gap-4" }, Cn = { class: "flex items-center gap-4" }, _n = { class: "bg-white p-6 md:p-8 rounded-2xl border border-border shadow-sm flex flex-col justify-center" }, An = { class: "w-full overflow-hidden" }, En = ["viewBox"], Rn = ["y1", "x2", "y2"], Ln = ["x", "y"], Mn = ["x", "y"], Nn = ["points"], In = ["points"], Sn = ["cx", "cy"], Pn = ["y"], zn = ["y"], Bn = ["y"], On = ["y"], Vn = { class: "py-24 bg-card/30" }, Hn = { class: "container mx-auto px-4 md:px-6" }, Tn = { class: "mb-20 bg-primary text-primary-foreground rounded-3xl p-10 md:p-14 relative overflow-hidden" }, jn = { class: "relative z-10 max-w-3xl" }, Dn = { class: "grid grid-cols-1 md:grid-cols-3 gap-6" }, Gn = { class: "text-4xl font-bold mb-1" }, $n = { class: "font-semibold mb-1" }, Un = { class: "text-primary-foreground/60 text-sm" }, Fn = { class: "mb-20" }, Zn = { class: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6" }, qn = { class: "flex items-start gap-4 mb-5" }, Wn = { class: "h-12 w-12 rounded-xl bg-primary/5 border border-primary/10 flex items-center justify-center shrink-0 group-hover:bg-primary group-hover:border-primary transition-colors" }, Kn = { class: "flex-1" }, Qn = { class: "text-2xl font-bold text-primary" }, Yn = { class: "text-xs text-muted-foreground uppercase tracking-wider" }, Xn = { class: "font-bold text-lg mb-2" }, Jn = { class: "text-sm text-muted-foreground leading-relaxed" }, ti = { class: "bg-white rounded-3xl border border-border p-10 md:p-14 shadow-sm" }, ei = { class: "grid grid-cols-1 lg:grid-cols-2 gap-12 items-center" }, ri = { class: "space-y-5" }, ai = { class: "flex justify-between items-center mb-3" }, oi = { class: "font-semibold text-sm" }, ni = { class: "text-xs text-muted-foreground font-medium bg-green-50 text-green-700 px-2 py-0.5 rounded-full border border-green-100" }, ii = { class: "flex gap-4 items-center" }, si = { class: "flex-1" }, li = { class: "flex justify-between text-xs text-muted-foreground mb-1" }, di = { class: "font-semibold text-foreground" }, ci = { class: "h-2 bg-secondary rounded-full overflow-hidden" }, pi = { class: "flex-1" }, ui = { class: "flex justify-between text-xs text-muted-foreground mb-1" }, fi = { class: "font-bold text-primary" }, hi = { class: "h-2 bg-secondary rounded-full overflow-hidden" }, gi = ["viewBox"], mi = ["y1", "x2", "y2"], vi = ["x", "y"], xi = ["x", "y", "height"], bi = ["x", "y", "height"], wi = ["x", "y"], yi = ["x", "y"], ki = { class: "mt-12 pt-10 border-t border-border grid grid-cols-1 md:grid-cols-3 gap-6" }, Ci = { class: "text-3xl font-bold text-primary mb-2" }, _i = { class: "font-bold mb-2" }, Ai = { class: "text-sm text-muted-foreground leading-relaxed" }, Ei = { class: "py-24 bg-card/30" }, Ri = { class: "container mx-auto px-4 md:px-6 text-center" }, Li = { class: "grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto" }, Mi = { class: "p-8 rounded-2xl bg-white border border-border shadow-sm flex flex-col h-full opacity-70" }, Ni = { class: "h-12 w-12 bg-destructive/10 text-destructive rounded-full flex items-center justify-center mb-6 mx-auto" }, Ii = { class: "p-8 rounded-2xl bg-primary text-primary-foreground border border-primary shadow-xl flex flex-col h-full md:-translate-y-4" }, Si = { class: "h-12 w-12 bg-white text-primary rounded-full flex items-center justify-center mb-6 mx-auto shadow-inner" }, Pi = { class: "py-32 bg-primary relative overflow-hidden" }, zi = { class: "container mx-auto px-4 md:px-6 relative z-10 text-center" }, Bi = { class: "flex flex-col sm:flex-row gap-4 justify-center" }, Oi = { class: "rounded-full h-14 px-10 text-lg font-bold bg-white text-primary hover:bg-card shadow-xl transition-transform hover:scale-105" }, Vi = ["href"], Hi = {
  key: 0,
...
}, Ti = { class: "bg-white border-t border-border pt-20 pb-10" }, ji = { class: "container mx-auto px-4 md:px-6" }, Di = { class: "grid grid-cols-1 md:grid-cols-4 gap-12 mb-16" }, Gi = { class: "md:col-span-1" }, $i = ["src"], Ui = {
  key: 0,
  class: "text-sm text-muted-foreground mb-6 max-w-xs"
}, Fi = { key: 0 }, Zi = { class: "pt-8 border-t border-border flex flex-col md:flex-row items-center justify-between gap-4" }, qi = { class: "text-sm text-muted-foreground" }, Wi = {
  key: 0,
  class: "flex gap-4"
}, re = 460, dt = 260, Nt = 50, Ki = 20, It = 20, Qi = 40, Dt = 3800, Te = 9e3, ae = 460, je = 340, St = 50, De = 20, ot = 20, Yi = 60, Gt = 28, Ge = 6, Xi = /* @__PURE__ */ Ft({
  __name: "LandingPage",
  setup(t) {
    ...
    const l = [
      ...
      { icon: ze, title: "Trade Association Access", desc: "Premium introductions and networking within key global trade organizations." },
    ...
    ], L = U(() => re - Nt - Ki), _ = U(() => dt - It - Qi);
    function F(Z) {
      return Nt + Z / (P.length - 1) * L.value;
    }
    function Y(Z) {
      return It + _.value - (Z - Dt) / (Te - Dt) * _.value;
    }
    const tt = U(
...
Revenue`, before: 30, after: 65 }
    ], wt = U(() => ae - St - De), K = U(() => je - ot - Yi), st = U(() => wt.value / Ot.length);
    function yt(Z) {
      const i = St + Z * st.value, ut = Gt * 2 + Ge;
    ...
    const kt = [
      ...
      { icon: ze, title: "Managed Logistics End-to-End", detail: "From factory gate to last-mile delivery globally. No freight broker negotiations, no warehouse coordination — fully handled.", metric: "100%", metricLabel: "Logistics Managed" },
        ...
        e("header", {
          ...
          e("div", Pa, [
            V(ut, {
              ...
              default: $t(() => [
                e("img", {
                  ...
                  class: ht(["h-8 w-auto transition-all duration-300", r.value ? "" : "brightness-0 invert"])
                }, null, 10, za)
              ]),
              _: 1
            }),
            ...
            e("div", Ba, [
              e("button", Oa, [
                e("a", {
                  href: u.value.view_pub
                }, " View Publications ", 8, Va)
              ]),
              e("button", Ha, [
                e("a", {
                  href: u.value.reg_supplier
            ...
            e("button", {
              ...
              a.value ? (k(), nt(z(Ve), {
                key: 0,
                class: ht(r.value ? "text-foreground" : "text-white")
              }, null, 8, ["class"])) : (k(), nt(z(Ia), {
                key: 1,
                class: ht(r.value ? "text-foreground" : "text-white")
              }, null, 8, ["class"]))
            ])
        ...
        e("main", null, [
          e("section", Fa, [
            (k(), E(O, null, T(l, (d, w) => e("div", {
              key: w,
              class: ht(["absolute inset-0 transition-opacity duration-1000", w === o.value ? "opacity-100" : "opacity-0"])
            }, [
            ...
            e("div", Xa, [
              e("div", Ja, [
                (k(), E(O, null, T(l, (d, w) => e("button", {
                  ...
                  class: ht(["h-1 rounded-full transition-all duration-300", w === o.value ? "w-12 bg-white" : "w-4 bg-white/30"]),
          ...
          e("section", eo, [
            e("div", ro, [
              n.value.A ? (k(), E("div", ao, [...i[3] || (i[3] = [
                X('<div class="flex flex-col items-center" data-v-6e33ef57><span class="text-4xl md:text-5xl font-bold text-primary mb-2 tracking-tight" data-v-6e33ef57>1000+</span><span class="text-muted-foreground font-medium uppercase tracking-wider text-sm" data-v-6e33ef57>Storefronts</span></div><div class="flex flex-col items-center" data-v-6e33ef57><span class="text-4xl md:text-5xl font-bold text-primary mb-2 tracking-tight" data-v-6e33ef57>50+</span><span class="text-muted-foreground font-medium uppercase tracking-wider text-sm" data-v-6e33ef57>Countries</span></div><div class="flex flex-col items-center" data-v-6e33ef57><span class="text-4xl md:text-5xl font-bold text-primary mb-2 tracking-tight" data-v-6e33ef57>AI</span><span class="text-muted-foreground font-medium uppercase tracking-wider text-sm" data-v-6e33ef57>Architecture</span></div><div class="flex flex-col items-center" data-v-6e33ef57><span class="text-4xl md:text-5xl font-bold text-primary mb-2 tracking-tight" data-v-6e33ef57>360°</span><span class="text-muted-foreground font-medium uppercase tracking-wider text-sm" data-v-6e33ef57>Logistics</span></div>', 4)
              ])])) : et("", !0),
              e("div", oo, [
          ...
          e("section", lo, [
            ...
            e("div", co, [
              e("div", po, [
                e("div", uo, [
                  i[4] || (i[4] = X('<div class="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-primary/5 border border-primary/10 text-primary text-sm font-semibold mb-6" data-v-6e33ef57><span class="flex h-2 w-2 rounded-full bg-primary" data-v-6e33ef57></span> The Platform </div><h2 class="text-3xl md:text-5xl font-bold mb-6 tracking-tight leading-tight" data-v-6e33ef57> The Infrastructure for Global Fashion Trade </h2><p class="text-lg text-muted-foreground mb-8 leading-relaxed" data-v-6e33ef57> MN Supplierhub is the operating system for fashion manufacturers, wholesalers, and retailers. We digitize factory floors and connect them directly to global demand through <span class="font-semibold text-foreground" data-v-6e33ef57>Onamoda Product Central</span> — our centralized fashion product repository. </p>', 3)),
                  e("div", fo, [
                    (k(), E(O, null, T(m, (d, w) => e("div", {
                      ...
                      e("div", ho, [
                        V(z(Pe), { class: "h-3 w-3 text-primary" })
                      ]),
                      e("span", go, C(d), 1)
                    ])), 64))
                  ])
                ...
                e("div", mo, [
                  e("div", vo, [
                    e("div", xo, [
                      e("div", bo, [
                        e("div", wo, [
                          V(z(Na), { class: "h-5 w-5 text-muted-foreground" }),
                          i[5] || (i[5] = e("span", { class: "font-bold" }, "Fragmented Factories", -1))
                        ])
                      ]),
                      e("div", yo, [
                        V(z(Xt), { class: "h-6 w-6 rotate-45" })
                      ]),
                      e("div", ko, [
                        e("div", Co, [
                          V(z(jt), { class: "h-6 w-6" })
                        ]),
                        i[6] || (i[6] = e("div", null, [
                      ...
                      e("div", Ao, [
                        e("div", Eo, [
                          V(z(Jt), { class: "h-6 w-6 text-muted-foreground mb-2" }),
                          i[7] || (i[7] = e("span", { class: "font-bold text-sm" }, "Global B2B Buyers", -1))
                        ]),
                        e("div", Ro, [
                          V(z(gt), { class: "h-6 w-6 text-muted-foreground mb-2" }),
          ...
          e("section", Qo, [
            e("div", Yo, [
              i[17] || (i[17] = X('<div class="text-center max-w-3xl mx-auto mb-16" data-v-6e33ef57><div class="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-primary/5 border border-primary/10 text-primary text-sm font-semibold mb-6" data-v-6e33ef57><span class="flex h-2 w-2 rounded-full bg-primary" data-v-6e33ef57></span> Global Reach </div><h2 class="text-3xl md:text-5xl font-bold mb-6 tracking-tight" data-v-6e33ef57>Unlimited Storefronts. <div data-v-6e33ef57>One Platform.</div></h2><p class="text-lg text-muted-foreground" data-v-6e33ef57> Your products, instantly visible across our pre-established global retail network — without building a single sales team. </p></div>', 1)),
          ...
          e("section", mn, [
            e("div", vn, [
                ...
                e("div", bn, [
                  e("div", null, [
                    ...
                    e("div", wn, [
                      ...
                      V(z(Tt), { class: "h-4 w-4 text-muted-foreground" }),
                  ...
                  e("div", yn, [
                    ...
                    e("div", kn, [
                      e("div", Cn, [
                        ...
                        V(z(Ie), { class: "h-5 w-5 text-primary" }),
                        i[28] || (i[28] = e("span", { class: "px-6 py-3 bg-white border-2 border-primary font-bold rounded-xl shadow-sm" }, "MN Aggregator", -1))
                      ]),
                      i[29] || (i[29] = X('<div class="pl-32 flex gap-8 relative" data-v-6e33ef57><div class="absolute left-[8.5rem] top-[-1rem] bottom-4 w-px bg-primary/30" data-v-6e33ef57></div><div class="absolute left-[8.5rem] top-1/2 w-4 h-px bg-primary/30" data-v-6e33ef57></div><div class="flex flex-col gap-4 w-full" data-v-6e33ef57><span class="px-4 py-2 bg-card border border-border font-medium rounded-lg" data-v-6e33ef57>B2B Buyers</span><span class="px-4 py-2 bg-card border border-border font-medium rounded-lg" data-v-6e33ef57>B2C Consumers</span></div></div>', 1))
                    ])
                  ])
                ]),
                e("div", _n, [
                  ...
                  e("div", An, [
                    (k(), E("svg", {
                      ...
                      (k(), E(O, null, T(5, (d) => e("text", {
                        ...
                        fill: "#888",
                        "font-size": "11"
                      }, C(Math.round(Dt + (d - 1) / 4 * (Te - Dt) / 1e3)) + "k", 9, Mn)), 64)),
                      e("polyline", {
                        points: tt.value,
                        fill: "none",
                        stroke: "#a3a3a3",
              ...
              i[34] || (i[34] = X('<div class="grid grid-cols-1 md:grid-cols-3 gap-6" data-v-6e33ef57><div class="rounded-2xl border border-border bg-card p-6" data-v-6e33ef57><p class="text-sm text-muted-foreground mb-1" data-v-6e33ef57>Estimated Growth</p><p class="text-4xl font-bold text-primary mb-4" data-v-6e33ef57>+77%</p><div class="flex items-center justify-between text-sm" data-v-6e33ef57><span class="text-muted-foreground" data-v-6e33ef57>Profit Simulation</span><span class="font-bold" data-v-6e33ef57>₹4.8Cr → ₹8.5Cr</span></div><div class="w-full bg-secondary h-2 mt-3 rounded-full overflow-hidden" data-v-6e33ef57><div class="bg-primary h-full rounded-full" style="width:77%;" data-v-6e33ef57></div></div></div><div class="rounded-2xl border border-border bg-card p-6" data-v-6e33ef57><p class="text-sm text-muted-foreground mb-1" data-v-6e33ef57>Inventory Reduction</p><p class="text-4xl font-bold text-primary mb-4" data-v-6e33ef57>20–30%</p><p class="text-sm text-muted-foreground" data-v-6e33ef57>Through AI predictive demand forecasting rather than guesswork.</p></div><div class="rounded-2xl border border-border bg-card p-6" data-v-6e33ef57><p class="text-sm text-muted-foreground mb-1" data-v-6e33ef57>Waste Reduction</p><p class="text-4xl font-bold text-primary mb-4" data-v-6e33ef57>15–25%</p><p class="text-sm text-muted-foreground" data-v-6e33ef57>Optimized raw material procurement aligned with actual sales data.</p></div></div>', 1))
            ])
          ]),
          e("section", Vn, [
            e("div", Hn, [
              i[46] || (i[46] = X('<div class="text-center max-w-3xl mx-auto mb-20" data-v-6e33ef57><div class="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-primary/5 border border-primary/10 text-primary text-sm font-semibold mb-6" data-v-6e33ef57><span class="flex h-2 w-2 rounded-full bg-primary" data-v-6e33ef57></span> Why India. Why Now. </div><h2 class="text-3xl md:text-5xl font-bold mb-6 tracking-tight leading-tight" data-v-6e33ef57>Why Indian Suppliers Should Adapt Now</h2><p class="text-lg text-muted-foreground leading-relaxed" data-v-6e33ef57> India possesses the world&#39;s most versatile textile base — 6,000+ year legacy in craft, the second-largest cotton producer globally, unmatched product diversity. Yet its export share is a fraction of its true potential. The single barrier: coordination infrastructure. MN Supplierhub is that infrastructure. </p></div>', 1)),
              e("div", Tn, [
                i[37] || (i[37] = e("div", {
                  class: "absolute inset-0 opacity-10",
              ...
              e("div", ti, [
                ...
                e("div", ei, [
                  e("div", ri, [
                      ...
                      e("div", ii, [
                        ...
                        e("div", pi, [
                          e("div", ui, [
                            ...
                            e("span", fi, C(d.after) + C(d.suffix), 1)
                          ]),
                          e("div", hi, [
                            e("div", {
                    ...
                    i[42] || (i[42] = X('<div class="rounded-xl bg-primary text-primary-foreground p-6 flex items-center justify-between" data-v-6e33ef57><div data-v-6e33ef57><div class="text-sm text-primary-foreground/70 mb-1" data-v-6e33ef57>Net Estimated Profit Uplift</div><div class="text-4xl font-bold" data-v-6e33ef57>+₹3.7 Crore</div><div class="text-primary-foreground/60 text-sm mt-1" data-v-6e33ef57>₹4.8 Cr → ₹8.5 Cr annually</div></div><div class="text-right" data-v-6e33ef57><div class="text-5xl font-bold opacity-90" data-v-6e33ef57>+77%</div><div class="text-primary-foreground/60 text-sm" data-v-6e33ef57>Estimated growth</div></div></div>', 1))
                  ]),
                  e("div", null, [
...
`)[1] || ""), 9, yi)
                    ...
                    i[44] || (i[44] = X('<div class="flex gap-6 justify-center mt-2 text-sm" data-v-6e33ef57><div class="flex items-center gap-2" data-v-6e33ef57><div class="h-3 w-3 rounded bg-gray-300" data-v-6e33ef57></div><span class="text-muted-foreground" data-v-6e33ef57>Before MN Supplierhub</span></div><div class="flex items-center gap-2" data-v-6e33ef57><div class="h-3 w-3 rounded bg-primary" data-v-6e33ef57></div><span class="text-muted-foreground" data-v-6e33ef57>After MN Supplierhub</span></div></div>', 1))
                  ])
                ]),
                e("div", ki, [
          ...
          e("section", Ei, [
            e("div", Ri, [
              ...
              e("div", Li, [
                e("div", Mi, [
                  e("div", Ni, [
                    V(z(Ve), { class: "h-6 w-6" })
                  ]),
                  i[47] || (i[47] = X('<h3 class="text-xl font-bold mb-4" data-v-6e33ef57>Without Aggregation</h3><ul class="space-y-4 text-left mt-auto" data-v-6e33ef57><li class="flex gap-3 text-muted-foreground" data-v-6e33ef57><span class="text-destructive font-bold" data-v-6e33ef57>•</span> Fragmented order volumes</li><li class="flex gap-3 text-muted-foreground" data-v-6e33ef57><span class="text-destructive font-bold" data-v-6e33ef57>•</span> High middleman dependency</li><li class="flex gap-3 text-muted-foreground" data-v-6e33ef57><span class="text-destructive font-bold" data-v-6e33ef57>•</span> Razor-thin production margins</li><li class="flex gap-3 text-muted-foreground" data-v-6e33ef57><span class="text-destructive font-bold" data-v-6e33ef57>•</span> Zero brand equity built</li></ul>', 2))
                ]),
                e("div", Ii, [
                  e("div", Si, [
                    V(z(Pe), { class: "h-6 w-6" })
                  ]),
                  i[48] || (i[48] = X('<h3 class="text-xl font-bold mb-4 text-white" data-v-6e33ef57>With MN Hybrid Aggregation</h3><ul class="space-y-4 text-left mt-auto" data-v-6e33ef57><li class="flex gap-3" data-v-6e33ef57><span class="text-white font-bold" data-v-6e33ef57>✓</span> AI-driven ecosystem matching</li><li class="flex gap-3" data-v-6e33ef57><span class="text-white font-bold" data-v-6e33ef57>✓</span> Global direct-to-buyer infrastructure</li><li class="flex gap-3" data-v-6e33ef57><span class="text-white font-bold" data-v-6e33ef57>✓</span> Premium margin capture</li><li class="flex gap-3" data-v-6e33ef57><span class="text-white font-bold" data-v-6e33ef57>✓</span> Long-term brand building capacity</li></ul>', 2))
                ])
              ])
            ])
          ]),
          ...
          e("div", ji, [
            e("div", Di, [
              e("div", Gi, [
                ...
                n.value.G ? (k(), E("p", Ui, " The global infrastructure that connects Indian and global fashion manufacturers into a unified hybrid commerce ecosystem. ")) : et("", !0)
              ]),
              ...
              n.value.F ? (k(), E("div", Fi, [...i[54] || (i[54] = [
            ...
            e("div", Zi, [
              e("p", qi, "© " + C((/* @__PURE__ */ new Date()).getFullYear()) + " MN Group. All rights reserved.", 1),
              n.value.I ? (k(), E("div", Wi, [...i[56] || (i[56] = [
                X('<a href="#" class="text-muted-foreground hover:text-primary transition-colors" data-v-6e33ef57><span class="sr-only" data-v-6e33ef57>LinkedIn</span><svg class="h-5 w-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true" data-v-6e33ef57><path fill-rule="evenodd" d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z" clip-rule="evenodd" data-v-6e33ef57></path></svg></a><a href="#" class="text-muted-foreground hover:text-primary transition-colors" data-v-6e33ef57><span class="sr-only" data-v-6e33ef57>Twitter</span><svg class="h-5 w-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true" data-v-6e33ef57><path d="M8.29 20.251c7.547 0 11.675-6.253 11.675-11.675 0-.178 0-.355-.012-.53A8.348 8.348 0 0022 5.92a8.19 8.19 0 01-2.357.646 4.118 4.118 0 001.804-2.27 8.224 8.224 0 01-2.605.996 4.107 4.107 0 00-6.993 3.743 11.65 11.65 0 01-8.457-4.287 4.106 4.106 0 001.27 5.477A4.072 4.072 0 012.8 9.713v.052a4.105 4.105 0 003.292 4.022 4.095 4.095 0 01-1.853.07 4.108 4.108 0 003.834 2.85A8.233 8.233 0 012 18.407a11.616 11.616 0 006.29 1.84" data-v-6e33ef57></path></svg></a>', 2)
              ])])) : et("", !0)
            ])
          ])
        ])
...
}), Ji = /* @__PURE__ */ rr(Xi, [["__scopeId", "data-v-6e33ef57"]]), ts = { class: "min-h-screen w-full flex items-center justify-center bg-gray-50" }, es = { class: "w-full max-w-md mx-4 bg-white rounded-xl border border-gray-200 shadow-sm p-6" }, rs = { class: "flex mb-4 gap-2 items-center" }, as = /* @__PURE__ */ Ft({
  __name: "NotFound",
  setup(t) {
    return (r, a) => {
      ...
      return k(), E("div", ts, [
        e("div", es, [
          e("div", rs, [
            V(z(Ma), { class: "h-8 w-8 text-red-500" }),
