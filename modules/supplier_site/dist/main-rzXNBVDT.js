import { H as nr, d as Zt, I as B, J as ir, K as sr, L as Ot, M as U, O as Vt, P as Wt, Q as xt, R as lr, U as dr, V as de, W as st, E as k, X as cr, Y as pr, D as E, Z as e, _ as at, a as z, $ as rt, p as mt, a0 as ut, F as V, a1 as T, a2 as C, a3 as ue, a4 as J, a5 as Mt, q as fe, c as ur } from "./runtime-dom.esm-bundler-flriJ5oA.js";
import { s as fr } from "./style-inject.es-CQKlVflb.js";
...
function ot(t, r) {
  return t instanceof Error && Fe in t && (r == null || !!(t.type & r));
}
const gr = [
  "params",
  "query",
...
function mr(t) {
  ...
  const r = {};
  for (const a of gr) a in t && (r[a] = t[a]);
  return JSON.stringify(r, null, 2);
}
const vr = /* @__PURE__ */ Symbol(""), ge = /* @__PURE__ */ Symbol(""), ce = /* @__PURE__ */ Symbol(""), Ze = /* @__PURE__ */ Symbol(""), ne = /* @__PURE__ */ Symbol("");
const qe = /#/g, xr = /&/g, br = /\//g, wr = /=/g, yr = /\?/g, We = /\+/g, kr = /%5B/g, Cr = /%5D/g, Ke = /%5E/g, _r = /%60/g, Qe = /%7B/g, Ar = /%7C/g, Ye = /%7D/g, Er = /%20/g;
function pe(t) {
  return t == null ? "" : encodeURI("" + t).replace(Ar, "|").replace(kr, "[").replace(Cr, "]");
}
function Rr(t) {
  return pe(t).replace(Qe, "{").replace(Ye, "}").replace(Ke, "^");
}
function ie(t) {
  return pe(t).replace(We, "%2B").replace(Er, "+").replace(qe, "%23").replace(xr, "%26").replace(_r, "`").replace(Qe, "{").replace(Ye, "}").replace(Ke, "^");
}
function Lr(t) {
  return ie(t).replace(wr, "%3D");
}
function Mr(t) {
  return pe(t).replace(qe, "%23").replace(yr, "%3F");
}
function Nr(t) {
...
function Qt(t, r, a = "/") {
  ...
  const x = r.indexOf("#");
  let l = r.indexOf("?");
  return l = x >= 0 && l > x ? -1 : l, l >= 0 && (o = r.slice(0, l), u = r.slice(l, x > 0 ? x : r.length), n = t(u.slice(1))), x >= 0 && (o = o || r.slice(0, x), g = r.slice(x, r.length)), o = Or(o ?? r, a), {
    fullPath: o + u + g,
    path: o,
    query: n,
    hash: Ft(g)
...
function zr(t, r, a) {
  ...
  return o > -1 && o === n && yt(r.matched[o], a.matched[n]) && Xe(r.params, a.params) && t(r.query) === t(a.query) && r.hash === a.hash;
}
function yt(t, r) {
...
function Xe(t, r) {
  ...
  for (var a in t) if (!Br(t[a], r[a])) return !1;
  return !0;
}
function Br(t, r) {
  return tt(t) ? ve(t, r) : tt(r) ? ve(r, t) : (t && t.valueOf()) === (r && r.valueOf());
}
function ve(t, r) {
  return tt(r) ? t.length === r.length && t.every((a, o) => a === r[o]) : t.length === 1 && t[0] === r;
}
function Or(t, r) {
  ...
  (n === ".." || n === ".") && o.push("");
  let u = a.length - 1, g, x;
  for (g = 0; g < o.length; g++)
    if (x = o[g], x !== ".")
      if (x === "..")
        u > 1 && u--;
      else break;
  return a.slice(0, u).join("/") + "/" + o.slice(g).join("/");
}
const nt = {
  path: "/",
  name: void 0,
...
function Fr(t) {
  ...
  for (let o = 0; o < a.length; ++o) {
    const n = a[o].replace(We, " "), u = n.indexOf("="), g = Ft(u < 0 ? n : n.slice(0, u)), x = u < 0 ? null : Ft(n.slice(u + 1));
    if (g in r) {
      let l = r[g];
      tt(l) || (l = r[g] = [l]), l.push(x);
    } else r[g] = x;
  }
  return r;
}
function be(t) {
  ...
  for (let a in t) {
    ...
    (tt(o) ? o.map((n) => n && ie(n)) : [o && ie(o)]).forEach((n) => {
...
function Zr(t) {
  ...
  for (const a in t) {
    const o = t[a];
    o !== void 0 && (r[a] = tt(o) ? o.map((n) => n == null ? null : "" + n) : o == null ? o : "" + o);
  }
  return r;
}
function Nt() {
...
function lt(t, r, a, o, n, u = (g) => g()) {
  const g = o && (o.enterCallbacks[n] = o.enterCallbacks[n] || []);
  return () => new Promise((x, l) => {
    const f = (p) => {
      p === !1 ? l(wt(H.NAVIGATION_ABORTED, {
        from: a,
        to: r
      })) : p instanceof Error ? l(p) : Ur(p) ? l(wt(H.NAVIGATION_GUARD_REDIRECT, {
        from: r,
        to: p
      })) : (g && o.enterCallbacks[n] === g && typeof p == "function" && g.push(p), x());
    }, m = u(() => t.call(o && o.instances[n], r, a, f));
    let c = Promise.resolve(m);
    t.length < 3 && (c = c.then(f)), c.catch((p) => l(p));
  });
}
function Xt(t, r, a, o, n = (u) => u()) {
  const u = [];
  for (const g of t)
    for (const x in g.components) {
      ...
      if (!(r !== "beforeRouteEnter" && !g.instances[x]))
        if (Ue(l)) {
          const f = (l.__vccOpts || l)[r];
          f && u.push(lt(f, a, o, g, x, n));
        } else {
          let f = l();
          u.push(() => f.then((m) => {
...
function qr(t, r) {
  const a = [], o = [], n = [], u = Math.max(r.matched.length, t.matched.length);
  for (let g = 0; g < u; g++) {
    const x = r.matched[g];
    x && (t.matched.find((f) => yt(f, x)) ? o.push(x) : a.push(x));
    const l = t.matched[g];
    l && (r.matched.find((f) => yt(f, l)) || n.push(l));
  }
  return [
    a,
    o,
...
function tr(t, r) {
  const { pathname: a, search: o, hash: n } = r, u = t.indexOf("#");
  if (u > -1) {
    let g = n.includes(t.slice(u)) ? t.slice(u).length : 1, x = n.slice(g);
    return x[0] !== "/" && (x = "/" + x), me(x, "");
  }
  return me(a, t) + o + n;
}
function Kr(t, r, a, o) {
  let n = [], u = [], g = null;
  const x = ({ state: p }) => {
    const h = tr(t, location), R = a.value, I = r.value;
    let O = 0;
    if (p) {
      if (a.value = h, r.value = p, g && g === R) {
        g = null;
        return;
      }
      O = I ? p.position - I.position : 0;
    } else o(h);
    n.forEach((P) => {
      P(a.value, R, {
        delta: O,
        type: se.pop,
        direction: O ? O > 0 ? Yt.forward : Yt.back : Yt.unknown
      });
    });
  };
  function l() {
  ...
  function m() {
    if (document.visibilityState === "hidden") {
      ...
      if (!p.state) return;
      p.replaceState(S({}, p.state, { scroll: qt() }), "");
    }
  }
  function c() {
    for (const p of u) p();
    u = [], window.removeEventListener("popstate", x), window.removeEventListener("pagehide", m), document.removeEventListener("visibilitychange", m);
  }
...
function Qr(t) {
  ...
  function u(l, f, m) {
    const c = t.indexOf("#"), p = c > -1 ? (a.host && document.querySelector("base") ? t : t.slice(c)) + l : Wr() + t + l;
    try {
      r[m ? "replaceState" : "pushState"](f, "", p), n.value = f;
    } catch (h) {
      console.error(h), a[m ? "replace" : "assign"](p);
    }
  }
  function g(l, f) {
    u(l, S({}, r.state, we(n.value.back, l, n.value.forward, !0), f, { position: n.value.position }), !0), o.value = l;
  }
  function x(l, f) {
    ...
    u(m.current, m, !0), u(l, S({}, we(o.value, l, null), { position: m.position + 1 }, f), !1), o.value = l;
  }
  return {
    location: o,
    state: n,
...
function Yr(t) {
  ...
  function o(u, g = !0) {
    g || a.pauseListeners(), history.go(u);
  }
  const n = S({
    location: "",
    base: t,
...
function ta(t) {
  ...
  function c() {
    f && (a === G.Static ? u.push({
      type: ft.Static,
      value: f
    }) : a === G.Param || a === G.ParamRegExp || a === G.ParamRegExpEnd ? (u.length > 1 && (l === "*" || l === "+") && r(`A repeatable param (${f}) must be alone in its segment. eg: '/:ids+.`), u.push({
      type: ft.Param,
      value: f,
      regexp: m,
      repeatable: l === "*" || l === "+",
      optional: l === "*" || l === "?"
    })) : r("Invalid state to consume buffer"), f = "");
  }
  function p() {
    f += l;
  }
  for (; x < t.length; )
    switch (l = t[x++], a) {
      case G.Static:
        l === "\\" ? (o = a, a = G.EscapeNext) : l === "/" ? (f && c(), g()) : l === ":" ? (c(), a = G.Param) : p();
        break;
      case G.EscapeNext:
        p(), a = o;
        break;
      case G.Param:
        l === "(" ? a = G.ParamRegExp : Jr.test(l) ? p() : (c(), a = G.Static, l !== "*" && l !== "?" && l !== "+" && x--);
        break;
      case G.ParamRegExp:
  ...
  return a === G.ParamRegExp && r(`Unfinished custom RegExp for param "${f}"`), c(), g(), n;
}
const ye = "[^/]+?", ea = {
  sensitive: !1,
  strict: !1,
...
function aa(t, r) {
  ...
  const u = [];
  for (const f of t) {
    const m = f.length ? [] : [q.Root];
    a.strict && !f.length && (n += "/");
    for (let c = 0; c < f.length; c++) {
      const p = f[c];
      let h = q.Segment + (a.sensitive ? q.BonusCaseSensitive : 0);
      if (p.type === ft.Static)
        c || (n += "/"), n += p.value.replace(ra, "\\$&"), h += q.Static;
      else if (p.type === ft.Param) {
        const { value: R, repeatable: I, optional: O, regexp: P } = p;
        u.push({
          name: R,
          repeatable: I,
          optional: O
        ...
        let _ = I ? `((?:${L})(?:/(?:${L}))*)` : `(${L})`;
        c || (_ = O && f.length < 2 ? `(?:/${_})` : "/" + _), O && (_ += "?"), n += _, h += q.Dynamic, O && (h += q.BonusOptional), I && (h += q.BonusRepeatable), L === ".*" && (h += q.BonusWildcard);
      }
      m.push(h);
    }
    o.push(m);
  ...
  if (a.strict && a.end) {
    const f = o.length - 1;
    o[f][o[f].length - 1] += q.BonusStrict;
  }
  ...
  function x(f) {
    ...
    for (let p = 1; p < m.length; p++) {
      const h = m[p] || "", R = u[p - 1];
      c[R.name] = h && R.repeatable ? h.split("/") : h;
    }
    return c;
  }
  function l(f) {
    ...
    for (const p of t) {
      (!c || !m.endsWith("/")) && (m += "/"), c = !1;
      for (const h of p) if (h.type === ft.Static) m += h.value;
      else if (h.type === ft.Param) {
        const { value: R, repeatable: I, optional: O } = h, P = R in f ? f[R] : "";
        if (tt(P) && !I) throw new Error(`Provided param "${R}" is an array but it is not repeatable (* or + modifiers)`);
        const L = tt(P) ? P.join("/") : P;
        if (!L) if (O)
          p.length < 2 && (m.endsWith("/") ? m = m.slice(0, -1) : c = !0);
...
function oa(t, r) {
  ...
  return t.length < r.length ? t.length === 1 && t[0] === q.Static + q.Segment ? -1 : 1 : t.length > r.length ? r.length === 1 && r[0] === q.Static + q.Segment ? 1 : -1 : 0;
}
function er(t, r) {
  let a = 0;
...
function sa(t, r) {
  ...
  function u(c, p, h) {
    const R = !h, I = _e(c);
    I.aliasOf = h && h.record;
    const O = he(r, c), P = [I];
    if ("alias" in c) {
      const F = typeof c.alias == "string" ? [c.alias] : c.alias;
      for (const X of F) P.push(_e(S({}, I, {
        components: h ? h.record.components : I.components,
        path: X,
        aliasOf: h ? h.record : I
      })));
    }
    let L, _;
    for (const F of P) {
      const { path: X } = F;
      if (p && X[0] !== "/") {
        const et = p.record.path, W = et[et.length - 1] === "/" ? "" : "/";
        F.path = p.record.path + (X && W + X);
      }
      if (L = ia(F, p, O), h ? h.alias.push(L) : (_ = _ || L, _ !== L && _.alias.push(L), R && c.name && !Ae(L) && g(c.name)), rr(L) && l(L), I.children) {
        const et = I.children;
        for (let W = 0; W < et.length; W++) u(et[W], L, h && h.children[W]);
      }
      h = h || L;
    }
    return _ ? () => {
  ...
  function g(c) {
    if (Je(c)) {
      const p = o.get(c);
      p && (o.delete(c), a.splice(a.indexOf(p), 1), p.children.forEach(g), p.alias.forEach(g));
    } else {
      const p = a.indexOf(c);
      p > -1 && (a.splice(p, 1), c.record.name && o.delete(c.record.name), c.children.forEach(g), c.alias.forEach(g));
    }
  }
  function x() {
    return a;
  ...
  function l(c) {
    const p = ca(c, a);
    a.splice(p, 0, c), c.record.name && !Ae(c) && o.set(c.record.name, c);
  }
  function f(c, p) {
    let h, R = {}, I, O;
    if ("name" in c && c.name) {
      if (h = o.get(c.name), !h) throw wt(H.MATCHER_NOT_FOUND, { location: c });
      O = h.record.name, R = S(Ce(p.params, h.keys.filter((_) => !_.optional).concat(h.parent ? h.parent.keys.filter((_) => _.optional) : []).map((_) => _.name)), c.params && Ce(c.params, h.keys.map((_) => _.name))), I = h.stringify(R);
    } else if (c.path != null)
      I = c.path, h = a.find((_) => _.re.test(I)), h && (R = h.parse(I), O = h.record.name, h.keys.forEach((_) => {
        _.optional && !R[_.name] && delete R[_.name];
      }));
    else {
      if (h = p.name ? o.get(p.name) : a.find((_) => _.re.test(p.path)), !h) throw wt(H.MATCHER_NOT_FOUND, {
        location: c,
        currentLocation: p
      });
      O = h.record.name, R = S({}, p.params, c.params), I = h.stringify(R);
    }
    const P = [];
    let L = h;
    for (; L; )
...
function Ee(t) {
  const r = Ot(ce), a = Ot(Ze), o = U(() => {
    const l = B(t.to);
    return r.resolve(l);
  }), n = U(() => {
    const { matched: l } = o.value, { length: f } = l, m = l[f - 1], c = a.matched;
    if (!m || !c.length) return -1;
    const p = c.findIndex(yt.bind(null, m));
    if (p > -1) return p;
    const h = Re(l[f - 2]);
    return f > 1 && Re(m) === h && c[c.length - 1].path !== h ? c.findIndex(yt.bind(null, l[f - 2])) : p;
  }), u = U(() => n.value > -1 && ma(a.params, o.value.params)), g = U(() => n.value > -1 && n.value === a.matched.length - 1 && Xe(a.params, o.value.params));
  function x(l = {}) {
    if (ga(l)) {
      const f = r[B(t.replace) ? "replace" : "push"](B(t.to)).catch(Bt);
      return t.viewTransition && typeof document < "u" && "startViewTransition" in document && document.startViewTransition(() => f), f;
    }
...
const fa = /* @__PURE__ */ Zt({
  ...
  useLink: Ee,
  setup(t, { slots: r }) {
    const a = sr(Ee(t)), { options: o } = Ot(ce), n = U(() => ({
      [Le(t.activeClass, o.linkActiveClass, "router-link-active")]: a.isActive,
      [Le(t.exactActiveClass, o.linkExactActiveClass, "router-link-exact-active")]: a.isExactActive
    }));
    return () => {
      const u = r.default && ua(r.default(a));
      return t.custom ? u : Vt("a", {
...
function ma(t, r) {
  for (const a in r) {
    ...
    if (typeof o == "string") {
      if (o !== n) return !1;
    } else if (!tt(n) || n.length !== o.length || o.some((u, g) => u.valueOf() !== n[g].valueOf())) return !1;
  }
  return !0;
}
function Re(t) {
...
const Le = (t, r, a) => t ?? r ?? a, va = /* @__PURE__ */ Zt({
  name: "RouterView",
  inheritAttrs: !1,
  props: {
    name: {
  ...
  setup(t, { attrs: r, slots: a }) {
    const o = Ot(ne), n = U(() => t.route || o.value), u = Ot(ge, 0), g = U(() => {
      let f = B(u);
      const { matched: m } = n.value;
      let c;
      for (; (c = m[f]) && !c.components; ) f++;
      return f;
    }), x = U(() => n.value.matched[g.value]);
    Wt(ge, U(() => g.value + 1)), Wt(vr, x), Wt(ne, n);
    const l = xt();
    return lr(() => [
      l.value,
      x.value,
      ...
      m && (m.instances[c] = f, h && h !== m && f && f === p && (m.leaveGuards.size || (m.leaveGuards = h.leaveGuards), m.updateGuards.size || (m.updateGuards = h.updateGuards))), f && m && (!h || !yt(m, h) || !p) && (m.enterCallbacks[c] || []).forEach((I) => I(f));
    }, { flush: "post" }), () => {
      const f = n.value, m = t.name, c = x.value, p = c && c.components[m];
      if (!p) return Me(a.default, {
        Component: p,
        route: f
      });
      const h = c.props[m], R = h ? h === !0 ? f.params : typeof h == "function" ? h(f) : h : null, O = Vt(p, S({}, R, r, {
        onVnodeUnmounted: (P) => {
...
const xa = va;
function ba(t) {
  const r = sa(t.routes, t), a = t.parseQuery || Fr, o = t.stringifyQuery || be, n = t.history, u = Nt(), g = Nt(), x = Nt(), l = nr(nt);
  let f = nt;
  bt && t.scrollBehavior && "scrollRestoration" in history && (history.scrollRestoration = "manual");
  const m = Kt.bind(null, (s) => "" + s), c = Kt.bind(null, Nr), p = Kt.bind(null, Ft);
  function h(s, b) {
    let v, y;
  ...
  function P(s, b) {
    if (b = S({}, b || l.value), typeof s == "string") {
      const A = Qt(a, s, b.path), D = r.resolve({ path: A.path }, b), Lt = n.createHref(A.fullPath);
      return S(A, D, {
        params: p(D.params),
        redirectedFrom: void 0,
        href: Lt
    ...
    let v;
    if (s.path != null)
      v = S({}, s, { path: Qt(a, s.path, b.path).path });
    else {
      const A = S({}, s.params);
  ...
  function L(s) {
    return typeof s == "string" ? Qt(a, s, l.value.path) : S({}, s);
  }
  function _(s, b) {
    if (f !== s) return wt(H.NAVIGATION_CANCELLED, {
      from: b,
      to: s
    });
  }
  ...
  function W(s, b) {
    const v = f = P(s), y = l.value, N = s.state, j = s.force, M = s.replace === !0, A = et(v, y);
    if (A) return W(S(L(A), {
    ...
    D.redirectedFrom = b;
    let Lt;
    return !j && zr(o, y, v) && (Lt = wt(H.NAVIGATION_DUPLICATED, {
      to: D,
      from: y
    }), Y(y, y, !0, !1)), (Lt ? Promise.resolve(Lt) : K(D, y)).catch((Q) => ot(Q) ? ot(Q, H.NAVIGATION_GUARD_REDIRECT) ? Q : i(Q) : At(Q, D, y)).then((Q) => {
      if (Q) {
        if (ot(Q, H.NAVIGATION_GUARD_REDIRECT))
  ...
  function kt(s) {
    const b = Et.values().next().value;
    return b && typeof b.runWithContext == "function" ? b.runWithContext(s) : s();
  }
  function K(s, b) {
    let v;
    const [y, N, j] = qr(s, b);
    v = Xt(y.reverse(), "beforeRouteLeave", s, b);
    for (const A of y) A.leaveGuards.forEach((D) => {
      v.push(lt(D, s, b));
    });
    const M = Ht.bind(null, s, b);
    return v.push(M), gt(v).then(() => {
      v = [];
      for (const A of u.list()) v.push(lt(A, s, b));
      return v.push(M), gt(v);
    }).then(() => {
      v = Xt(N, "beforeRouteUpdate", s, b);
      ...
      v = [];
      for (const A of j) if (A.beforeEnter) if (tt(A.beforeEnter)) for (const D of A.beforeEnter) v.push(lt(D, s, b));
      else v.push(lt(A.beforeEnter, s, b));
      return v.push(M), gt(v);
    }).then(() => (s.matched.forEach((A) => A.enterCallbacks = {}), v = Xt(j, "beforeRouteEnter", s, b, kt), v.push(M), gt(v))).then(() => {
      v = [];
      for (const A of g.list()) v.push(lt(A, s, b));
      return v.push(M), gt(v);
    }).catch((A) => ot(A, H.NAVIGATION_CANCELLED) ? A : Promise.reject(A));
  }
  function dt(s, b, v) {
    x.list().forEach((y) => kt(() => y(s, b, v)));
  }
  function Ct(s, b, v, y, N) {
    const j = _(s, b);
    if (j) return j;
    const M = b === nt, A = bt ? history.state : {};
    v && (y || M ? n.replace(s.fullPath, S({ scroll: M && A && A.scroll }, N)) : n.push(s.fullPath, N)), l.value = s, Y(s, b, v, M), i();
  }
  let ct;
  function Tt() {
    ct || (ct = n.listen((s, b, v) => {
      if (!Rt.listening) return;
      const y = P(s), N = et(y, Rt.currentRoute.value);
      if (N) {
        W(S(N, {
          replace: !0,
          force: !0
      ...
      f = y;
      const j = l.value;
      bt && Gr(xe(j.fullPath, v.delta), qt()), K(y, j).catch((M) => ot(M, H.NAVIGATION_ABORTED | H.NAVIGATION_CANCELLED) ? M : ot(M, H.NAVIGATION_GUARD_REDIRECT) ? (W(S(L(M.to), { force: !0 }), y).then((A) => {
        ot(A, H.NAVIGATION_ABORTED | H.NAVIGATION_DUPLICATED) && !v.delta && v.type === se.pop && n.go(-1, !1);
      }).catch(Bt), Promise.reject()) : (v.delta && n.go(-v.delta, !1), At(M, y, j))).then((M) => {
        M = M || Ct(y, j, !1), M && (v.delta && !ot(M, H.NAVIGATION_CANCELLED) ? n.go(-v.delta, !1) : v.type === se.pop && ot(M, H.NAVIGATION_ABORTED | H.NAVIGATION_DUPLICATED) && n.go(-1, !1)), dt(y, j, M);
      }).catch(Bt);
    }));
  }
  let _t = Nt(), jt = Nt(), ht;
  ...
  function Z() {
    return ht && l.value !== nt ? Promise.resolve() : new Promise((s, b) => {
      _t.add([s, b]);
    });
  }
  function i(s) {
    return ht || (ht = !s, Tt(), _t.list().forEach(([b, v]) => s ? v(s) : b()), _t.reset()), s;
  }
  function Y(s, b, v, y) {
    const { scrollBehavior: N } = t;
    if (!bt || !N) return Promise.resolve();
    const j = !v && $r(xe(s.fullPath, 0)) || (y || !v) && history.state && history.state.scroll || null;
    return dr().then(() => N(s, b, j)).then((M) => M && Dr(M)).catch((M) => At(M, s, b));
  }
  const d = (s) => n.go(s);
  let w;
  const Et = /* @__PURE__ */ new Set(), Rt = {
    currentRoute: l,
    listening: !0,
    addRoute: h,
    removeRoute: R,
    ...
    isReady: Z,
    install(s) {
      s.component("RouterLink", ha), s.component("RouterView", xa), s.config.globalProperties.$router = Rt, Object.defineProperty(s.config.globalProperties, "$route", {
        enumerable: !0,
        get: () => B(l)
      }), bt && !w && l.value === nt && (w = !0, F(n.location).catch((y) => {
      }));
      const b = {};
      for (const y in nt) Object.defineProperty(b, y, {
        get: () => l.value[y],
        enumerable: !0
      });
      s.provide(ce, Rt), s.provide(Ze, ir(b)), s.provide(ne, l);
      const v = s.unmount;
      Et.add(s), s.unmount = function() {
        Et.delete(s), Et.size < 1 && (f = nt, ct && ct(), ct = null, l.value = nt, w = !1, ht = !1), v();
      };
    }
  };
  function gt(s) {
    return s.reduce((b, v) => b.then(() => kt(v)), Promise.resolve());
  }
  return Rt;
}
const ar = (t, r) => {
...
const Ra = ({
  ...
  "svg",
  {
    ...
    height: g,
    stroke: x,
    "stroke-width": Ne(a) || Ne(o) || a === !0 || o === !0 ? Number(n || u || It["stroke-width"]) * 24 / Number(g) : n || u || It["stroke-width"],
    class: _a(
      "lucide",
      l.class,
      ...t ? [`lucide-${Ie(Ea(t))}-icon`, `lucide-${Ie(t)}`] : ["lucide-icon"]
    ),
    ...!f.default && !Ca(l) && { "aria-hidden": "true" }
  },
  [...r.map((m) => Vt(...m)), ...f.default ? [f.default()] : []]
);
const $ = (t, r) => (a, { slots: o, attrs: n }) => Vt(
  Ra,
  {
    ...n,
    ...a,
...
const Se = $("arrow-right", [
  ["path", { d: "M5 12h14", key: "1ays0h" }],
  ["path", { d: "m12 5 7 7-7 7", key: "xquz4c" }]
]);
const Jt = $("arrow-up-right", [
...
const Pe = $("chart-column", [
  ["path", { d: "M3 3v16a2 2 0 0 0 2 2h16", key: "c24i48" }],
  ["path", { d: "M18 17V9", key: "2bz60n" }],
  ["path", { d: "M13 17V5", key: "1frdt8" }],
  ["path", { d: "M8 17v-3", key: "17ska0" }]
]);
const Dt = $("chevron-right", [
...
}, Po = { class: "grid grid-cols-1 md:grid-cols-2 gap-8" }, zo = { class: "h-12 w-12 rounded-full bg-white/10 flex items-center justify-center mb-6" }, Bo = { class: "text-2xl font-bold mb-3" }, Oo = { class: "text-primary-foreground/70 leading-relaxed" }, Vo = { class: "py-24 bg-card/30" }, Ho = { class: "container mx-auto px-4 md:px-6" }, To = { class: "max-w-4xl mx-auto" }, jo = { class: "space-y-12 relative before:absolute before:inset-0 before:ml-5 before:-translate-x-px md:before:mx-auto md:before:translate-x-0 before:h-full before:w-0.5 before:bg-gradient-to-b before:from-transparent before:via-border before:to-transparent" }, Do = { class: "flex items-center justify-center w-10 h-10 rounded-full border border-primary bg-background shadow shrink-0 md:order-1 md:group-odd:-translate-x-1/2 md:group-even:translate-x-1/2 relative z-10 text-primary font-bold" }, Go = { class: "w-[calc(100%-4rem)] md:w-[calc(50%-2.5rem)] p-6 rounded-2xl bg-white border border-border shadow-sm transition-all hover:shadow-md" }, $o = { class: "font-bold text-lg mb-2" }, Uo = { class: "text-muted-foreground text-sm leading-relaxed" }, Fo = { class: "py-24 bg-white border-y border-border overflow-hidden" }, Zo = { class: "container mx-auto px-4 md:px-6" }, qo = {
  key: 0,
  class: "relative w-full max-w-5xl mx-auto mb-16"
}, Wo = { class: "relative bg-card rounded-3xl border border-border shadow-inner p-8 md:p-12 overflow-hidden" }, Ko = { class: "relative flex flex-col items-center" }, Qo = { class: "w-20 h-20 rounded-full bg-primary text-primary-foreground flex items-center justify-center shadow-2xl mb-8 z-10" }, Yo = { class: "grid grid-cols-2 md:grid-cols-3 gap-4 w-full" }, Xo = { class: "text-2xl" }, Jo = { class: "font-bold text-sm" }, tn = { class: "text-primary font-bold text-lg" }, en = {
  key: 1,
  class: "grid grid-cols-2 md:grid-cols-4 gap-6 text-center max-w-4xl mx-auto"
}, rn = { class: "text-3xl md:text-4xl font-bold text-primary mb-1" }, an = { class: "text-sm font-medium text-muted-foreground uppercase tracking-wider" }, on = { class: "py-24 bg-card/30" }, nn = { class: "container mx-auto px-4 md:px-6" }, sn = { class: "grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl mx-auto" }, ln = { class: "h-10 w-10 rounded-full bg-primary/5 border border-primary/10 flex items-center justify-center shrink-0" }, dn = { class: "font-bold text-lg mb-1" }, cn = { class: "text-muted-foreground text-sm" }, pn = {
  id: "analytics",
  class: "py-24 bg-card border-y border-border"
}, un = { class: "container mx-auto px-4 md:px-6" }, fn = { class: "grid grid-cols-1 lg:grid-cols-2 gap-12 mb-12" }, hn = { class: "space-y-8" }, gn = { class: "flex flex-wrap gap-2 text-sm font-medium items-center" }, mn = { class: "p-6 bg-white border border-primary/20 rounded-2xl shadow-sm relative overflow-hidden" }, vn = { class: "flex flex-col gap-4" }, xn = { class: "flex items-center gap-4" }, bn = { class: "bg-white p-6 md:p-8 rounded-2xl border border-border shadow-sm flex flex-col justify-center" }, wn = { class: "w-full overflow-hidden" }, yn = ["viewBox"], kn = ["y1", "x2", "y2"], Cn = ["x", "y"], _n = ["x", "y"], An = ["points"], En = ["points"], Rn = ["cx", "cy"], Ln = ["y"], Mn = ["y"], Nn = ["y"], In = ["y"], Sn = { class: "py-24 bg-card/30" }, Pn = { class: "container mx-auto px-4 md:px-6" }, zn = { class: "mb-20 bg-primary text-primary-foreground rounded-3xl p-10 md:p-14 relative overflow-hidden" }, Bn = { class: "relative z-10 max-w-3xl" }, On = { class: "grid grid-cols-1 md:grid-cols-3 gap-6" }, Vn = { class: "text-4xl font-bold mb-1" }, Hn = { class: "font-semibold mb-1" }, Tn = { class: "text-primary-foreground/60 text-sm" }, jn = { class: "mb-20" }, Dn = { class: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6" }, Gn = { class: "flex items-start gap-4 mb-5" }, $n = { class: "h-12 w-12 rounded-xl bg-primary/5 border border-primary/10 flex items-center justify-center shrink-0 group-hover:bg-primary group-hover:border-primary transition-colors" }, Un = { class: "flex-1" }, Fn = { class: "text-2xl font-bold text-primary" }, Zn = { class: "text-xs text-muted-foreground uppercase tracking-wider" }, qn = { class: "font-bold text-lg mb-2" }, Wn = { class: "text-sm text-muted-foreground leading-relaxed" }, Kn = { class: "bg-white rounded-3xl border border-border p-10 md:p-14 shadow-sm" }, Qn = { class: "grid grid-cols-1 lg:grid-cols-2 gap-12 items-center" }, Yn = { class: "space-y-5" }, Xn = { class: "flex justify-between items-center mb-3" }, Jn = { class: "font-semibold text-sm" }, ti = { class: "text-xs text-muted-foreground font-medium bg-green-50 text-green-700 px-2 py-0.5 rounded-full border border-green-100" }, ei = { class: "flex gap-4 items-center" }, ri = { class: "flex-1" }, ai = { class: "flex justify-between text-xs text-muted-foreground mb-1" }, oi = { class: "font-semibold text-foreground" }, ni = { class: "h-2 bg-secondary rounded-full overflow-hidden" }, ii = { class: "flex-1" }, si = { class: "flex justify-between text-xs text-muted-foreground mb-1" }, li = { class: "font-bold text-primary" }, di = { class: "h-2 bg-secondary rounded-full overflow-hidden" }, ci = ["viewBox"], pi = ["y1", "x2", "y2"], ui = ["x", "y"], fi = ["x", "y", "height"], hi = ["x", "y", "height"], gi = ["x", "y"], mi = ["x", "y"], vi = { class: "mt-12 pt-10 border-t border-border grid grid-cols-1 md:grid-cols-3 gap-6" }, xi = { class: "text-3xl font-bold text-primary mb-2" }, bi = { class: "font-bold mb-2" }, wi = { class: "text-sm text-muted-foreground leading-relaxed" }, yi = { class: "py-24 bg-card/30" }, ki = { class: "container mx-auto px-4 md:px-6 text-center" }, Ci = { class: "grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto" }, _i = { class: "p-8 rounded-2xl bg-white border border-border shadow-sm flex flex-col h-full opacity-70" }, Ai = { class: "h-12 w-12 bg-destructive/10 text-destructive rounded-full flex items-center justify-center mb-6 mx-auto" }, Ei = { class: "p-8 rounded-2xl bg-primary text-primary-foreground border border-primary shadow-xl flex flex-col h-full md:-translate-y-4" }, Ri = { class: "h-12 w-12 bg-white text-primary rounded-full flex items-center justify-center mb-6 mx-auto shadow-inner" }, Li = { class: "py-32 bg-primary relative overflow-hidden" }, Mi = { class: "container mx-auto px-4 md:px-6 relative z-10 text-center" }, Ni = { class: "flex flex-col sm:flex-row gap-4 justify-center" }, Ii = { class: "rounded-full h-14 px-10 text-lg font-bold bg-white text-primary hover:bg-card shadow-xl transition-transform hover:scale-105" }, Si = {
  key: 0,
...
}, Pi = { class: "bg-white border-t border-border pt-20 pb-10" }, zi = { class: "container mx-auto px-4 md:px-6" }, Bi = { class: "grid grid-cols-1 md:grid-cols-4 gap-12 mb-16" }, Oi = { class: "md:col-span-1" }, Vi = ["src"], Hi = {
  key: 0,
  class: "text-sm text-muted-foreground mb-6 max-w-xs"
}, Ti = { key: 0 }, ji = { class: "pt-8 border-t border-border flex flex-col md:flex-row items-center justify-between gap-4" }, Di = { class: "text-sm text-muted-foreground" }, Gi = {
  key: 0,
  class: "flex gap-4"
}, ae = 460, pt = 260, St = 50, $i = 20, Pt = 20, Ui = 40, $t = 3800, je = 9e3, oe = 460, De = 340, zt = 50, Ge = 20, it = 20, Fi = 60, Ut = 28, $e = 6, Zi = /* @__PURE__ */ Zt({
  __name: "LandingPage",
  setup(t) {
    const r = xt(!1), a = xt(!1), o = xt(0), n = xt({
      A: !1,
      B: !1,
      C: !1,
      D: !1,
    ...
    const l = [
      ...
      { title: "Global Storefront Network", icon: vt, desc: "Instant access to global retail channels" },
      { title: "AI-Powered Architecture", icon: Gt, desc: "Predictive demand and automated indexing" },
      { title: "Customs Support", icon: Oe, desc: "Frictionless cross-border trade compliance" },
      { title: "B2B Lead Generation", icon: Ve, desc: "Data-driven buyer matching system" }
    ], m = [
      ...
      { icon: Pe, title: "AI Forecasting", desc: "Predict demand before it happens", detail: "Algorithms analyze millions of B2C data points to guide B2B production volumes, minimizing dead stock." },
      { icon: ee, title: "Consumer Intelligence", desc: "Direct line to market trends", detail: "Retail data flows directly back to manufacturers, aligning production with actual consumer preferences." },
      { icon: vt, title: "Global Sourcing", desc: "Borderless procurement", detail: "Connect with vetted international manufacturers through a single, standardized compliance layer." },
      { icon: Ve, title: "Supplier Growth", desc: "Scale without the overhead", detail: "Access new markets and buyer networks instantly without building individual sales infrastructure." },
      ...
      { icon: re, title: "Live Demand Visibility", desc: "End-to-end transparency", detail: "A unified dashboard showing SKU-level performance across all B2B and B2C channels globally." }
    ], p = [
      { icon: vt, title: "Global Market Access", desc: "Instantly reach macro and micro markets worldwide. We handle the localization, translation, and localized pricing strategies automatically." },
      { icon: re, title: "Fast Inventory Clearance", desc: "Algorithmic liquidations of stagnant inventory across secondary global markets without diluting core brand equity." },
      { icon: ee, title: "Total Brand Visibility", desc: "Proprietary indexing ensures your products appear in front of the right buyers precisely when procurement intent is highest." },
      { icon: Gt, title: "AI Architecture", desc: "Built on a proprietary machine learning foundation that automates matching, pricing optimization, and logistics routing." }
    ], h = [
      ...
      { icon: te, title: "Sell through unlimited storefronts", desc: "Tap into our pre-established network of global retail partners instantly." },
      { icon: vt, title: "Global Expansion", desc: "Enter new territories without physical presence or local entities." },
      { icon: Be, title: "Trade Association Access", desc: "Premium introductions and networking within key global trade organizations." },
      { icon: Pe, title: "Market Intelligence & Advisory", desc: "Receive bespoke advisory and data on what to produce next based on real demand." }
    ], P = [
    ...
    ], L = U(() => ae - St - $i), _ = U(() => pt - Pt - Ui);
    function F(Z) {
      return St + Z / (P.length - 1) * L.value;
    }
    function X(Z) {
      return Pt + _.value - (Z - $t) / (je - $t) * _.value;
    }
    const et = U(
      () => P.map((Z, i) => `${F(i)},${X(Z.traditional)}`).join(" ")
    ), W = U(
      () => P.map((Z, i) => `${F(i)},${X(Z.hybrid)}`).join(" ")
    ), Ht = [
      { label: `Capacity
...
Revenue`, before: 30, after: 65 }
    ], kt = U(() => oe - zt - Ge), K = U(() => De - it - Fi), dt = U(() => kt.value / Ht.length);
    function Ct(Z) {
      const i = zt + Z * dt.value, Y = Ut * 2 + $e;
      return i + dt.value / 2 - Y / 2;
    }
    function ct(Z) {
      return Ct(Z) + Ut + $e;
    }
    function Tt(Z) {
      return zt + Z * dt.value + dt.value / 2;
    }
    const _t = [
      ...
      { icon: re, title: "Rapid SKU Digitization", detail: "Physical samples converted to commerce-ready global listings in under 48 hours. No photography studio, no catalogue team required.", metric: "48hr", metricLabel: "Avg. Listing Time" },
      { icon: Oe, title: "Zero Compliance Burden", detail: "MN manages all international certifications, customs documentation, duties calculation and regulatory filings across 50+ countries.", metric: "50+", metricLabel: "Countries Covered" },
      ...
      { icon: Gt, title: "AI-Driven Production Planning", detail: "Replace guesswork with real-time global demand signals. Produce exactly what the market needs, when it needs it.", metric: "30%", metricLabel: "Waste Reduction" },
      { icon: ee, title: "Private Label Brand Building", detail: "Transition from anonymous OEM manufacturer to a branded, globally distributed fashion label with our private label infrastructure.", metric: "3x", metricLabel: "Higher Margins" },
      { icon: te, title: "Unified B2B + B2C Operations", detail: "Manage wholesale bulk orders and direct-to-consumer retail fulfillment from one intelligent dashboard — simultaneously.", metric: "1", metricLabel: "Unified Platform" }
    ], ht = [
    ...
    return (Z, i) => {
      ...
      return k(), E("div", Sa, [
        e("header", {
          ...
          e("div", Pa, [
            z(Y, {
              ...
              default: rt(() => [
                e("img", {
                  ...
                  class: mt(["h-8 w-auto transition-all duration-300", r.value ? "" : "brightness-0 invert"])
                }, null, 10, za)
              ]),
              _: 1
            }),
            i[3] || (i[3] = e("nav", { class: "hidden md:flex items-center gap-8" }, null, -1)),
            e("div", Ba, [
              e("button", Oa, [
                z(Y, {
                  to: u.value.view_pub
              ...
              e("button", Va, [
                z(Y, {
                  to: u.value.reg_supplier
                }, {
                  default: rt(() => [...i[2] || (i[2] = [
                    ut(" Register as a Supplier ", -1)
                  ])]),
                  _: 1
                }, 8, ["to"])
              ])
            ...
            e("button", {
              ...
              a.value ? (k(), st(B(He), {
                key: 0,
                class: mt(r.value ? "text-foreground" : "text-white")
              }, null, 8, ["class"])) : (k(), st(B(Ia), {
                key: 1,
                class: mt(r.value ? "text-foreground" : "text-white")
              }, null, 8, ["class"]))
            ])
        ...
        e("main", null, [
          e("section", Da, [
            (k(), E(V, null, T(l, (d, w) => e("div", {
              key: w,
              class: mt(["absolute inset-0 transition-opacity duration-1000", w === o.value ? "opacity-100" : "opacity-0"])
            }, [
              i[6] || (i[6] = e("div", { class: "absolute inset-0 bg-gradient-to-r from-black/80 via-black/50 to-transparent z-10" }, null, -1)),
              e("img", {
                src: d.image,
                alt: d.title,
            ...
            e("div", qa, [
              e("div", Wa, [
                (k(), E(V, null, T(l, (d, w) => e("button", {
                  key: w,
                  onClick: (Et) => o.value = w,
                  class: mt(["h-1 rounded-full transition-all duration-300", w === o.value ? "w-12 bg-white" : "w-4 bg-white/30"]),
          ...
          e("section", Qa, [
            e("div", Ya, [
              n.value.A ? (k(), E("div", Xa, [...i[8] || (i[8] = [
                J('<div class="flex flex-col items-center" data-v-002f2040><span class="text-4xl md:text-5xl font-bold text-primary mb-2 tracking-tight" data-v-002f2040>1000+</span><span class="text-muted-foreground font-medium uppercase tracking-wider text-sm" data-v-002f2040>Storefronts</span></div><div class="flex flex-col items-center" data-v-002f2040><span class="text-4xl md:text-5xl font-bold text-primary mb-2 tracking-tight" data-v-002f2040>50+</span><span class="text-muted-foreground font-medium uppercase tracking-wider text-sm" data-v-002f2040>Countries</span></div><div class="flex flex-col items-center" data-v-002f2040><span class="text-4xl md:text-5xl font-bold text-primary mb-2 tracking-tight" data-v-002f2040>AI</span><span class="text-muted-foreground font-medium uppercase tracking-wider text-sm" data-v-002f2040>Architecture</span></div><div class="flex flex-col items-center" data-v-002f2040><span class="text-4xl md:text-5xl font-bold text-primary mb-2 tracking-tight" data-v-002f2040>360°</span><span class="text-muted-foreground font-medium uppercase tracking-wider text-sm" data-v-002f2040>Logistics</span></div>', 4)
              ])])) : at("", !0),
              e("div", Ja, [
                (k(), E(V, null, T(f, (d, w) => e("div", {
                  key: w,
                  ...
                  e("div", to, [
                    (k(), st(Mt(d.icon), { class: "h-6 w-6 text-primary" }))
                  ]),
                  e("h3", eo, C(d.title), 1),
                  e("p", ro, C(d.desc), 1)
                ])), 64))
          ...
          e("section", ao, [
            i[14] || (i[14] = e("div", { class: "absolute top-0 right-0 w-1/3 h-full bg-gradient-to-l from-primary/[0.03] to-transparent pointer-events-none" }, null, -1)),
            e("div", oo, [
              e("div", no, [
                e("div", io, [
                  i[9] || (i[9] = J('<div class="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-primary/5 border border-primary/10 text-primary text-sm font-semibold mb-6" data-v-002f2040><span class="flex h-2 w-2 rounded-full bg-primary" data-v-002f2040></span> The Platform </div><h2 class="text-3xl md:text-5xl font-bold mb-6 tracking-tight leading-tight" data-v-002f2040> The Infrastructure for Global Fashion Trade </h2><p class="text-lg text-muted-foreground mb-8 leading-relaxed" data-v-002f2040> MN Supplierhub is the operating system for fashion manufacturers, wholesalers, and retailers. We digitize factory floors and connect them directly to global demand through <span class="font-semibold text-foreground" data-v-002f2040>Onamoda Product Central</span> — our centralized fashion product repository. </p>', 3)),
                  e("div", so, [
                    (k(), E(V, null, T(m, (d, w) => e("div", {
                      key: w,
                      class: "flex items-start gap-3"
                    }, [
                      e("div", lo, [
                        z(B(ze), { class: "h-3 w-3 text-primary" })
                      ]),
                      e("span", co, C(d), 1)
                    ])), 64))
                  ])
                ...
                e("div", po, [
                  e("div", uo, [
                    e("div", fo, [
                      e("div", ho, [
                        e("div", go, [
                          z(B(Na), { class: "h-5 w-5 text-muted-foreground" }),
                          i[10] || (i[10] = e("span", { class: "font-bold" }, "Fragmented Factories", -1))
                        ])
                      ]),
                      e("div", mo, [
                        z(B(Jt), { class: "h-6 w-6 rotate-45" })
                      ]),
                      e("div", vo, [
                        e("div", xo, [
                          z(B(Gt), { class: "h-6 w-6" })
                        ]),
                        i[11] || (i[11] = e("div", null, [
                      ...
                      e("div", wo, [
                        e("div", yo, [
                          z(B(te), { class: "h-6 w-6 text-muted-foreground mb-2" }),
                          i[12] || (i[12] = e("span", { class: "font-bold text-sm" }, "Global B2B Buyers", -1))
                        ]),
                        e("div", ko, [
                          z(B(vt), { class: "h-6 w-6 text-muted-foreground mb-2" }),
                          i[13] || (i[13] = e("span", { class: "font-bold text-sm" }, "B2C Consumers", -1))
                        ])
                      ])
                    ])
                  ])
          ...
          e("section", Co, [
            e("div", _o, [
              i[15] || (i[15] = e("div", { class: "text-center max-w-3xl mx-auto mb-16" }, [
          ...
          e("section", Mo, [
            ...
            e("div", No, [
              e("div", Io, [
                i[16] || (i[16] = e("div", { class: "max-w-2xl" }, [
                ...
                n.value.B ? (k(), E("button", So, " View All Features ")) : at("", !0)
              ]),
              e("div", Po, [
                (k(), E(V, null, T(p, (d, w) => e("div", {
                  key: w,
                  class: "group border border-white/10 rounded-2xl p-8 bg-white/5 hover:bg-white/10 transition-colors"
                }, [
                  e("div", zo, [
                    (k(), st(Mt(d.icon), { class: "h-6 w-6" }))
                  ]),
                  e("h3", Bo, C(d.title), 1),
                  e("p", Oo, C(d.desc), 1)
                ])), 64))
          ...
          e("section", Vo, [
            e("div", Ho, [
              i[18] || (i[18] = e("h2", { class: "text-3xl md:text-5xl font-bold mb-16 text-center tracking-tight" }, "Operational Advantages", -1)),
              e("div", To, [
                e("div", jo, [
                  (k(), E(V, null, T(h, (d, w) => e("div", {
                    key: w,
          ...
          e("section", Fo, [
            e("div", Zo, [
              i[22] || (i[22] = J('<div class="text-center max-w-3xl mx-auto mb-16" data-v-002f2040><div class="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-primary/5 border border-primary/10 text-primary text-sm font-semibold mb-6" data-v-002f2040><span class="flex h-2 w-2 rounded-full bg-primary" data-v-002f2040></span> Global Reach </div><h2 class="text-3xl md:text-5xl font-bold mb-6 tracking-tight" data-v-002f2040>Unlimited Storefronts. <div data-v-002f2040>One Platform.</div></h2><p class="text-lg text-muted-foreground" data-v-002f2040> Your products, instantly visible across our pre-established global retail network — without building a single sales team. </p></div>', 1)),
              n.value.C ? (k(), E("div", qo, [
                e("div", Wo, [
                  ...
                  e("div", Ko, [
                    e("div", Qo, [
                      z(B(vt), { class: "h-10 w-10" })
                    ]),
                    i[20] || (i[20] = e("p", { class: "text-sm font-bold uppercase tracking-widest text-muted-foreground mb-10" }, "MN Supplierhub Global Network", -1)),
                    e("div", Yo, [
                      (k(), E(V, null, T(R, (d, w) => e("div", {
                        key: w,
                        class: "flex items-center gap-3 bg-white rounded-xl border border-border p-4 shadow-sm animate-in"
                      }, [
                        e("span", Xo, C(d.flag), 1),
                        e("div", null, [
                          e("div", Jo, C(d.name), 1),
                          e("div", tn, C(d.stores), 1),
                          i[19] || (i[19] = e("div", { class: "text-xs text-muted-foreground" }, "storefronts", -1))
                        ])
                      ])), 64))
                    ])
                  ])
              ...
              n.value.D ? (k(), E("div", en, [
                (k(), E(V, null, T(I, (d, w) => e("div", { key: w }, [
                  e("div", rn, C(d.value), 1),
                  e("div", an, C(d.label), 1)
                ])), 64))
              ])) : at("", !0)
            ])
          ]),
          e("section", on, [
            e("div", nn, [
              i[23] || (i[23] = e("h2", { class: "text-3xl md:text-5xl font-bold mb-4 text-center tracking-tight" }, "Expand Without Limits", -1)),
              i[24] || (i[24] = e("p", { class: "text-lg text-muted-foreground text-center max-w-2xl mx-auto mb-16" }, "Every benefit designed to let you focus on manufacturing — we handle everything else.", -1)),
              e("div", sn, [
                (k(), E(V, null, T(O, (d, w) => e("div", {
                  key: w,
                  class: "p-6 rounded-2xl bg-white border border-border flex gap-4 shadow-sm"
                }, [
                  e("div", ln, [
                    (k(), st(Mt(d.icon), { class: "h-5 w-5 text-primary" }))
                  ]),
                  e("div", null, [
                    e("h4", dn, C(d.title), 1),
                    e("p", cn, C(d.desc), 1)
          ...
          e("section", pn, [
            e("div", un, [
              i[38] || (i[38] = e("div", { class: "text-center max-w-3xl mx-auto mb-16" }, [
              ...
              e("div", fn, [
                e("div", hn, [
                  e("div", null, [
                    i[30] || (i[30] = e("h4", { class: "text-sm font-bold uppercase tracking-wider text-muted-foreground mb-4" }, "Traditional Linear Model", -1)),
                    e("div", gn, [
                      i[25] || (i[25] = e("span", { class: "px-3 py-1 bg-white border border-border rounded" }, "Factory", -1)),
                      z(B(Dt), { class: "h-4 w-4 text-muted-foreground" }),
                      i[26] || (i[26] = e("span", { class: "px-3 py-1 bg-white border border-border rounded text-muted-foreground" }, "Agent", -1)),
                      z(B(Dt), { class: "h-4 w-4 text-muted-foreground" }),
                      i[27] || (i[27] = e("span", { class: "px-3 py-1 bg-white border border-border rounded text-muted-foreground" }, "Exporter", -1)),
                      z(B(Dt), { class: "h-4 w-4 text-muted-foreground" }),
                      i[28] || (i[28] = e("span", { class: "px-3 py-1 bg-white border border-border rounded" }, "Brand", -1)),
                      z(B(Dt), { class: "h-4 w-4 text-muted-foreground" }),
                      i[29] || (i[29] = e("span", { class: "px-3 py-1 bg-white border border-border rounded" }, "Consumer", -1))
                    ]),
                    i[31] || (i[31] = e("p", { class: "text-xs text-muted-foreground mt-2" }, "Margin dilution and information loss at every step.", -1))
                  ]),
                  e("div", mn, [
                    i[35] || (i[35] = e("div", { class: "absolute top-0 right-0 w-32 h-32 bg-primary/5 rounded-bl-full" }, null, -1)),
                    i[36] || (i[36] = e("h4", { class: "text-sm font-bold uppercase tracking-wider text-primary mb-4" }, "MN Hybrid Model", -1)),
                    e("div", vn, [
                      e("div", xn, [
                        i[32] || (i[32] = e("span", { class: "px-4 py-2 bg-primary text-primary-foreground font-bold rounded-lg shadow-md" }, "Factory", -1)),
                        z(B(Se), { class: "h-5 w-5 text-primary" }),
                        i[33] || (i[33] = e("span", { class: "px-6 py-3 bg-white border-2 border-primary font-bold rounded-xl shadow-sm" }, "MN Aggregator", -1))
                      ]),
                      i[34] || (i[34] = J('<div class="pl-32 flex gap-8 relative" data-v-002f2040><div class="absolute left-[8.5rem] top-[-1rem] bottom-4 w-px bg-primary/30" data-v-002f2040></div><div class="absolute left-[8.5rem] top-1/2 w-4 h-px bg-primary/30" data-v-002f2040></div><div class="flex flex-col gap-4 w-full" data-v-002f2040><span class="px-4 py-2 bg-card border border-border font-medium rounded-lg" data-v-002f2040>B2B Buyers</span><span class="px-4 py-2 bg-card border border-border font-medium rounded-lg" data-v-002f2040>B2C Consumers</span></div></div>', 1))
                    ])
                  ])
                ]),
                e("div", bn, [
                  i[37] || (i[37] = e("h3", { class: "text-xl font-bold mb-6" }, "Revenue Growth Trajectory", -1)),
                  e("div", wn, [
                    (k(), E("svg", {
                      viewBox: `0 0 ${ae} ${pt}`,
                      class: "w-full",
                      ...
                      (k(), E(V, null, T(5, (d) => e("text", {
                        key: `y-${d}`,
                        x: St - 10,
                        y: Pt + (5 - d) / 4 * _.value + 4,
                        "text-anchor": "end",
                        fill: "#888",
                        "font-size": "11"
                      }, C(Math.round($t + (d - 1) / 4 * (je - $t) / 1e3)) + "k", 9, _n)), 64)),
                      e("polyline", {
                        points: et.value,
                        fill: "none",
                        stroke: "#a3a3a3",
              ...
              i[39] || (i[39] = J('<div class="grid grid-cols-1 md:grid-cols-3 gap-6" data-v-002f2040><div class="rounded-2xl border border-border bg-card p-6" data-v-002f2040><p class="text-sm text-muted-foreground mb-1" data-v-002f2040>Estimated Growth</p><p class="text-4xl font-bold text-primary mb-4" data-v-002f2040>+77%</p><div class="flex items-center justify-between text-sm" data-v-002f2040><span class="text-muted-foreground" data-v-002f2040>Profit Simulation</span><span class="font-bold" data-v-002f2040>₹4.8Cr → ₹8.5Cr</span></div><div class="w-full bg-secondary h-2 mt-3 rounded-full overflow-hidden" data-v-002f2040><div class="bg-primary h-full rounded-full" style="width:77%;" data-v-002f2040></div></div></div><div class="rounded-2xl border border-border bg-card p-6" data-v-002f2040><p class="text-sm text-muted-foreground mb-1" data-v-002f2040>Inventory Reduction</p><p class="text-4xl font-bold text-primary mb-4" data-v-002f2040>20–30%</p><p class="text-sm text-muted-foreground" data-v-002f2040>Through AI predictive demand forecasting rather than guesswork.</p></div><div class="rounded-2xl border border-border bg-card p-6" data-v-002f2040><p class="text-sm text-muted-foreground mb-1" data-v-002f2040>Waste Reduction</p><p class="text-4xl font-bold text-primary mb-4" data-v-002f2040>15–25%</p><p class="text-sm text-muted-foreground" data-v-002f2040>Optimized raw material procurement aligned with actual sales data.</p></div></div>', 1))
            ])
          ]),
          e("section", Sn, [
            e("div", Pn, [
              i[51] || (i[51] = J('<div class="text-center max-w-3xl mx-auto mb-20" data-v-002f2040><div class="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-primary/5 border border-primary/10 text-primary text-sm font-semibold mb-6" data-v-002f2040><span class="flex h-2 w-2 rounded-full bg-primary" data-v-002f2040></span> Why India. Why Now. </div><h2 class="text-3xl md:text-5xl font-bold mb-6 tracking-tight leading-tight" data-v-002f2040>Why Indian Suppliers Should Adapt Now</h2><p class="text-lg text-muted-foreground leading-relaxed" data-v-002f2040> India possesses the world&#39;s most versatile textile base — 6,000+ year legacy in craft, the second-largest cotton producer globally, unmatched product diversity. Yet its export share is a fraction of its true potential. The single barrier: coordination infrastructure. MN Supplierhub is that infrastructure. </p></div>', 1)),
              e("div", zn, [
                i[42] || (i[42] = e("div", {
                  class: "absolute inset-0 opacity-10",
                ...
                e("div", Bn, [
                  i[40] || (i[40] = e("h3", { class: "text-2xl md:text-3xl font-bold mb-4" }, "India's Fragmentation Problem", -1)),
                  i[41] || (i[41] = e("p", { class: "text-primary-foreground/80 mb-8 leading-relaxed text-lg" }, " India has over 45 million SME manufacturers in textiles and apparel. Yet 92% operate below ₹1 crore in annual export revenue. The problem is not capability — it is coordination, visibility, and access. ", -1)),
                  e("div", On, [
                    (k(), E(V, null, T(_t, (d, w) => e("div", {
                      key: w,
                      class: "bg-white/10 rounded-2xl p-6 text-center border border-white/10"
                    }, [
                      e("div", Vn, C(d.stat), 1),
                      e("div", Hn, C(d.label), 1),
                      e("div", Tn, C(d.sub), 1)
                    ])), 64))
                  ])
                ])
              ...
              e("div", jn, [
                i[43] || (i[43] = e("h3", { class: "text-2xl md:text-3xl font-bold mb-4 text-center" }, "Operational Advantages", -1)),
                i[44] || (i[44] = e("p", { class: "text-muted-foreground text-center mb-12 max-w-2xl mx-auto" }, "Every operational barrier that keeps Indian suppliers out of global markets — resolved by MN Supplierhub.", -1)),
                e("div", Dn, [
                  (k(), E(V, null, T(jt, (d, w) => e("div", {
                    key: w,
                    class: "bg-white rounded-2xl border border-border p-7 shadow-sm hover:shadow-lg transition-all group"
                  }, [
                    e("div", Gn, [
                      e("div", $n, [
                        (k(), st(Mt(d.icon), { class: "h-6 w-6 text-primary group-hover:text-white transition-colors" }))
                      ]),
                      e("div", Un, [
                        e("div", Fn, C(d.metric), 1),
                        e("div", Zn, C(d.metricLabel), 1)
                      ])
                    ]),
                    e("h4", qn, C(d.title), 1),
                    e("p", Wn, C(d.detail), 1)
              ...
              e("div", Kn, [
                i[50] || (i[50] = e("div", { class: "text-center mb-12" }, [
                ...
                e("div", Qn, [
                  e("div", Yn, [
                    (k(), E(V, null, T(ht, (d, w) => e("div", {
                      key: w,
                      class: "rounded-xl border border-border p-5 bg-card/30"
                    }, [
                      e("div", Xn, [
                        e("span", Jn, C(d.label), 1),
                        e("span", ti, " +" + C(Math.round((d.after - d.before) / d.before * 100)) + "% ", 1)
                      ]),
                      e("div", ei, [
                        e("div", ri, [
                          e("div", ai, [
                            i[45] || (i[45] = e("span", null, "Before", -1)),
                            e("span", oi, C(d.before) + C(d.suffix), 1)
                          ]),
                          e("div", ni, [
                            e("div", {
                              class: "h-full bg-muted-foreground/40 rounded-full",
                              style: fe({ width: `${d.isAmount ? d.before / d.after * 100 : d.before}%` })
                            }, null, 4)
                          ])
                        ]),
                        e("div", ii, [
                          e("div", si, [
                            i[46] || (i[46] = e("span", null, "After", -1)),
                            e("span", li, C(d.after) + C(d.suffix), 1)
                          ]),
                          e("div", di, [
                            e("div", {
                              class: "h-full bg-primary rounded-full",
                              style: fe({ width: `${d.isAmount ? 100 : d.after}%` })
                            }, null, 4)
                          ])
                        ])
                      ])
                    ])), 64)),
                    i[47] || (i[47] = J('<div class="rounded-xl bg-primary text-primary-foreground p-6 flex items-center justify-between" data-v-002f2040><div data-v-002f2040><div class="text-sm text-primary-foreground/70 mb-1" data-v-002f2040>Net Estimated Profit Uplift</div><div class="text-4xl font-bold" data-v-002f2040>+₹3.7 Crore</div><div class="text-primary-foreground/60 text-sm mt-1" data-v-002f2040>₹4.8 Cr → ₹8.5 Cr annually</div></div><div class="text-right" data-v-002f2040><div class="text-5xl font-bold opacity-90" data-v-002f2040>+77%</div><div class="text-primary-foreground/60 text-sm" data-v-002f2040>Estimated growth</div></div></div>', 1))
                  ]),
                  e("div", null, [
                    i[48] || (i[48] = e("h4", { class: "text-sm font-bold uppercase tracking-wider text-muted-foreground mb-6 text-center" }, "Before vs After — Key Metrics", -1)),
                    (k(), E("svg", {
                      viewBox: `0 0 ${oe} ${De}`,
                      class: "w-full",
                      style: { height: "340px" }
                      ...
                      (k(), E(V, null, T(5, (d) => e("text", {
                        key: `y-${d}`,
                        x: zt - 8,
                        y: it + (5 - d) / 4 * K.value + 4,
                        "text-anchor": "end",
                        fill: "#888",
                        "font-size": "11"
                      }, C(Math.round((d - 1) / 4 * 100)) + "%", 9, ui)), 64)),
                      (k(), E(V, null, T(Ht, (d, w) => (k(), E(V, {
                        key: `bar-${w}`
                      }, [
                        e("rect", {
                          x: Ct(w),
                          y: it + K.value - d.before / 100 * K.value,
                          width: Ut,
                        ...
                        e("rect", {
                          x: ct(w),
                          y: it + K.value - d.after / 100 * K.value,
                          width: Ut,
...
`)[1] || ""), 9, mi)
                    ...
                    i[49] || (i[49] = J('<div class="flex gap-6 justify-center mt-2 text-sm" data-v-002f2040><div class="flex items-center gap-2" data-v-002f2040><div class="h-3 w-3 rounded bg-gray-300" data-v-002f2040></div><span class="text-muted-foreground" data-v-002f2040>Before MN Supplierhub</span></div><div class="flex items-center gap-2" data-v-002f2040><div class="h-3 w-3 rounded bg-primary" data-v-002f2040></div><span class="text-muted-foreground" data-v-002f2040>After MN Supplierhub</span></div></div>', 1))
                  ])
                ]),
                e("div", vi, [
                  (k(), E(V, null, T(At, (d, w) => e("div", {
                    key: w,
                    class: "text-center p-6 bg-card/50 rounded-2xl border border-border"
                  }, [
                    e("div", xi, C(d.value), 1),
                    e("div", bi, C(d.title), 1),
                    e("div", wi, C(d.desc), 1)
                  ])), 64))
                ])
              ])
          ...
          e("section", yi, [
            e("div", ki, [
              i[54] || (i[54] = e("h2", { class: "text-3xl md:text-5xl font-bold mb-16 tracking-tight" }, "Industry Transformation", -1)),
              e("div", Ci, [
                e("div", _i, [
                  e("div", Ai, [
                    z(B(He), { class: "h-6 w-6" })
                  ]),
                  i[52] || (i[52] = J('<h3 class="text-xl font-bold mb-4" data-v-002f2040>Without Aggregation</h3><ul class="space-y-4 text-left mt-auto" data-v-002f2040><li class="flex gap-3 text-muted-foreground" data-v-002f2040><span class="text-destructive font-bold" data-v-002f2040>•</span> Fragmented order volumes</li><li class="flex gap-3 text-muted-foreground" data-v-002f2040><span class="text-destructive font-bold" data-v-002f2040>•</span> High middleman dependency</li><li class="flex gap-3 text-muted-foreground" data-v-002f2040><span class="text-destructive font-bold" data-v-002f2040>•</span> Razor-thin production margins</li><li class="flex gap-3 text-muted-foreground" data-v-002f2040><span class="text-destructive font-bold" data-v-002f2040>•</span> Zero brand equity built</li></ul>', 2))
                ]),
                e("div", Ei, [
                  e("div", Ri, [
                    z(B(ze), { class: "h-6 w-6" })
                  ]),
                  i[53] || (i[53] = J('<h3 class="text-xl font-bold mb-4 text-white" data-v-002f2040>With MN Hybrid Aggregation</h3><ul class="space-y-4 text-left mt-auto" data-v-002f2040><li class="flex gap-3" data-v-002f2040><span class="text-white font-bold" data-v-002f2040>✓</span> AI-driven ecosystem matching</li><li class="flex gap-3" data-v-002f2040><span class="text-white font-bold" data-v-002f2040>✓</span> Global direct-to-buyer infrastructure</li><li class="flex gap-3" data-v-002f2040><span class="text-white font-bold" data-v-002f2040>✓</span> Premium margin capture</li><li class="flex gap-3" data-v-002f2040><span class="text-white font-bold" data-v-002f2040>✓</span> Long-term brand building capacity</li></ul>', 2))
                ])
              ])
            ])
          ]),
          e("section", Li, [
            i[58] || (i[58] = e("div", { class: "absolute inset-0 bg-gradient-to-br from-primary via-primary to-black z-0" }, null, -1)),
            i[59] || (i[59] = e("div", { class: "absolute top-0 left-0 w-full h-px bg-white/20" }, null, -1)),
            e("div", Mi, [
              i[56] || (i[56] = e("h2", { class: "text-4xl md:text-6xl font-bold text-white mb-6 tracking-tight max-w-4xl mx-auto leading-tight" }, " Scale Your Fashion Business Beyond Borders ", -1)),
              i[57] || (i[57] = e("p", { class: "text-xl text-white/80 mb-12 max-w-2xl mx-auto font-light" }, " Join the next generation hybrid commerce infrastructure for fashion suppliers. Let data drive your production and our network drive your sales. ", -1)),
              e("div", Ni, [
                e("button", Ii, [
                  z(Y, {
                    to: u.value.reg_supplier
                  }, {
                    default: rt(() => [...i[55] || (i[55] = [
                      ut(" Register as a Supplier ", -1)
                    ])]),
                    _: 1
                  }, 8, ["to"])
                ]),
                n.value.E ? (k(), E("button", Si, " Contact Enterprise Team ")) : at("", !0)
              ])
            ])
          ])
        ]),
          ...
          e("div", zi, [
            e("div", Bi, [
              e("div", Oi, [
                ...
                n.value.G ? (k(), E("p", Hi, " The global infrastructure that connects Indian and global fashion manufacturers into a unified hybrid commerce ecosystem. ")) : at("", !0)
              ]),
              i[61] || (i[61] = e("div", null, [
              ...
              n.value.F ? (k(), E("div", Ti, [...i[60] || (i[60] = [
            ...
            e("div", ji, [
              e("p", Di, "© " + C((/* @__PURE__ */ new Date()).getFullYear()) + " MN Group. All rights reserved.", 1),
              n.value.I ? (k(), E("div", Gi, [...i[62] || (i[62] = [
                J('<a href="#" class="text-muted-foreground hover:text-primary transition-colors" data-v-002f2040><span class="sr-only" data-v-002f2040>LinkedIn</span><svg class="h-5 w-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true" data-v-002f2040><path fill-rule="evenodd" d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z" clip-rule="evenodd" data-v-002f2040></path></svg></a><a href="#" class="text-muted-foreground hover:text-primary transition-colors" data-v-002f2040><span class="sr-only" data-v-002f2040>Twitter</span><svg class="h-5 w-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true" data-v-002f2040><path d="M8.29 20.251c7.547 0 11.675-6.253 11.675-11.675 0-.178 0-.355-.012-.53A8.348 8.348 0 0022 5.92a8.19 8.19 0 01-2.357.646 4.118 4.118 0 001.804-2.27 8.224 8.224 0 01-2.605.996 4.107 4.107 0 00-6.993 3.743 11.65 11.65 0 01-8.457-4.287 4.106 4.106 0 001.27 5.477A4.072 4.072 0 012.8 9.713v.052a4.105 4.105 0 003.292 4.022 4.095 4.095 0 01-1.853.07 4.108 4.108 0 003.834 2.85A8.233 8.233 0 012 18.407a11.616 11.616 0 006.29 1.84" data-v-002f2040></path></svg></a>', 2)
              ])])) : at("", !0)
            ])
          ])
        ])
...
}), qi = /* @__PURE__ */ ar(Zi, [["__scopeId", "data-v-002f2040"]]), Wi = { class: "min-h-screen w-full flex items-center justify-center bg-gray-50" }, Ki = { class: "w-full max-w-md mx-4 bg-white rounded-xl border border-gray-200 shadow-sm p-6" }, Qi = { class: "flex mb-4 gap-2 items-center" }, Yi = /* @__PURE__ */ Zt({
  __name: "NotFound",
  setup(t) {
    return (r, a) => {
      const o = de("RouterLink");
      return k(), E("div", Wi, [
        e("div", Ki, [
          e("div", Qi, [
            z(B(Ma), { class: "h-8 w-8 text-red-500" }),
