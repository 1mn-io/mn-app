...
(async () => {
  ...
  l: [
    {
      ...
      data: {
        ...
        //set..
        content: {
          ce_file: //"https://raw.githubusercontent.com/1mn-io/mn-app/main/modules/form_inputtext/dist/data.json" 
          {
            "config": {
              "lazy_lib": {
  ...
  //test..[child]
  (async() => {
  ce_listen("child:msg", async (_$) => {
      console.log(`[child] ce_listen`, _$);
    });
    setTimeout(async() => {
      await ce_call("msg", {
      type: `child:get_value`,//`child:xyz`,
      _p: {},
      _$p: {},
      custom: {
        //theme
