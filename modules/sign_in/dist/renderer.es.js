import { q as B, p as N, h as E, s as _, u as z, x as v, N as y, y as V, z as u, F as M, S as j, C as U, A as H, B as L, D as p, E as O, G as P, H as C, I as F, J as I, n as D, K as W, L as G, M as K, O as q, P as J, Q, R as X, U as Y, V as Z, W as rr, X as er, d as tr, c as or, a as ar, t as ir, o as nr, Y as lr } from "./runtime-dom.esm-bundler-ChC2ihda.js";
function sr(r, e) {
  e === void 0 && (e = {});
  var t = e.insertAt;
...
function gr(r, e) {
  ...
  for (let o in r) {
    ...
    o.startsWith("."))
      continue;
    const a = r[o];
    o.startsWith("^") && (o = o.slice(1)), o === "class" || o === "className" ? t += ` class="${ur(a)}"` : o === "style" ? t += ` style="${hr(a)}"` : t += pr(o, a, e);
  }
  return t;
}
function pr(r, e, t) {
