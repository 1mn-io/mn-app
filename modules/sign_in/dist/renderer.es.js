import { o as B, b as N, k as E, O as _, P as z, w as v, N as y, t as V, A as u, F as j, S as M, C as H, n as O, T as P, m as p, E as U, B as F, r as C, v as I, D as L, G as D, I as G, Q as W, x as K, z as q, K as J, s as Q, p as X, y as Y, u as Z, H as rr, q as er, l as tr, g as or, d as ar, R as ir, J as nr, h as lr } from "./runtime-dom.esm-bundler-BPoQGdGP.js";
function sr(r, e) {
  e === void 0 && (e = {});
  var t = e.insertAt;
...
function gr(r, e) {
  let t = "";
  for (let o in r) {
    if (dr(o) || I(o) || e === "textarea" && o === "value" || // force as property (not rendered in SSR)
    o.startsWith("."))
      continue;
    const a = r[o];
    o.startsWith("^") && (o = o.slice(1)), o === "class" ? t += ` class="${ur(a)}"` : o === "style" ? t += ` style="${hr(a)}"` : o === "className" ? a != null && (t += ` class="${p(String(a))}"`) : t += pr(o, a, e);
  }
  return t;
}
function pr(r, e, t) {
