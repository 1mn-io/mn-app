    ...
    l:  [
      {
        ...
        "data": {
          "data": "Hello world! ",
          "columns": [
            { field: "code", header: "Code", style: "" },
            { field: "name", header: "Name", style: "" },
            { field: "quantity", header: "Quantity", style: "" },
            { field: "price", header: "Price", style: "" }
          ],

          "rows": [
            { code: "P100", name: "Nike Shirt", quantity: 10, price: 120 },
            { code: "P200", name: "Adidas Tee", quantity: 5, price: 90 },
          ],
          "pt": {
