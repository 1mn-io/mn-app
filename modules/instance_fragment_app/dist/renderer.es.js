import { g as B, f as N, h as E, s as _, i as C, j as m, N as y, k as V, l as u, F as M, S as j, C as H, m as L, T as U, n as p, p as F, q as I, t as S, u as O, v as P, w as D, x as G, y as W, z as K, A as q, B as J, D as Q, E as X, G as Y, H as Z, I as ee, J as te, d as re, c as oe, b as ie, K as ae, a as ne, L as le } from "./runtime-dom.esm-bundler-Cyp0UzkF.js";
function se(e, t) {
  t === void 0 && (t = {});
  var o = t.insertAt;
...
function fe(e, t) {
  ...
  for (let r in e) {
    ...
    r.startsWith("."))
      continue;
    const i = e[r];
    r.startsWith("^") && (r = r.slice(1)), r === "class" || r === "className" ? o += ` class="${ue(i)}"` : r === "style" ? o += ` style="${be(i)}"` : o += pe(r, i, t);
  }
  return o;
}
function pe(e, t, o) {
...
function g(e, t, o, r) {
  ...
  switch (l && (t.props = ve(t, c, l)), i) {
    ...
    case M:
      ...
      break;
    default:
      a & 1 ? xe(e, t, o, r) : a & 6 ? e(z(t, o, r)) : a & 64 ? _e(e, t, o, r) : a & 128 && g(e, t.ssContent, o, r);
  }
}
function w(e, t, o, r) {
...
function xe(e, t, o, r) {
  const i = t.type;
  let { props: a, children: n, shapeFlag: l, scopeId: c } = t, f = `<${i}`;
  a && (f += fe(a, i)), c && (f += ` ${c}`);
  let d = o, s = t;
  for (; d && s === d.subTree; )
  ...
  if (r && (f += ` ${r}`), e(f + ">"), !I(i)) {
    let b = !1;
    a && (a.innerHTML ? (b = !0, e(a.innerHTML)) : a.textContent ? (b = !0, e(p(a.textContent))) : i === "textarea" && a.value && (b = !0, e(p(a.value)))), b || (l & 8 ? e(p(n)) : l & 16 && w(
      e,
      n,
      o,
      r
