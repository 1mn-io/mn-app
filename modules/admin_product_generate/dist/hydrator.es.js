...
var U = (...o) => oe(x.getTheme(), ...o), oe = (o = {}, r, e, t) => {
  if (r) {
    let { variable: n, options: l } = x.defaults || {}, { prefix: d, transform: c } = o?.options || l || {}, a = X(r, ao) ? r : `{${r}}`;
    return t === "value" || Co(t) && c === "strict" ? x.getTokenValue(r) : or(a, void 0, d, [n.excludedKeyRegex], e);
  }
  return "";
};
function uo(o, ...r) {
...
function re(o, r = {}) {
  let e = x.defaults.variable, { prefix: t = e.prefix, selector: n = e.selector, excludedKeyRegex: l = e.excludedKeyRegex } = r, d = [], c = [], a = [{ node: o, path: t }];
  for (; a.length; ) {
...
var C = { regex: { rules: { class: { pattern: /^\.([a-zA-Z][\w-]*)$/, resolve(o) {
  ...
  if (v(u) && f.transform !== "strict") {
    ...
    let wr = this.transformCSS(o, `${lr}${ur}`, "light", "variable", f, t, n), xr = this.transformCSS(o, `${gr}`, "dark", "variable", f, t, n);
    b = `${wr}${xr}`, h = [.../* @__PURE__ */ new Set([...sr, ...fr, ...mr])];
    let Cr = this.transformCSS(o, `${pr}${hr}color-scheme:light`, "light", "variable", f, t, n), $r = this.transformCSS(o, `${kr}color-scheme:dark`, "dark", "variable", f, t, n);
    y = `${Cr}${$r}`, D = [.../* @__PURE__ */ new Set([...br, ...vr, ...yr])], L = P(u.css, { dt: U });
  }
  ...
  let l = function(c, a = {}, i = []) {
    ...
    return Co(a.binding) && delete a.binding, i.pop(), { colorScheme: c, path: this.path, paths: a, value: s.includes("__UNRESOLVED__") ? void 0 : s };
  }, d = (c, a, i) => {
  ...
  let { theme: r } = o;
  r && (this._theme = ho($({}, r), { options: $($({}, this.defaults.options), r.options) }), this._tokens = C.createTokens(this.preset, this.defaults), this.clearLoadedStyleNames());
}, get theme() {
  return this._theme;
}, get preset() {
  var o;
  ...
  this._theme = ho($({}, this.theme), { preset: o }), this._tokens = C.createTokens(o, this.defaults), this.clearLoadedStyleNames(), _.emit("preset:change", o), _.emit("theme:change", this.theme);
}, getOptions() {
  return this.options;
}, setOptions(o) {
...
`);
  ...
  loadStyle: function() {
    ...
    return this.load(this.style, e, function() {
      ...
      return x.transformCSS(e.name || r.name, "".concat(n).concat(uo(Po || (Po = fo(["", ""])), t)));
    });
  },
  ...
  getThemeStyleSheet: function(r) {
    ...
    if (this.style) {
      var n = this.name === "base" ? "global-style" : "".concat(this.name, "-style"), l = uo(Lo || (Lo = fo(["", ""])), P(this.style, {
        dt: U
      })), d = no(x.transformCSS(n, l)), c = Object.entries(e).reduce(function(a, i) {
...
function $e(o, r) {
  ...
  return o.config.globalProperties.$primevue = e, o.provide(Ce, e), Be(), Se(o, e), e;
}
var oo = [];
function Be() {
...
function Se(o, r) {
  var e = to(!1), t = function() {
    var i;
    if (((i = r.config) === null || i === void 0 ? void 0 : i.theme) !== "none" && !x.isStyleNameLoaded("common")) {
  ...
  var n = eo(r.config, function(a, i) {
    ...
    e.value || x.setTheme(a), r.config.unstyled || t(), e.value = !1, go.emit("config:theme:change", {
      newValue: a,
      oldValue: i
    });
  }, {
