import { s as N, u as _, q as E, l as B, x as z, y as w, N as y, z as V, A as u, F as M, S as j, C as U, B as H, D as L, E as g, G as C, H as O, I as P, J as F, K as I, n as D, L as G, M as K, O as W, P as q, Q as J, R as Q, U as X, V as Y, W as Z, X as rr, Y as er, d as tr, Z as or } from "./runtime-dom.esm-bundler-BbZdgTWE.js";
function ar(r, e) {
  e === void 0 && (e = {});
  var t = e.insertAt;
...
function lr(r, e) {
  ...
  for (const o in r) {
    if (nr(o) || I(o) || e === "textarea" && o === "value")
      continue;
    const a = r[o];
    o === "class" ? t += ` class="${cr(a)}"` : o === "style" ? t += ` style="${dr(a)}"` : o === "className" ? t += ` class="${String(a)}"` : t += sr(o, a, e);
  }
  return t;
}
function sr(r, e, t) {
  ...
  return Q(o) ? X(e) ? ` ${o}` : "" : Y(o) ? e === "" ? ` ${o}` : ` ${o}="${g(e)}"` : (console.warn(
...
function gr(r, e, t, o, a) {
  ...
  if (o)
    ...
    s("<!--teleport start anchor-->"), e(s), s("<!--teleport anchor-->"), p = d();
  }
...
function S() {
  ...
  return {
    ...
    push(t) {
      ...
      e.push(t), r = o, (w(t) || C(t) && t.hasAsync) && (e.hasAsync = !0);
    }
  };
}
...
function x(r, e) {
  ...
  if (V(t)) {
    ...
    (!r.render || r.render === y) && !r.ssrRender && !t.ssrRender && u(t.template) && (t.ssrRender = ur(t.template));
...
function v(r, e, t, o) {
  ...
  switch (l && (e.props = yr(e, c, l)), a) {
    ...
    case j:
      ...
      break;
    case M:
      e.slotScopeIds && (o = (o ? o + " " : "") + e.slotScopeIds.join(" ")), r("<!--[-->"), m(
        r,
        n,
        t,
        o
      ...
      break;
    default:
      i & 1 ? vr(r, e, t, o) : i & 6 ? r(T(e, t, o)) : i & 64 ? mr(r, e, t, o) : i & 128 && v(r, e.ssContent, t, o);
  }
}
function m(r, e, t, o) {
...
function vr(r, e, t, o) {
  const a = e.type;
  let { props: i, children: n, shapeFlag: l, scopeId: c } = e, p = `<${a}`;
  i && (p += lr(i, a)), c && (p += ` ${c}`);
  let d = t, s = e;
  for (; d && s === d.subTree; )
  ...
  if (o && (p += ` ${o}`), r(p + ">"), !P(a)) {
    let f = !1;
    i && (i.innerHTML ? (f = !0, r(i.innerHTML)) : i.textContent ? (f = !0, r(g(i.textContent))) : a === "textarea" && i.value && (f = !0, r(g(i.value)))), f || (l & 8 ? r(g(n)) : l & 16 && m(
      r,
      n,
      t,
      o
...
async function A(r, e = {}) {
  ...
  if (await kr(e), e.__watcherHandles)
...
async function kr(r) {
  if (r.__teleportBuffers) {
    ...
    for (const e in r.__teleportBuffers)
      r.teleports[e] = await R(
        await Promise.all([r.__teleportBuffers[e]])
      );
  }
}
er();
const xr = /* @__PURE__ */ tr({
  __name: "index",
  props: {
    _p: {},
    _$p: {},
