import { d as U, o as r, c as s, a as e, b as O, t as h, e as d, n as w, f as k, w as C, F as z, r as _, T as M, g as P, h as E, v as R, i as p, j as X, k as Y, l as K } from "./runtime-dom.esm-bundler-3-OL3GTG.js";
const W = { class: "w-full text-white font-sans relative transition-colors duration-300" }, Q = { class: "relative z-10 w-full max-w-[1440px] mx-auto" }, q = { class: "hidden lg:flex justify-between items-center px-6 py-2 text-[13px] tracking-wide" }, ee = { class: "flex items-center gap-5 relative" }, te = { class: "relative" }, oe = { class: "uppercase font-bold text-[13px]" }, ae = {
  key: 0,
...
}, re = ["onClick"], se = { class: "text-[11px] opacity-60 font-mono" }, le = { class: "flex flex-wrap items-center gap-4 px-4 pb-4 pt-2.5 lg:pt-2.5 lg:gap-6 relative z-30" }, ne = { href: "/" }, ie = ["src"], ce = { class: "order-3 w-full mt-2 lg:order-none lg:mt-0 lg:flex-1 relative group z-50" }, de = { class: "relative" }, ue = {
  key: 0,
...
}, pe = { class: "max-h-[420px] overflow-y-auto" }, fe = ["onClick"], ge = ["innerHTML"], ve = {
  key: 0,
  class: "px-6 py-5 text-gray-400 text-[13px] flex items-center gap-2"
}, he = { class: "flex items-center gap-2 lg:gap-5 ml-auto order-2 lg:order-none" }, xe = ["href"], ye = ["href"], me = ["href"], be = ["href"], we = {
  key: 0,
  class: "fixed inset-0 bg-white z-[999] flex flex-col lg:hidden"
}, ke = { class: "flex items-center gap-3 p-3.5 border-b border-gray-200 shadow-sm bg-white" }, Ce = { class: "flex-1 relative" }, ze = { class: "flex-1 overflow-y-auto bg-white" }, _e = {
  key: 0,
  class: "divide-y divide-gray-50"
}, Me = ["onClick"], Se = ["innerHTML"], Ie = {
  key: 1,
...
}, Le = { class: "flex items-center justify-between px-6 py-5 bg-gradient-to-r from-[#f6f6f9] to-[#ffffff] dark:from-[#252525] dark:to-[#1f1f1f] border-b border-gray-100 dark:border-gray-800" }, Te = { class: "flex-1 overflow-y-auto py-1" }, Ae = { class: "flex flex-col" }, Ne = {
  href: "#",
...
}, je = "https://fastapi.dryutil.1mn.io/client/api/i/ona/product_dir?typ=search_suggestion", Oe = "eyJhbGciOiJSUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6ImYwZTNlMDRiLTVkNDAtNDg1ZS05OGU4LWEzOTI3NWU3MzM0OCIsInNlY3VyaXR5Ijp7InBhcnR5IjpbInBhcnR5XzEiLCJwYXJ0eV8yIl19LCJzdWIiOiJmMGUzZTA0Yi01ZDQwLTQ4NWUtOThlOC1hMzkyNzVlNzMzNDgiLCJpYXQiOjE3NjU4MTI4Mjh9.OoClnPtlxI71L-e555nbNSmenmGufxewp78SlmdZCNxeuauXao5RRvqwOKQ77SJFqJXk0ng6GZ7VOgYECdEf-3k1UGX7w1NE_D5A6SP3UkVsSG8orYACFuvTyesbFwkpnEhdu0PBd6n8wuLkgU6nZ1bLDzKVg1zd8fFeJrwmUqk", Ee = /* @__PURE__ */ U({
  __name: "header",
  props: {
    _p: {},
    _$p: {}
  ...
  setup(o) {
    ...
    }, i = p(""), u = p([]), x = p(!1), v = p(!1), y = p(!1), B = p(null), m = p({
      var: {
        login: null
      },
      fn: {
    ...
    const D = () => {
      ...
      y.value || (v.value = !0), x.value = !0, $ = setTimeout(async () => {
        await H(i.value), x.value = !1;
      }, 300);
    }, H = async (c) => {
      try {
        const t = await fetch(je, {
          method: "POST",
          headers: {
    ...
    return (c, t) => (r(), s("header", W, [
      ...
      e("div", Q, [
        e("div", q, [
          t[8] || (t[8] = O('<div class="flex items-center gap-2 cursor-pointer hover:opacity-80 transition-opacity" data-v-0cc06d8d><svg class="w-3.5 h-3.5 text-white/90" fill="currentColor" viewBox="0 0 24 24" data-v-0cc06d8d><path d="M12 2C8.13 2 5 5.13 5 9c0 5.25 7 13 7 13s7-7.75 7-13c0-3.87-3.13-7-7-7zm0 9.5c-1.38 0-2.5-1.12-2.5-2.5s1.12-2.5 2.5-2.5 2.5 1.12 2.5 2.5-1.12 2.5-2.5 2.5z" data-v-0cc06d8d></path></svg><span class="border-b border-dashed border-white/50 hover:border-white transition-colors" data-v-0cc06d8d>New Delhi</span></div><div class="flex gap-7 text-white/95 font-medium" data-v-0cc06d8d><a href="#" class="hover:text-white transition-colors relative after:absolute after:bottom-[-8px] after:left-0 after:w-full after:h-0.5 after:bg-[#ffd900] after:opacity-0 hover:after:opacity-100 after:transition-opacity" data-v-0cc06d8d>Wibes</a><a href="#" class="hover:text-white transition-colors" data-v-0cc06d8d>Hotels</a><a href="#" class="hover:text-white transition-colors" data-v-0cc06d8d>Flights</a><a href="#" class="hover:text-white transition-colors" data-v-0cc06d8d>Trends</a><a href="#" class="hover:text-white transition-colors" data-v-0cc06d8d>Brands</a></div>', 2)),
          e("div", ee, [
        ...
        e("div", le, [
          e("a", ne, [
            e("img", {
              ...
              style: P(o._$p.data.curr.data.logo.style),
          ...
          e("div", ce, [
            ...
            v.value && u.value.length > 0 ? (r(), s("div", ue, [
              e("ul", pe, [
                (r(!0), s(z, null, _(u.value, (a, b) => (r(), s("li", {
                  key: b,
                  onClick: (G) => A(a.title),
          ...
          e("nav", he, [
            ...
            e("a", {
              ...
              O('<div class="relative" data-v-0cc06d8d><svg class="w-[26px] h-[26px] text-white/95 group-hover:text-white transition-colors drop-shadow-sm" fill="currentColor" viewBox="0 0 24 24" data-v-0cc06d8d><path d="M7 18c-1.1 0-1.99.9-1.99 2S5.9 22 7 22s2-.9 2-2-.9-2-2-2zm10 0c-1.1 0-1.99.9-1.99 2s.89 2 1.99 2 2-.9 2-2-.9-2-2-2zm-8.9-5h7.45c.75 0 1.41-.41 1.75-1.03L21.7 4H5.21l-.94-2H1v2h2l3.6 7.59-1.35 2.44C4.83 14.83 5.37 16 6.5 16H19v-2H7.42c-.14 0-.25-.11-.25-.25L7.1 13z" data-v-0cc06d8d></path></svg><span class="absolute -top-1 -right-2 bg-[#f44336] text-white text-[10px] font-bold px-1.5 py-0.5 rounded-full border-2 border-[#481173] min-w-[18px] text-center shadow-md" data-v-0cc06d8d>9</span></div><span class="text-[11px] font-medium opacity-95 group-hover:opacity-100 transition-opacity" data-v-0cc06d8d>Cart</span>', 2)
            ])], 8, be)
          ])
        ])
      ]),
        ...
        default: C(() => [
          y.value ? (r(), s("div", we, [
            ...
            e("div", ze, [
              ...
              ])])) : i.value.length > 0 ? (r(), s("div", Be, [...t[24] || (t[24] = [
                e("svg", {
  ...
  for (const [n, g] of l)
    f[n] = g;
  return f;
}, Ue = /* @__PURE__ */ Re(Ee, [["__scopeId", "data-v-0cc06d8d"]]), Ve = /* @__PURE__ */ U({
  __name: "index",
  props: {
    _p: {},
    _$p: {}
  ...
  setup(o) {
    return o._$p.data.curr.data.logo || (o._$p.data.curr.data.logo = { src: "", class: "", style: "" }), (async () => (o._p.my.emitter = o._p.f.new_emitter(), o._p.my.emitter.on("msg", async (l) => {
