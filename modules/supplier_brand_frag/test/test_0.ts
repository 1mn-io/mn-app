  ...
  l: [
    {
      ...
      "data": {
        ...
        api: {
          listBrand: {
            url: 
            //'http://localhost:8000/client/api/i/test/pdt_supplier_data?typ=list_brand',
            'https://fastapi.dryutil.1mn.io/client/api/i/ona/pdt_supplier_data?typ=list_brand',
            headers: {
              Authorization: 
              //'Bearer eyJhbGciOiJSUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6ImJmM2UyYzI5LTZhNzMtNDAyNy1hNDE0LTY4MGMyM2M3ODYzMSIsInNlY3VyaXR5Ijp7InBhcnR5IjpbInBhcnR5XzEiLCJwYXJ0eV8yIl19LCJzdWIiOiJiZjNlMmMyOS02YTczLTQwMjctYTQxNC02ODBjMjNjNzg2MzEiLCJpYXQiOjE3Nzk2NTA3MjJ9.KHBYgwCKDLprRu3Dyx7gZ5rejVlpD-LNYgaW4Zec21FbUEH-nk3_jm2TEM1BC7xQv24ysijqVjWZxAUxpChLhxy60hfcJ2Fe2hoMKAd-SyKwtTBrCddNGss6wiwsEON-qQ_ATYBb_NUimAh102xfR071zVxpC2hT3Yz1NK8u_zE',
              '{localStorage.token}'
            },
          },
          deleteBrand: {
            url: 
            //'http://localhost:8000/client/api/i/test/pdt_supplier_data?typ=delete_brand',
            'https://fastapi.dryutil.1mn.io/client/api/i/ona/pdt_supplier_data?typ=delete_brand',
            headers: {
              Authorization: 
              //'Bearer eyJhbGciOiJSUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6ImJmM2UyYzI5LTZhNzMtNDAyNy1hNDE0LTY4MGMyM2M3ODYzMSIsInNlY3VyaXR5Ijp7InBhcnR5IjpbInBhcnR5XzEiLCJwYXJ0eV8yIl19LCJzdWIiOiJiZjNlMmMyOS02YTczLTQwMjctYTQxNC02ODBjMjNjNzg2MzEiLCJpYXQiOjE3Nzk2NTA3MjJ9.KHBYgwCKDLprRu3Dyx7gZ5rejVlpD-LNYgaW4Zec21FbUEH-nk3_jm2TEM1BC7xQv24ysijqVjWZxAUxpChLhxy60hfcJ2Fe2hoMKAd-SyKwtTBrCddNGss6wiwsEON-qQ_ATYBb_NUimAh102xfR071zVxpC2hT3Yz1NK8u_zE',
              '{localStorage.token}'
