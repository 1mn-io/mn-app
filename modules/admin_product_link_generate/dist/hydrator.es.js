...
function Xr(o, r = "", e) {
  Uo(o) && e !== null && e !== void 0 && o.setAttribute(r, e);
}
var Vr = Object.defineProperty, Gr = Object.defineProperties, Ur = Object.getOwnPropertyDescriptors, po = Object.getOwnPropertySymbols, qo = Object.prototype.hasOwnProperty, Jo = Object.prototype.propertyIsEnumerable, zo = (o, r, e) => r in o ? Vr(o, r, { enumerable: !0, configurable: !0, writable: !0, value: e }) : o[r] = e, $ = (o, r) => {
  for (var e in r || (r = {})) qo.call(r, e) && zo(o, e, r[e]);
  if (po) for (var e of po(r)) Jo.call(r, e) && zo(o, e, r[e]);
  return o;
}, ho = (o, r) => Gr(o, Ur(r)), R = (o, r) => {
  var e = {};
  for (var t in o) qo.call(o, t) && r.indexOf(t) < 0 && (e[t] = o[t]);
  if (o != null && po) for (var t of po(o)) r.indexOf(t) < 0 && Jo.call(o, t) && (e[t] = o[t]);
  return e;
}, qr = Go(), _ = qr, ao = /{([^}]*)}/g, Ko = /(\d+\s+[\+\-\*\/]\s+\d+)/g, Zo = /var\([^)]+\)/g;
function Oo(o) {
  ...
  if (ro(o)) {
    ...
    if (X(l, ao)) {
      let d = l.replaceAll(ao, (c) => {
        ...
        return `var(${Qo(e, Vo(a.join("-")))}${v(n) ? `, ${n}` : ""})`;
      });
...
var V = (...o) => oe(C.getTheme(), ...o), oe = (o = {}, r, e, t) => {
  if (r) {
...
function uo(o, ...r) {
  if (o instanceof Array) {
    let e = o.reduce((t, n, l) => {
      var d;
      return t + n + ((d = P(r[l], { dt: V })) != null ? d : "");
    }, "");
    return rr(e, V);
  }
  return P(o, { dt: V });
...
function re(o, r = {}) {
  ...
  for (; a.length; ) {
    ...
    for (let u in s) {
      let f = s[u], m = Jr(f), p = X(u, l) ? yo(g) : yo(g, Vo(u));
...
var x = { regex: { rules: { class: { pattern: /^\.([a-zA-Z][\w-]*)$/, resolve(o) {
  ...
  if (v(u) && f.transform !== "strict") {
    ...
    y = `${xr}${$r}`, D = [.../* @__PURE__ */ new Set([...br, ...vr, ...yr])], L = P(u.css, { dt: V });
  }
  ...
  if (v(r) && e.transform !== "strict") {
    let f = o.replace("-directive", ""), m = r, { colorScheme: p, extend: b, css: h } = m, y = R(m, ["colorScheme", "extend", "css"]), D = b || {}, { colorScheme: L } = D, G = R(D, ["colorScheme"]), W = p || {}, { dark: z } = W, O = R(W, ["dark"]), T = L || {}, { dark: E } = T, N = R(T, ["dark"]), I = v(y) ? this._toVariables({ [f]: $($({}, y), G) }, e) : {}, A = v(O) ? this._toVariables({ [f]: $($({}, O), N) }, e) : {}, j = v(z) ? this._toVariables({ [f]: $($({}, z), E) }, e) : {}, [M, U] = [(c = I.declarations) != null ? c : "", I.tokens || []], [F, q] = [(a = A.declarations) != null ? a : "", A.tokens || []], [J, S] = [(i = j.declarations) != null ? i : "", j.tokens || []], B = this.transformCSS(f, `${M}${F}`, "light", "variable", e, n, l, d), H = this.transformCSS(f, J, "dark", "variable", e, n, l, d);
    s = `${B}${H}`, g = [.../* @__PURE__ */ new Set([...U, ...q, ...S])], u = P(h, { dt: V });
  }
  ...
  var r = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {}, e = to(!1), t = to(o), n = to(null), l = Yr() ? window.document : void 0, d = r.document, c = d === void 0 ? l : d, a = r.immediate, i = a === void 0 ? !0 : a, s = r.manual, g = s === void 0 ? !1 : s, u = r.name, f = u === void 0 ? "style_".concat(++de) : u, m = r.id, p = m === void 0 ? void 0 : m, b = r.media, h = b === void 0 ? void 0 : b, y = r.nonce, D = y === void 0 ? void 0 : y, L = r.first, G = L === void 0 ? !1 : L, W = r.onMounted, z = W === void 0 ? void 0 : W, O = r.onUpdated, T = O === void 0 ? void 0 : O, E = r.onLoad, N = E === void 0 ? void 0 : E, I = r.props, A = I === void 0 ? {} : I, j = function() {
    ...
    if (c) {
      ...
      n.value = c.querySelector('style[data-primevue-style-id="'.concat(B, '"]')) || c.getElementById(H) || c.createElement("style"), n.value.isConnected || (t.value = q || o, ko(n.value, {
        ...
        media: h,
        nonce: so
      }), G ? c.head.prepend(n.value) : c.head.appendChild(n.value), Xr(n.value, "data-primevue-style-id", B), ko(n.value, S), n.value.onload = function(K) {
        return N?.(K, {
          name: B
        });
...
`, Fu = { root: $u, header: Bu, headerCell: Su, columnTitle: Ru, row: _u, bodyCell: zu, footerCell: Ou, columnFooter: Tu, footer: Nu, columnResizer: ju, resizeIndicator: Pu, sortIcon: Du, loadingIcon: Lu, nodeToggleButton: Wu, paginatorTop: Eu, paginatorBottom: Iu, colorScheme: Au, css: Mu }, Hu = { mask: { background: "{content.background}", color: "{text.muted.color}" }, icon: { size: "2rem" } }, Yu = { loader: Hu }, Xu = Object.defineProperty, Vu = Object.defineProperties, Gu = Object.getOwnPropertyDescriptors, Mo = Object.getOwnPropertySymbols, Uu = Object.prototype.hasOwnProperty, qu = Object.prototype.propertyIsEnumerable, Fo = (o, r, e) => r in o ? Xu(o, r, { enumerable: !0, configurable: !0, writable: !0, value: e }) : o[r] = e, Ho, Ju = (Ho = ((o, r) => {
  for (var e in r || (r = {})) Uu.call(r, e) && Fo(o, e, r[e]);
  if (Mo) for (var e of Mo(r)) qu.call(r, e) && Fo(o, e, r[e]);
  return o;
})({}, nt), Vu(Ho, Gu({ components: { accordion: Ne, autocomplete: Fe, avatar: Ue, badge: rt, blockui: it, breadcrumb: st, button: gt, card: kt, carousel: Bt, cascadeselect: Nt, checkbox: Dt, chip: Mt, colorpicker: Vt, confirmdialog: qt, confirmpopup: on, contextmenu: cn, datatable: On, dataview: Wn, datepicker: ta, dialog: la, divider: ma, dock: ha, drawer: xa, editor: za, fieldset: Pa, fileupload: Fa, floatlabel: Ga, galleria: ci, iconfield: si, iftalabel: gi, image: vi, imagecompare: yi, inlinemessage: Bi, inplace: _i, inputchips: Ni, inputgroup: Pi, inputnumber: Ei, inputotp: Mi, inputtext: Hi, knob: Ui, listbox: ed, megamenu: fd, menu: vd, menubar: Bd, message: Dd, metergroup: Fd, multiselect: Zd, orderlist: rc, organizationchart: ic, overlaybadge: cc, paginator: gc, panel: yc, panelmenu: Sc, password: Nc, picklist: Dc, popover: Ec, progressbar: Fc, progressspinner: Yc, radiobutton: Gc, rating: Jc, ripple: Zc, scrollpanel: el, select: fl, selectbutton: pl, skeleton: vl, slider: $l, speeddial: Sl, splitbutton: _l, splitter: Nl, stepper: Ml, steps: Gl, tabmenu: Ql, tabs: ds, tabview: ms, tag: vs, terminal: Cs, textarea: $s, tieredmenu: Ts, timeline: Ws, toast: Gs, togglebutton: Zs, toggleswitch: eu, toolbar: nu, tooltip: du, tree: pu, treeselect: xu, treetable: Fu, virtualscroller: Yu }, css: ln })));
const wo = () => ({
                ...
                event: {
                  l: [
                    ...
                    },
                    {
                      ...
                      typ: "api",
                      data: {
                        url: "https://fastapi.dryutil.1mn.io/client/api/i/ona/product_dir?typ=create_product_link_with_genai",
                        method: "POST",
                        headers: {
