import { j as B, i as E, f as N, s as _, k as C, l as m, N as b, m as V, p as u, F as M, S as j, C as U, q as H, T as L, x as p, y as O, z as P, A as S, B as F, D as I, E as D, G, H as W, I as K, J as q, K as J, L as Q, M as X, O as Y, P as Z, Q as ee, R as te, d as re, c as ie, o as oe, U as ne } from "./runtime-dom.esm-bundler-BgnH2PNw.js";
function se(e, t) {
  t === void 0 && (t = {});
  var i = t.insertAt;
...
function he(e, t, i, r, o) {
  e("<!--teleport start-->");
  const n = o.appContext.provides[_], s = n.__teleportBuffers || (n.__teleportBuffers = {}), a = s[i] || (s[i] = []), c = a.length;
  let f;
  if (r)
...
function w(e, t, i, r) {
  const { type: o, shapeFlag: n, children: s, dirs: a, props: c } = t;
  switch (a && (t.props = ve(t, c, a)), o) {
    case L:
      e(p(s));
      break;
    case U:
...
function ye(e, t, i, r) {
  const o = t.type;
  let { props: n, children: s, shapeFlag: a, scopeId: c } = t, f = `<${o}`;
  n && (f += ce(n, o)), c && (f += ` ${c}`);
  let d = i, l = t;
  for (; d && l === d.subTree; )
