import { s as m } from "./index-BC52hFLB.js";
import { s as x } from "./index-BJUkcrjV.js";
import { s as c } from "./index-CLlCJZKz.js";
import { s as v } from "./index-CcHoYxw3.js";
import { s as _ } from "./index-BKwuUbG4.js";
import { X as a, G as g, H as u, I as b, a3 as s, a as e } from "./runtime-dom.esm-bundler-C71lIG0B.js";
const w = { class: "flex flex-col md:flex-row gap-8" }, y = { class: "md:w-1/2" }, O = { class: "card flex flex-col gap-4" }, V = { class: "flex flex-col gap-2" }, F = { class: "flex flex-col gap-2" }, I = { class: "flex flex-col gap-2" }, L = { class: "card flex flex-col gap-4" }, N = { class: "flex flex-wrap gap-4" }, B = { class: "flex flex-col grow basis-0 gap-2" }, E = { class: "flex flex-col grow basis-0 gap-2" }, S = { class: "md:w-1/2" }, $ = { class: "card flex flex-col gap-4" }, z = { class: "grid grid-cols-12 gap-2" }, A = { class: "col-span-12 md:col-span-10" }, H = { class: "grid grid-cols-12 gap-2" }, T = { class: "col-span-12 md:col-span-10" }, k = { class: "card flex flex-col gap-4" }, G = { class: "flex flex-wrap items-start gap-4" }, U = { class: "field" }, C = { class: "field" }, X = { class: "card flex flex-col gap-4" }, Z = { class: "flex flex-wrap gap-2" }, j = { class: "flex mt-8" }, q = { class: "card flex flex-col gap-4 w-full" }, D = { class: "flex flex-col md:flex-row gap-4" }, J = { class: "flex flex-wrap gap-2 w-full" }, K = { class: "flex flex-wrap gap-2 w-full" }, M = { class: "flex flex-wrap" }, P = { class: "flex flex-col md:flex-row gap-4" }, Q = { class: "flex flex-wrap gap-2 w-full" }, R = { class: "flex flex-wrap gap-2 w-full" }, as = {
  __name: "FormLayout",
  setup(W) {
    const i = a([
