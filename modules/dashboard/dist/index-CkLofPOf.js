import { B as u, k as b } from "./main-HoJjMwWR.js";
import { a as l } from "./index-BqrZ5r-u.js";
const { createElementBlock: s, openBlock: c, mergeProps: a, createElementVNode: e } = window.Vue;
import { f as p } from "./index-BcTfHd3F.js";
var h = `
    .p-radiobutton {
        position: relative;
        display: inline-flex;
...
function v(n, t, o) {
  return (t = y(t)) in n ? Object.defineProperty(n, t, { value: o, enumerable: !0, configurable: !0, writable: !0 }) : n[t] = o, n;
}
function y(n) {
  var t = k(n, "string");
  ...
  methods: {
    ...
    onChange: function(t) {
      if (!this.disabled && !this.readonly) {
        ...
        this.$pcRadioButtonGroup ? this.$pcRadioButtonGroup.writeValue(o, t) : this.writeValue(o, t), this.$emit("change", t);
      }
    },
    onFocus: function(t) {
      this.$emit("focus", t);
    ...
    onBlur: function(t) {
      var o, r;
      this.$emit("blur", t), (o = (r = this.formField).onBlur) === null || o === void 0 || o.call(r, t);
    }
  },
  computed: {
    groupName: function() {
    ...
    checked: function() {
      ...
      return t != null && (this.binary ? !!t : b(t, this.value));
    },
    dataP: function() {
      return p(v({
...
}, B = ["data-p-checked", "data-p-disabled", "data-p"], w = ["id", "value", "name", "checked", "tabindex", "disabled", "readonly", "aria-labelledby", "aria-label", "aria-invalid"], P = ["data-p"], z = ["data-p"];
function S(n, t, o, r, R, i) {
  return c(), s("div", a({
    class: n.cx("root")
  }, i.getPTOptions("root"), {
  ...
  }, i.getPTOptions("input")), null, 16, w), e("div", a({
    class: n.cx("box")
  }, i.getPTOptions("box"), {
    "data-p": i.dataP
  }), [e("div", a({
