import { w as z, B as j, a as V, b as $, i as m, Y as R, I as A, v as B, D as M, x as y, S as D } from "./main-DmGEeWOh.js";
import { O as H, C as U } from "./index-D4csMdAS.js";
import { s as x } from "./index-CTvE0mxz.js";
import { V as b, H as u, W as l, m as i, E as h, a as c, I as s, J as f, G as w, Y as k, Z as C, a0 as S, ad as q } from "./runtime-dom.esm-bundler-CEAeiVlj.js";
import { s as K, a as Z } from "./index-PGJZDOlW.js";
var T = {
  name: "EyeSlashIcon",
  extends: z
};
...
var ae = {
  ...
  beforeUnmount: function() {
    this.unbindResizeListener(), this.scrollHandler && (this.scrollHandler.destroy(), this.scrollHandler = null), this.overlay && (y.clear(this.overlay), this.overlay = null);
  },
  methods: {
    onOverlayEnter: function(n) {
      y.set("overlay", n, this.$primevue.config.zIndex.overlay), D(n, {
        position: "absolute",
        top: "0"
    ...
    alignOverlay: function() {
      this.appendTo === "self" ? A(this.overlay, this.$refs.input.$el) : (this.overlay.style.minWidth = B(this.$refs.input.$el) + "px", M(this.overlay, this.$refs.input.$el));
    },
    ...
    onKeyUp: function(n) {
      if (this.feedback) {
        var t = n.target.value, r = this.checkPasswordStrength(t), o = r.meter, a = r.label;
        if (this.meter = o, this.infoText = a, n.code === "Escape") {
    ...
    bindScrollListener: function() {
      var n = this;
      this.scrollHandler || (this.scrollHandler = new U(this.$refs.input.$el, function() {
    ...
    bindResizeListener: function() {
      ...
      this.resizeListener || (this.resizeListener = function() {
        n.overlayVisible && !R() && (n.overlayVisible = !1);
  ...
  computed: {
    ...
    meterDataP: function() {
      var n, t;
      return m(I({}, (n = this.meter) === null || n === void 0 ? void 0 : n.strength, (t = this.meter) === null || t === void 0 ? void 0 : t.strength));
    },
    overlayDataP: function() {
      return m(I({}, "portal-" + this.appendTo, "portal-" + this.appendTo));
    }
  },
  components: {
    InputText: K,
...
function ie(e, n, t) {
  return (n = oe(n)) in e ? Object.defineProperty(e, n, { value: t, enumerable: !0, configurable: !0, writable: !0 }) : e[n] = t, e;
}
function oe(e) {
  var n = se(e, "string");
...
function pe(e, n, t, r, o, a) {
  var P = h("InputText"), O = h("TimesIcon"), E = h("Portal");
  return u(), b("div", i({
    class: e.cx("root"),
    style: e.sx("root"),
    ...
    "aria-controls": o.overlayVisible ? e.overlayProps && e.overlayProps.id || e.overlayId || e.panelProps && e.panelProps.id || e.panelId || a.overlayUniqueId : void 0,
    "aria-haspopup": !0,
  ...
  }) : f("", !0), e.toggleMask && !o.unmasked ? s(e.$slots, e.$slots.unmaskicon ? "unmaskicon" : "showicon", i({
    key: 1,
    toggleCallback: a.onMaskToggle,
  ...
  }) : f("", !0), a.isClearIconVisible ? s(e.$slots, "clearicon", i({
    key: 2,
    ...
    default: S(function() {
      return [c(q, i({
        ...
        default: S(function() {
          return [o.overlayVisible ? (u(), b("div", i({
            key: 0,
            ref: a.overlayRef,
            ...
            return [l("div", i({
              ...
              "data-p": a.meterDataP
            }, e.ptm("meterLabel")), null, 16, de)], 16), l("div", i({
              class: e.cx("meterText")
            }, e.ptm("meterText")), C(o.infoText), 17)], 16)];
