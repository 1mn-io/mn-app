import { B as u, i as b, k as l } from "./main-DmGEeWOh.js";
import { a as s } from "./index-PGJZDOlW.js";
import { V as c, H as p, W as e, m as a } from "./runtime-dom.esm-bundler-CEAeiVlj.js";
var h = `
    .p-radiobutton {
        position: relative;
        display: inline-flex;
...
var B = {
  ...
  computed: {
    ...
    checked: function() {
      ...
      return t != null && (this.binary ? !!t : l(t, this.value));
    },
    dataP: function() {
      return b(v({
...
}, x = ["data-p-checked", "data-p-disabled", "data-p"], w = ["id", "value", "name", "checked", "tabindex", "disabled", "readonly", "aria-labelledby", "aria-label", "aria-invalid"], P = ["data-p"], z = ["data-p"];
