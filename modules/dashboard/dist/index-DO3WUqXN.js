import { s as a } from "./index-BDd5eCIG.js";
const { createElementBlock: i, openBlock: l, mergeProps: u, createElementVNode: s } = window.Vue;
var C = {
  name: "BarsIcon",
  extends: a
};
function p(r) {
  return m(r) || d(r) || f(r) || c();
}
function c() {
