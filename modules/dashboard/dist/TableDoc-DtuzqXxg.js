import { s as Y } from "./index-DY40fn-R.js";
import { s as Q } from "./index-D_I3J9JH.js";
import { s as Z } from "./index-CXfSJiCM.js";
import { s as ee } from "./index-DPIQTGO7.js";
import { b as ae, s as ne, a as ie } from "./index-DPOweF1B.js";
import { s as te } from "./index-BctaLG9L.js";
import { s as re } from "./index-JFi7Gene.js";
import { s as oe } from "./index-CPOuXgRp.js";
import { s as me } from "./index-C3dFQVuj.js";
import { s as ce } from "./index-9Mdthw2i.js";
import { s as se, a as de } from "./index-prkcUU1-.js";
import { s as le } from "./index-BqrZ5r-u.js";
import { s as ue } from "./index-Bbb9yBUj.js";
const { ref: l, reactive: k, onBeforeMount: ye, createElementBlock: pe, openBlock: ve, Fragment: ge, createElementVNode: t, createVNode: a, withCtx: n, createTextVNode: y, toDisplayString: c, normalizeClass: B } = window.Vue;
import { P as fe } from "./ProductService-bZb9w0YO.js";
import { F as s, a2 as h } from "./main-HoJjMwWR.js";
...
const M = {
  ...
  getCustomers(b) {
    const p = b ? Object.keys(b).map((u) => encodeURIComponent(u) + "=" + encodeURIComponent(b[u])).join("&") : "";
    return fetch("https://www.primefaces.org/data/customers?" + p).then((u) => u.json());
  }
}, be = { class: "card" }, we = { class: "flex justify-between" }, Se = { class: "flex items-center gap-2" }, Ce = { class: "flex items-center gap-2" }, Ae = ["alt", "src"], Ie = { class: "flex items-center gap-2" }, Ee = ["alt", "src"], qe = { class: "flex items-center justify-between px-2" }, Be = { class: "card" }, Me = { class: "font-bold" }, xe = { class: "card" }, ke = { class: "flex flex-wrap justify-end gap-2" }, Fe = ["src", "alt"], Le = { class: "p-4" }, De = { class: "card" }, Je = { class: "flex items-center gap-2" }, Pe = ["alt", "src"], Re = { class: "flex items-center gap-2" }, Te = { class: "flex justify-end font-bold w-full" }, He = {
  __name: "TableDoc",
  setup(b) {
    const p = l(null), u = l(null), w = l(null), v = l(null), x = l(null), A = l(!1), I = l(null), S = l([]), F = k(["unqualified", "qualified", "new", "negotiation", "renewal", "proposal"]), L = k([
    ...
    ye(() => {
      fe.getProductsWithOrdersSmall().then((m) => I.value = m), M.getCustomersLarge().then((m) => {
        p.value = m, x.value = !1, p.value.forEach((r) => r.date = new Date(r.date));
      }), M.getCustomersLarge().then((m) => u.value = m), M.getCustomersMedium().then((m) => w.value = m), P();
    });
    function P() {
      v.value = {
        global: { value: null, matchMode: s.CONTAINS },
        name: { operator: h.AND, constraints: [{ value: null, matchMode: s.STARTS_WITH }] },
        "country.name": { operator: h.AND, constraints: [{ value: null, matchMode: s.STARTS_WITH }] },
        representative: { value: null, matchMode: s.IN },
        date: { operator: h.AND, constraints: [{ value: null, matchMode: s.DATE_IS }] },
        balance: { operator: h.AND, constraints: [{ value: null, matchMode: s.EQUALS }] },
        status: { operator: h.OR, constraints: [{ value: null, matchMode: s.EQUALS }] },
        activity: { value: [0, 100], matchMode: s.BETWEEN },
        verified: { value: null, matchMode: s.EQUALS }
      };
    }
    function R() {
      S.value = I.value.reduce((m, r) => (m[r.id] = !0) && m, {});
    }
    function T() {
      S.value = null;
    }
    function C(m) {
      return m.toLocaleString("en-US", { style: "currency", currency: "USD" });
    }
    function H(m) {
    ...
    function O(m) {
      let r = 0;
      if (w.value)
        for (let d of w.value)
          d.representative.name === m && r++;
      return r;
    }
    return (m, r) => {
      const d = ue, G = de, q = le, z = se, i = ce, K = ae, N = ne, V = me, g = oe, W = re, _ = te, j = ie, U = ee, f = Z, X = Q, $ = Y;
      return ve(), pe(ge, null, [
        t("div", be, [
          r[9] || (r[9] = t("div", { class: "font-semibold text-xl mb-4" }, "Filtering", -1)),
          a(f, {
            value: p.value,
            paginator: !0,
            rows: 10,
            ...
            rowHover: !0,
            filters: v.value,
            "onUpdate:filters": r[2] || (r[2] = (e) => v.value = e),
            filterDisplay: "menu",
            loading: x.value,
            ...
            header: n(() => [
              t("div", we, [
                a(d, {
                  ...
                  label: "Clear",
                  outlined: "",
                  onClick: r[0] || (r[0] = (e) => m.clearFilter())
                }),
                a(z, null, {
                  default: n(() => [
                    a(G, null, {
                      default: n(() => [...r[5] || (r[5] = [
                        t("i", { class: "pi pi-search" }, null, -1)
                      ])]),
                      _: 1
                    }),
                    a(q, {
                      modelValue: v.value.global.value,
                      "onUpdate:modelValue": r[1] || (r[1] = (e) => v.value.global.value = e),
            ...
            empty: n(() => [...r[6] || (r[6] = [
              y(" No customers found. ", -1)
            ])]),
            loading: n(() => [...r[7] || (r[7] = [
              y(" Loading customers data. Please wait. ", -1)
            ])]),
            default: n(() => [
              a(i, {
                field: "name",
              ...
              a(i, {
                ...
                body: n(({ data: e }) => [
                  t("div", Se, [
                    t("img", {
                      ...
                      class: B(`flag flag-${e.country.code}`),
                      style: { width: "24px" }
                    }, null, 2),
                    t("span", null, c(e.country.name), 1)
                  ])
                ]),
                filter: n(({ filterModel: e }) => [
                  a(q, {
                ...
                filterclear: n(({ filterCallback: e }) => [
                  a(d, {
                    type: "button",
                    icon: "pi pi-times",
                    onClick: (o) => e(),
                ...
                filterapply: n(({ filterCallback: e }) => [
                  a(d, {
                    type: "button",
                    icon: "pi pi-check",
                    onClick: (o) => e(),
              ...
              a(i, {
                ...
                body: n(({ data: e }) => [
                  t("div", Ce, [
                    t("img", {
                      alt: e.representative.name,
                      src: `https://primefaces.org/cdn/primevue/images/avatar/${e.representative.image}`,
                      style: { width: "32px" }
                    }, null, 8, Ae),
                    t("span", null, c(e.representative.name), 1)
                  ])
                ]),
                filter: n(({ filterModel: e }) => [
                  a(K, {
                    ...
                    option: n((o) => [
                      t("div", Ie, [
                        t("img", {
                          alt: o.option.name,
                          src: `https://primefaces.org/cdn/primevue/images/avatar/${o.option.image}`,
                          style: { width: "32px" }
                        }, null, 8, Ee),
                        t("span", null, c(o.option.name), 1)
                      ])
                    ]),
                    _: 1
              ...
              a(i, {
                ...
                filter: n(({ filterModel: e }) => [
                  ...
                  t("div", qe, [
                    t("span", null, c(e.value ? e.value[0] : 0), 1),
                    t("span", null, c(e.value ? e.value[1] : 100), 1)
                  ])
                ]),
                _: 1
              }),
              a(i, {
                ...
                body: n(({ data: e }) => [
                  t("i", {
                    class: B(["pi", { "pi-check-circle text-green-500 ": e.verified, "pi-times-circle text-red-500": !e.verified }])
                  }, null, 2)
                ]),
                filter: n(({ filterModel: e }) => [
                  r[8] || (r[8] = t("label", {
        ...
        t("div", Be, [
          r[10] || (r[10] = t("div", { class: "font-semibold text-xl mb-4" }, "Frozen Columns", -1)),
          a(X, {
            modelValue: A.value,
            "onUpdate:modelValue": r[3] || (r[3] = (e) => A.value = e),
            onIcon: "pi pi-lock",
        ...
        t("div", xe, [
          r[11] || (r[11] = t("div", { class: "font-semibold text-xl mb-4" }, "Row Expansion", -1)),
          a(f, {
            expandedRows: S.value,
            "onUpdate:expandedRows": r[4] || (r[4] = (e) => S.value = e),
            value: I.value,
            dataKey: "id",
            ...
            expansion: n((e) => [
              t("div", Le, [
                t("h5", null, "Orders for " + c(e.data.name), 1),
                a(f, {
                  value: e.data.orders
                }, {
                  default: n(() => [
                    ...
                    a(i, {
                      ...
                      body: n((o) => [
                        a(g, {
                          value: o.data.status.toLowerCase(),
                          severity: D(o.data)
                        }, null, 8, ["value", "severity"])
                      ]),
                      _: 2
                    }, 1024),
                    a(i, { headerStyle: "width:4rem" }, {
                      body: n(() => [
                        a(d, { icon: "pi pi-search" })
                      ]),
                      _: 1
                    })
                  ]),
            ...
            default: n(() => [
              ...
              a(i, { header: "Image" }, {
                body: n((e) => [
                  t("img", {
                    src: `https://primefaces.org/cdn/primevue/images/product/${e.data.image}`,
                    alt: e.data.image,
                    class: "shadow-lg",
                    width: "64"
                  }, null, 8, Fe)
        ...
        t("div", De, [
          r[12] || (r[12] = t("div", { class: "font-semibold text-xl mb-4" }, "Grouping", -1)),
          a(f, {
            value: w.value,
            ...
            groupheader: n((e) => [
              t("div", Je, [
                t("img", {
                  alt: e.data.representative.name,
                  src: `https://primefaces.org/cdn/primevue/images/avatar/${e.data.representative.image}`,
                  width: "32",
                  style: { "vertical-align": "middle" }
                }, null, 8, Pe),
                t("span", null, c(e.data.representative.name), 1)
              ])
            ]),
            groupfooter: n((e) => [
              t("div", Te, "Total Customers: " + c(O(e.data.representative.name)), 1)
            ]),
            default: n(() => [
              a(i, {
                field: "representative.name",
                ...
                body: n((e) => [
                  t("div", Re, [
                    t("img", {
                      alt: "flag",
                      src: "https://primefaces.org/cdn/primevue/images/flag/flag_placeholder.png",
                      class: B(`flag flag-${e.data.country.code}`),
                      style: { width: "24px" }
                    }, null, 2),
                    t("span", null, c(e.data.country.name), 1)
                  ])
                ]),
                _: 1
              }),
...
}, na = /* @__PURE__ */ he(He, [["__scopeId", "data-v-79afe919"]]);
export {
  na as default
};
