import { B as re, R as oe, o as ie, s as q, i as H, a0 as ae, p as le, Q as M, z as V, f as R, v as de, a1 as se } from "./main-DmGEeWOh.js";
import { b as ce } from "./index-rHs1im66.js";
import { s as J } from "./index-4IqxQNQ3.js";
import { s as ue, a as pe } from "./index-BX8nGF6u.js";
import { s as fe } from "./index-PGJZDOlW.js";
import { a3 as he, E as m, X as ge, V as p, H as s, J as v, W as j, p as b, $ as ye, G as f, m as u, F as C, Y as k, a0 as A, ah as be, ag as Q, Z as X, a2 as $, a as K, I as T, ad as me } from "./runtime-dom.esm-bundler-CEAeiVlj.js";
import { s as ve } from "./index-DFnj3uPo.js";
import { s as ke } from "./index-Sz5ySbmC.js";
import { s as Ne } from "./index-DwxjZ8kc.js";
import { s as De } from "./index-DEtGoJpz.js";
var Se = `
    .p-tree {
        display: block;
...
var ee = {
  ...
  methods: {
    ...
    onArrowLeft: function(e) {
      var n = V(e.currentTarget, '[data-pc-section="nodetogglebutton"]');
    ...
    onNodeDragStart: function(e) {
      if (this.isNodeDraggable) {
        ...
        n.setAttribute("data-p-dragging", "true"), o.style.width = de(n) + "px", o.style.height = se(n) + "px", o.setAttribute("data-pc-section", "drag-image"), i.style.visibility = "hidden", r?.remove(), document.body.appendChild(o), e.dataTransfer.setDragImage(o, 0, 0), setTimeout(function() {
    ...
    setAllNodesTabIndexes: function() {
      var e = R(this.$refs.currentNode.closest('[data-pc-section="rootchildren"]'), '[role="treeitem"]'), n = S(e).some(function(i) {
    ...
    setTabIndexForSelectionMode: function(e, n) {
      if (this.selectionMode !== null) {
        var o = S(R(this.$refs.currentNode.parentElement, '[role="treeitem"]'));
...
function ze(t, e, n, o, i, r) {
  var a = m("SpinnerIcon"), l = m("Checkbox"), d = m("TreeNode", !0), c = ge("ripple");
  return s(), p("li", u({
    ref: "currentNode",
    class: t.cx("node"),
    role: "treeitem",
    ...
    key: 1
  }, [Q(X(r.label(n.node)), 1)], 64))], 16)], 16, Fe), r.isNextDropPointActive ? (s(), p("div", {
    key: 1,
    class: b(t.cx("dropPoint")),
    "aria-hidden": "true"
...
var We = {
  ...
  methods: {
    ...
    isFilterMatched: function(e, n) {
      ...
      try {
        for (l.s(); !(d = l.n()).done; ) {
          var c = d.value, g = String(le(e, c)).toLocaleLowerCase(this.filterLocale);
          g.indexOf(i) > -1 && (a = !0);
        }
      } catch (x) {
        l.e(x);
  ...
  computed: {
    filteredValue: function() {
      var e = [], n = ae(this.filterBy) ? [this.filterBy] : this.filterBy.split(","), o = this.filterValue.trim().toLocaleLowerCase(this.filterLocale), i = this.filterMode === "strict", r = O(this.value), a;
      try {
        for (r.s(); !(a = r.n()).done; ) {
...
function Z(t) {
  for (var e = 1; e < arguments.length; e++) {
    var n = arguments[e] != null ? arguments[e] : {};
    e % 2 ? Y(Object(n), !0).forEach(function(o) {
      Ge(t, o, n[o]);
    }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(t, Object.getOwnPropertyDescriptors(n)) : Y(Object(n)).forEach(function(o) {
      Object.defineProperty(t, o, Object.getOwnPropertyDescriptor(n, o));
    });
  }
  return t;
...
function Ge(t, e, n) {
  return (e = Ye(e)) in t ? Object.defineProperty(t, e, { value: n, enumerable: !0, configurable: !0, writable: !0 }) : t[e] = n, t;
}
function Ye(t) {
  var e = Ze(t, "string");
...
var qe = ["data-p"], Je = ["data-p"], Qe = ["aria-labelledby", "aria-label"];
function Xe(t, e, n, o, i, r) {
  ...
  return s(), p("div", u({
    ...
    key: 0,
    unstyled: t.unstyled,
    pt: Z(Z({}, t.ptm("pcFilter")), t.ptm("pcFilterContainer")),
    ...
    return [Q(X(r.emptyMessageText), 1)];
  })], 16)) : v("", !0) : (s(), p("ul", u({
    key: 0,
