import { B as re, ad as oe, p as ie, Q as M, z as H, d as V, v as ae, C as le } from "./main-HoJjMwWR.js";
import { c as de } from "./index-JFi7Gene.js";
import { a as Z } from "./index-C3UPxY3s.js";
import { s as se, a as ce } from "./index-prkcUU1-.js";
import { s as ue } from "./index-BqrZ5r-u.js";
import { s as Q } from "./index-lKnV4MRg.js";
const { reactive: pe, resolveComponent: m, resolveDirective: fe, createElementBlock: p, openBlock: s, mergeProps: u, createCommentVNode: v, createElementVNode: j, normalizeClass: b, withDirectives: he, createBlock: f, Fragment: C, resolveDynamicComponent: k, withCtx: A, withModifiers: ge, createTextVNode: J, toDisplayString: X, renderList: $, createVNode: K, Transition: ye, renderSlot: T } = window.Vue;
import { s as be } from "./index-DNewhQo1.js";
import { s as me } from "./index-BfXXEqKQ.js";
import { s as ve } from "./index-BDqxOfG1.js";
import { s as ke } from "./index-CrkgpO9J.js";
import { s as Ne } from "./index-DPIQTGO7.js";
import { R as De, f as R } from "./index-BcTfHd3F.js";
var Se = `
    .p-tree {
        display: block;
...
`, xe = {
  ...
  dragNode: null,
  dragScope: null
}), E = /* @__PURE__ */ new Set(), F = /* @__PURE__ */ new Set();
function we() {
  var t = function(r) {
    N.isDragging = !0, N.dragNode = r.node, N.dragScope = r.scope, E.forEach(function(a) {
      return a(r);
    });
  }, e = function(r) {
    N.isDragging = !1, N.dragNode = null, N.dragScope = null, F.forEach(function(a) {
      return a(r);
    });
  }, n = function(r) {
...
function Oe(t, e, n) {
  return (e = Ae(e)) in t ? Object.defineProperty(t, e, { value: n, enumerable: !0, configurable: !0, writable: !0 }) : t[e] = n, t;
}
function Ae(t) {
  var e = Me(t, "string");
...
var ee = {
  ...
  methods: {
    ...
    onClick: function(e) {
      if (this.toggleClicked || M(e.target, '[data-pc-section="nodetogglebutton"]') || M(e.target.parentElement, '[data-pc-section="nodetogglebutton"]')) {
    ...
    onArrowLeft: function(e) {
      var n = H(e.currentTarget, '[data-pc-section="nodetogglebutton"]');
    ...
    insertNodeInSiblings: function(e, n, o, i) {
      var r = this, a = e.findIndex(function(l) {
        return l.key === n;
      });
      return a !== -1 ? e.toSpliced(a + i, 0, o) : e.map(function(l) {
        return l.children && l.children.length > 0 ? y(y({}, l), {}, {
          children: r.insertNodeInSiblings(l.children, n, o, i)
        }) : l;
      });
    },
    addNodeAsChild: function(e, n, o) {
      ...
      return e.map(function(r) {
        return r.key === n ? y(y({}, r), {}, {
          children: [].concat(S(r.children || []), [o])
        }) : r.children && r.children.length > 0 ? y(y({}, r), {}, {
    ...
    insertNodeOnDrop: function() {
      ...
      if (!this.node || o == null || !n || !i)
        return null;
      var a = this.dropPosition, l = this.removeNodeFromTree(this.rootNodes, n);
      return a < 0 ? l = this.insertNodeInSiblings(l, this.node.key, n, 0) : a > 0 ? l = this.insertNodeInSiblings(l, this.node.key, n, 1) : l = this.addNodeAsChild(l, this.node.key, n), this.$emit("value-change", {
        nodes: l
      }), r.stopDrag({
        node: n,
        subNodes: l,
    ...
    onNodeDragStart: function(e) {
      if (this.isNodeDraggable) {
        ...
        n.setAttribute("data-p-dragging", "true"), o.style.width = ae(n) + "px", o.style.height = le(n) + "px", o.setAttribute("data-pc-section", "drag-image"), i.style.visibility = "hidden", r?.remove(), document.body.appendChild(o), e.dataTransfer.setDragImage(o, 0, 0), setTimeout(function() {
    ...
    setAllNodesTabIndexes: function() {
      var e = V(this.$refs.currentNode.closest('[data-pc-section="rootchildren"]'), '[role="treeitem"]'), n = S(e).some(function(i) {
        return i.getAttribute("aria-selected") === "true" || i.getAttribute("aria-checked") === "true";
      });
      if (S(e).forEach(function(i) {
        i.tabIndex = -1;
      }), n) {
        var o = S(e).filter(function(i) {
          return i.getAttribute("aria-selected") === "true" || i.getAttribute("aria-checked") === "true";
        });
        o[0].tabIndex = 0;
        return;
    ...
    setTabIndexForSelectionMode: function(e, n) {
      if (this.selectionMode !== null) {
        var o = S(V(this.$refs.currentNode.parentElement, '[role="treeitem"]'));
    ...
    propagateUp: function(e) {
      var n = e.check, o = y({}, e.selectionKeys), i = 0, r = !1, a = B(this.node.children), l;
      try {
        for (a.s(); !(l = a.n()).done; ) {
          var d = l.value;
          o[d.key] && o[d.key].checked ? i++ : o[d.key] && o[d.key].partialChecked && (r = !0);
        }
      } catch (c) {
        a.e(c);
      } finally {
    ...
    getParentNodeElement: function(e) {
      ...
      return M(n, "role") === "treeitem" ? n : null;
    },
...
}, Ee = ["aria-label", "aria-selected", "aria-expanded", "aria-setsize", "aria-posinset", "aria-level", "aria-checked", "tabindex"], Fe = ["draggable", "data-p-selected", "data-p-selectable"], je = ["data-p-leaf"];
function ze(t, e, n, o, i, r) {
  var a = m("SpinnerIcon"), l = m("Checkbox"), d = m("TreeNode", !0), c = fe("ripple");
  return s(), p("li", u({
    ref: "currentNode",
    class: t.cx("node"),
    role: "treeitem",
  ...
  }, r.getPTOptions("node")), [r.isPrevDropPointActive ? (s(), p("div", {
    key: 0,
    class: b(t.cx("dropPoint")),
    "aria-hidden": "true"
  }, null, 2)) : v("", !0), j("div", u({
    ...
    tabindex: "-1",
    "data-p-leaf": r.leaf
  }, r.getPTOptions("nodeToggleButton")), [n.node.loading && n.loadingMode === "icon" ? (s(), p(C, {
    key: 0
  }, [n.templates.nodetoggleicon || n.templates.nodetogglericon ? (s(), f(k(n.templates.nodetoggleicon || n.templates.nodetogglericon), {
    key: 0,
    node: n.node,
    expanded: r.expanded,
    class: b(t.cx("nodeToggleIcon"))
  }, null, 8, ["node", "expanded", "class"])) : (s(), f(a, u({
    key: 1,
    spin: "",
    class: t.cx("nodeToggleIcon")
  }, r.getPTOptions("nodeToggleIcon")), null, 16, ["class"]))], 64)) : (s(), p(C, {
    key: 1
  }, [n.templates.nodetoggleicon || n.templates.togglericon ? (s(), f(k(n.templates.nodetoggleicon || n.templates.togglericon), {
    key: 0,
    node: n.node,
    expanded: r.expanded,
    class: b(t.cx("nodeToggleIcon"))
  }, null, 8, ["node", "expanded", "class"])) : r.expanded ? (s(), f(k(n.node.expandedIcon ? "span" : "ChevronDownIcon"), u({
    key: 1,
    class: t.cx("nodeToggleIcon")
  }, r.getPTOptions("nodeToggleIcon")), null, 16, ["class"])) : (s(), f(k(n.node.collapsedIcon ? "span" : "ChevronRightIcon"), u({
    key: 2,
    class: t.cx("nodeToggleIcon")
  }, r.getPTOptions("nodeToggleIcon")), null, 16, ["class"]))], 64))], 16, je)), [[c]]), r.checkboxMode ? (s(), f(l, {
    key: 0,
    defaultValue: r.checked,
    binary: !0,
    indeterminate: r.partialChecked,
    class: b(t.cx("nodeCheckbox")),
    tabindex: -1,
    unstyled: t.unstyled,
    ...
    icon: A(function(g) {
      return [n.templates.checkboxicon ? (s(), f(k(n.templates.checkboxicon), {
        key: 0,
        checked: g.checked,
        partialChecked: r.partialChecked,
        class: b(g.class)
      }, null, 8, ["checked", "partialChecked", "class"])) : v("", !0)];
    }),
    _: 1
  }, 8, ["defaultValue", "indeterminate", "class", "unstyled", "pt", "data-p-partialchecked"])) : v("", !0), n.templates.nodeicon ? (s(), f(k(n.templates.nodeicon), u({
    key: 1,
    node: n.node,
    class: [t.cx("nodeIcon")]
  }, r.getPTOptions("nodeIcon")), null, 16, ["node", "class"])) : (s(), p("span", u({
    key: 2,
    class: [t.cx("nodeIcon"), n.node.icon]
  }, r.getPTOptions("nodeIcon")), null, 16)), j("span", u({
    class: t.cx("nodeLabel")
  }, r.getPTOptions("nodeLabel"), {
    onKeydown: e[1] || (e[1] = ge(function() {
    }, ["stop"]))
  }), [n.templates[n.node.type] || n.templates.default ? (s(), f(k(n.templates[n.node.type] || n.templates.default), {
    key: 0,
    node: n.node,
    expanded: r.expanded,
    selected: r.checkboxMode ? r.checked : r.selected
  }, null, 8, ["node", "expanded", "selected"])) : (s(), p(C, {
    key: 1
  }, [J(X(r.label(n.node)), 1)], 64))], 16)], 16, Fe), r.isNextDropPointActive ? (s(), p("div", {
    key: 1,
    class: b(t.cx("dropPoint")),
    "aria-hidden": "true"
  }, null, 2)) : v("", !0), r.hasChildren && r.expanded ? (s(), p("ul", u({
    key: 2,
    class: t.cx("nodeChildren"),
    role: "group"
  }, t.ptm("nodeChildren")), [(s(!0), p(C, null, $(n.node.children, function(g, x) {
    return s(), f(d, {
      key: g.key,
      node: g,
      parentNode: n.node,
      ...
      onNodeDrop: e[10] || (e[10] = function(h) {
        return t.$emit("node-drop", h);
      }),
      onNodeDragenter: e[11] || (e[11] = function(h) {
        return t.$emit("node-dragenter", h);
      }),
      onNodeDragleave: e[12] || (e[12] = function(h) {
        return t.$emit("node-dragleave", h);
      }),
      onValueChange: e[13] || (e[13] = function(h) {
        return t.$emit("value-change", h);
      }),
      unstyled: t.unstyled,
      pt: t.pt
...
function te(t, e) {
  if (t) {
    ...
    var n = {}.toString.call(t).slice(8, -1);
    return n === "Object" && t.constructor && (n = t.constructor.name), n === "Map" || n === "Set" ? Array.from(t) : n === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n) ? L(t, e) : void 0;
  }
}
function He(t) {
  if (typeof Symbol < "u" && t[Symbol.iterator] != null || t["@@iterator"] != null) return Array.from(t);
...
function D(t) {
  for (var e = 1; e < arguments.length; e++) {
    var n = arguments[e] != null ? arguments[e] : {};
    e % 2 ? q(Object(n), !0).forEach(function(o) {
      Re(t, o, n[o]);
    }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(t, Object.getOwnPropertyDescriptors(n)) : q(Object(n)).forEach(function(o) {
      Object.defineProperty(t, o, Object.getOwnPropertyDescriptor(n, o));
    });
  }
  return t;
...
var We = {
  ...
  mounted: function() {
    var e = this;
    this.droppableNodes && (this.dragDropService = we(), this.dragStartCleanup = this.dragDropService.onDragStart(function(n) {
  ...
  methods: {
    onNodeToggle: function(e) {
      var n = e.key;
      this.d_expandedKeys[n] ? (delete this.d_expandedKeys[n], this.$emit("node-collapse", e)) : (this.d_expandedKeys[n] = !0, this.$emit("node-expand", e)), this.d_expandedKeys = D({}, this.d_expandedKeys), this.$emit("update:expandedKeys", this.d_expandedKeys);
    },
    ...
    handleSelectionWithMetaKey: function(e) {
      ...
      return r && i ? (this.isSingleSelectionMode() ? a = {} : (a = D({}, this.selectionKeys), delete a[o.key]), this.$emit("node-unselect", o)) : (this.isSingleSelectionMode() ? a = {} : this.isMultipleSelectionMode() && (a = i ? this.selectionKeys ? D({}, this.selectionKeys) : {} : {}), a[o.key] = !0, this.$emit("node-select", o)), a;
    },
    handleSelectionWithoutMetaKey: function(e) {
      var n = e.node, o = this.isNodeSelected(n), i;
      return this.isSingleSelectionMode() ? o ? (i = {}, this.$emit("node-unselect", n)) : (i = {}, i[n.key] = !0, this.$emit("node-select", n)) : o ? (i = D({}, this.selectionKeys), delete i[n.key], this.$emit("node-unselect", n)) : (i = this.selectionKeys ? D({}, this.selectionKeys) : {}, i[n.key] = !0, this.$emit("node-select", n)), i;
    },
      ...
      if (e) {
        ...
        if (e.children) {
          ...
          try {
            for (r.s(); !(a = r.n()).done; ) {
              var l = a.value, d = D({}, l);
              this.isFilterMatched(d, n) && (o = !0, e.children.push(d));
            }
          } catch (c) {
            r.e(c);
          } finally {
    ...
    isFilterMatched: function(e, n) {
      var o = n.searchFields, i = n.filterText, r = n.strict, a = !1, l = O(o), d;
      try {
        for (l.s(); !(d = l.n()).done; ) {
          var c = d.value, g = String(ie(e, c)).toLocaleLowerCase(this.filterLocale);
          g.indexOf(i) > -1 && (a = !0);
        }
      } catch (x) {
        l.e(x);
  ...
  computed: {
    filteredValue: function() {
      var e = [], n = oe(this.filterBy) ? [this.filterBy] : this.filterBy.split(","), o = this.filterValue.trim().toLocaleLowerCase(this.filterLocale), i = this.filterMode === "strict", r = O(this.value), a;
      try {
        for (r.s(); !(a = r.n()).done; ) {
          var l = a.value, d = D({}, l), c = {
            searchFields: n,
            filterText: o,
            strict: i
          };
          (i && (this.findFilteredNodes(d, c) || this.isFilterMatched(d, c)) || !i && (this.isFilterMatched(d, c) || this.findFilteredNodes(d, c))) && e.push(d);
        }
      } catch (g) {
        r.e(g);
      } finally {
...
function Y(t) {
  for (var e = 1; e < arguments.length; e++) {
    var n = arguments[e] != null ? arguments[e] : {};
    e % 2 ? G(Object(n), !0).forEach(function(o) {
      qe(t, o, n[o]);
    }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(t, Object.getOwnPropertyDescriptors(n)) : G(Object(n)).forEach(function(o) {
      Object.defineProperty(t, o, Object.getOwnPropertyDescriptor(n, o));
    });
  }
  return t;
...
var Ze = ["data-p"], Qe = ["data-p"], Je = ["aria-labelledby", "aria-label"];
function Xe(t, e, n, o, i, r) {
  var a = m("SpinnerIcon"), l = m("InputText"), d = m("SearchIcon"), c = m("InputIcon"), g = m("IconField"), x = m("TreeNode");
  return s(), p("div", u({
    class: t.cx("root"),
    ...
    default: A(function() {
      return [t.loading && t.loadingMode === "mask" ? (s(), p("div", u({
        key: 0,
        class: t.cx("mask")
      }, t.ptm("mask")), [T(t.$slots, "loadingicon", {
        class: b(t.cx("loadingIcon"))
      }, function() {
        return [t.loadingIcon ? (s(), p("i", u({
          key: 0,
          class: [t.cx("loadingIcon"), "pi-spin", t.loadingIcon]
        }, t.ptm("loadingIcon")), null, 16)) : (s(), f(a, u({
          key: 1,
          spin: "",
    ...
    key: 0,
    unstyled: t.unstyled,
    pt: Y(Y({}, t.ptm("pcFilter")), t.ptm("pcFilterContainer")),
    class: b(t.cx("pcFilterContainer"))
  }, {
    default: A(function() {
      return [K(l, {
        modelValue: i.filterValue,
        "onUpdate:modelValue": e[0] || (e[0] = function(h) {
          return i.filterValue = h;
        }),
        autocomplete: "off",
        class: b(t.cx("pcFilterInput")),
        placeholder: t.filterPlaceholder,
        unstyled: t.unstyled,
        onKeyup: r.onFilterKeyup,
        pt: t.ptm("pcFilterInput")
      }, null, 8, ["modelValue", "class", "placeholder", "unstyled", "onKeyup", "pt"]), K(c, {
        unstyled: t.unstyled,
  ...
  }, t.ptm("rootChildren")), [(s(!0), p(C, null, $(r.valueToRender, function(h, ne) {
    return s(), f(x, {
      key: h.key,
      node: h,
