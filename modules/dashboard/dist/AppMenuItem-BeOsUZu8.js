import { X as g, ai as A, Y as B, E as k, a1 as u, H as i, a2 as m, G as f, a6 as v, p as c, a3 as r, I as x, ab as S, a7 as D, F as E, a9 as N, af as F } from "./runtime-dom.esm-bundler-C71lIG0B.js";
import { u as L } from "./layout-Ck1jaogC.js";
import { u as R } from "./main-BuXBcYFI.js";
const W = {
  key: 0,
  ...
  setup(e) {
    const h = R(), { layoutState: d, setActiveMenuItem: I, toggleMenu: M } = L(), s = e, o = g(!1), n = g(null);
    A(() => {
    ...
    return (t, a) => {
      const y = k("router-link"), w = k("app-menu-item", !0);
      return i(), u("li", {
        class: c({ "layout-root-menuitem": e.root, "active-menuitem": o.value })
      }, [
        e.root && e.item.visible !== !1 ? (i(), u("div", W, v(e.item.label), 1)) : m("", !0),
        (!e.item.to || e.item.items) && e.item.visible !== !1 ? (i(), u("a", {
          ...
          r("span", z, v(e.item.label), 1),
          e.item.items ? (i(), u("i", G)) : m("", !0)
        ], 10, j)) : m("", !0),
        e.item.to && !e.item.items && e.item.visible !== !1 ? (i(), f(y, {
          ...
          default: x(() => [
            ...
            r("span", H, v(e.item.label), 1),
            e.item.items ? (i(), u("i", O)) : m("", !0)
          ]),
          _: 1
        }, 8, ["class", "to"])) : m("", !0),
        e.item.items && e.item.visible !== !1 ? (i(), f(S, {
          ...
          default: x(() => [
            D(r("ul", T, [
              (i(!0), u(E, null, N(e.item.items, (l, C) => (i(), f(w, {
                key: l,
                index: C,
                item: l,
