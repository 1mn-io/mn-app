import { s } from "./index-lKnV4MRg.js";
import { B as v } from "./main-HoJjMwWR.js";
const { createElementBlock: a, openBlock: l, mergeProps: p, createCommentVNode: c, renderSlot: u } = window.Vue;
import { f as y } from "./index-BcTfHd3F.js";
var f = `
...
function o(e, i, t) {
  return (i = z(i)) in e ? Object.defineProperty(e, i, { value: t, enumerable: !0, configurable: !0, writable: !0 }) : e[i] = t, e;
}
function z(e) {
  var i = S(e, "string");
  return n(i) == "symbol" ? i : i + "";
}
function S(e, i) {
...
var k = {
  ...
  computed: {
    dataP: function() {
      return y(o(o(o({}, this.align, this.align), this.layout, this.layout), this.type, this.type));
    }
  }
}, P = ["aria-orientation", "data-p"], x = ["data-p"];
function $(e, i, t, r, w, d) {
  return l(), a("div", p({
    class: e.cx("root"),
    style: e.sx("root"),
    role: "separator",
    ...
    "data-p": d.dataP
  }, e.ptmi("root")), [e.$slots.default ? (l(), a("div", p({
    key: 0,
    class: e.cx("content"),
    "data-p": d.dataP
  }, e.ptm("content")), [u(e.$slots, "default")], 16, x)) : c("", !0)], 16, P);
}
k.render = $;
export {
  k as s
