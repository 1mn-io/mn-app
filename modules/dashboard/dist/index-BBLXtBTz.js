import { B as oe, w as B, s as b, R as S, y as ie } from "./main-k5gsV9f8.js";
import { V as p, H as o, W as N, m as u, Z as U, X as I, $ as R, G as g, Y as v, E as d, ae as Z, a0 as z, p as T, F as k, a2 as D, ag as se, J as O, I as $, _ as le } from "./runtime-dom.esm-bundler-CEAeiVlj.js";
import { s as W } from "./index-BqojmDQN.js";
import { s as pe } from "./index-BgtAwlhB.js";
import { s as ue } from "./index-CukqTT7O.js";
var ge = `
    .p-paginator {
        display: flex;
        align-items: center;
...
function Ue(e, t, n, r, i, a) {
  ...
  return o(), p("span", u({
    class: e.cx("pages")
  }, e.ptm("pages")), [(o(!0), p(k, null, D(n.value, function(l) {
    return R((o(), p("button", u({
      key: l,
      class: e.cx("page", {
        pageLink: l
...
function Ye(e, t, n, r, i, a) {
  ...
  return e.alwaysShow || a.pageLinks && a.pageLinks.length > 1 ? (o(), p("nav", le(u({
    key: 0
  }, e.ptmi("paginatorContainer"))), [(o(!0), p(k, null, D(a.templateItems, function(x, M) {
    return o(), p("div", u({
      key: M,
      ref_for: !0,
      ref: "paginator",
      ...
      ref_for: !0
    }, e.ptm("root")), [e.$slots.container ? $(e.$slots, "container", {
      key: 0,
      first: i.d_first + 1,
      last: a.last,
      rows: i.d_rows,
      ...
      ref_for: !0
    }, e.ptm("contentStart")), [$(e.$slots, "start", {
      state: a.currentState
    })], 16)) : O("", !0), N("div", u({
      class: e.cx("content")
    }, {
      ref_for: !0
    }, e.ptm("content")), [(o(!0), p(k, null, D(x, function(h) {
      return o(), p(k, {
        key: h
