import { s as J } from "./index-D0HFIfIx.js";
import { s as X } from "./index-C3dFQVuj.js";
import { s as Z } from "./index-CkLofPOf.js";
import { s as ee } from "./index-JFi7Gene.js";
import { s as te } from "./index-FetBWay4.js";
import { s as le } from "./index-CXfSJiCM.js";
import { s as oe } from "./index-CPOuXgRp.js";
import { s as ae } from "./index-DY40fn-R.js";
import { s as se } from "./index-9Mdthw2i.js";
import { s as ie, a as ne } from "./index-prkcUU1-.js";
import { s as re } from "./index-BqrZ5r-u.js";
import { s as ue } from "./index-B55saars.js";
import { s as de } from "./index-Bbb9yBUj.js";
const { onMounted: ce, ref: u, createElementBlock: y, openBlock: g, createElementVNode: a, createVNode: o, withCtx: n, createTextVNode: V, toDisplayString: $, createCommentVNode: k } = window.Vue;
import { P as me } from "./ProductService-bZb9w0YO.js";
import { a as ve, F as pe } from "./main-HoJjMwWR.js";
const fe = { class: "card" }, ye = { class: "flex flex-wrap gap-2 items-center justify-between" }, ge = ["src", "alt"], be = { class: "flex flex-col gap-6" }, Se = ["src", "alt"], ke = {
  key: 0,
  class: "text-red-500"
}, xe = { class: "grid grid-cols-12 gap-4" }, Ce = { class: "flex items-center gap-2 col-span-6" }, Ve = { class: "flex items-center gap-2 col-span-6" }, we = { class: "flex items-center gap-2 col-span-6" }, Pe = { class: "flex items-center gap-2 col-span-6" }, Ue = { class: "grid grid-cols-12 gap-4" }, Te = { class: "col-span-6" }, $e = { class: "col-span-6" }, Ne = { class: "flex items-center gap-4" }, _e = { key: 0 }, De = { class: "flex items-center gap-4" }, Oe = { key: 0 }, He = {
  __name: "Crud",
  setup(Ie) {
    ce(() => {
      me.getProducts().then((s) => r.value = s);
    });
    const b = ve(), w = u(), r = u(), c = u(!1), v = u(!1), p = u(!1), t = u({}), m = u(), x = u({
      global: { value: null, matchMode: pe.CONTAINS }
    }), f = u(!1), N = u([
    ...
    return (s, e) => {
      const i = de, B = ue, E = ne, U = re, W = ie, d = se, Y = ae, j = oe, Q = le, z = te, G = ee, S = Z, T = X, C = J;
      return g(), y("div", null, [
        a("div", fe, [
          o(B, { class: "mb-6" }, {
            start: n(() => [
          ...
          o(Q, {
            ...
            header: n(() => [
              a("div", ye, [
                e[18] || (e[18] = a("h4", { class: "m-0" }, "Manage Products", -1)),
                o(W, null, {
                  default: n(() => [
                    o(E, null, {
                      default: n(() => [...e[17] || (e[17] = [
        ...
        o(C, {
          ...
          default: n(() => [
            a("div", be, [
              ...
              a("div", null, [
                e[26] || (e[26] = a("span", { class: "block font-bold mb-4" }, "Category", -1)),
                a("div", xe, [
                  a("div", Ce, [
                    o(S, {
                      id: "category1",
                    ...
                    e[22] || (e[22] = a("label", { for: "category1" }, "Accessories", -1))
                  ]),
                  a("div", Ve, [
                    o(S, {
                      id: "category2",
                    ...
                    e[23] || (e[23] = a("label", { for: "category2" }, "Clothing", -1))
                  ]),
                  a("div", we, [
                    o(S, {
                      id: "category3",
                    ...
                    e[24] || (e[24] = a("label", { for: "category3" }, "Electronics", -1))
                  ]),
                  a("div", Pe, [
                    o(S, {
                      id: "category4",
                    ...
                    e[25] || (e[25] = a("label", { for: "category4" }, "Fitness", -1))
                  ])
                ])
              ]),
              a("div", Ue, [
        ...
        o(C, {
          ...
          default: n(() => [
            a("div", Ne, [
              e[31] || (e[31] = a("i", { class: "pi pi-exclamation-triangle text-3xl!" }, null, -1)),
              t.value ? (g(), y("span", _e, [
                e[29] || (e[29] = V("Are you sure you want to delete ", -1)),
                a("b", null, $(t.value.name), 1),
                e[30] || (e[30] = V("?", -1))
              ])) : k("", !0)
            ])
          ]),
        ...
        o(C, {
          ...
          default: n(() => [
            a("div", De, [
              e[32] || (e[32] = a("i", { class: "pi pi-exclamation-triangle text-3xl!" }, null, -1)),
