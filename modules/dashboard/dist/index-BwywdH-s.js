import { B as p, s as v, i as c } from "./main-DmGEeWOh.js";
import { V as a, H as l, J as u, m as s, I as y } from "./runtime-dom.esm-bundler-CEAeiVlj.js";
var f = `
...
var k = {
  ...
  computed: {
    dataP: function() {
      return c(o(o(o({}, this.align, this.align), this.layout, this.layout), this.type, this.type));
    }
  }
...
function $(e, i, t, r, w, d) {
  return l(), a("div", s({
    ...
    class: e.cx("content"),
    "data-p": d.dataP
  }, e.ptm("content")), [y(e.$slots, "default")], 16, x)) : u("", !0)], 16, P);
}
k.render = $;
export {
  k as s
