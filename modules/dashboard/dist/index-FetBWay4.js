const { mergeProps: d, createElementBlock: l, openBlock: s } = window.Vue;
import { a as u } from "./index-BqrZ5r-u.js";
import { B as p } from "./main-HoJjMwWR.js";
import { f as c } from "./index-BcTfHd3F.js";
var f = `
    .p-textarea {
        font-family: inherit;
  ...
  methods: {
    resize: function() {
      if (this.$el.offsetParent) {
        var e = this.$el.style.height, n = parseInt(e) || 0, r = this.$el.scrollHeight, o = !n || r > n, a = n && r < n;
        a ? (this.$el.style.height = "auto", this.$el.style.height = "".concat(this.$el.scrollHeight, "px")) : o && (this.$el.style.height = "".concat(r, "px"));
      }
    },
    onInput: function(e) {
