...
import * as Vue from "https://cdn.jsdelivr.net/npm/vue@latest/dist/vue.esm-browser.prod.js"; window.Vue = Vue; 
      ...
      "data": {
        ...
        "routes": [
          ...
          },*/
          {
            ...
            //"component": "../views/ContentEngineIframe.vue",
            "meta": {
              "ce_file": "https://raw.githubusercontent.com/1mn-io/mn-app/main/modules/supplier_pdt_frag/dist/data.json",
              /*"ce_file": {
                "config": {
                  "lazy_lib": {
                    "renderer_src": "http://localhost:5174/src/renderer/index.ts",
                    "hydrator_src": "http://localhost:5174/src/hydrator/index.ts",
                    "editor_src": "http://localhost:5174/src/editor/index.ts",
                    "custom_src": "http://localhost:5174/src/custom/index.ts"
                  }
                },
                "data": {
                  "l": [
                    {
                      "id": "hgd78c-supplier_pdt_frag",
                      "type": "supplier_pdt_frag",
                      "slug": "supplier_pdt_frag",
                      "data": {
                        "data": "Hello world! ",
                        "api": {
                          "list": {
                            "url": "https://fastapi.dryutil.1mn.io/client/api/i/ona/supplier_pdt?action=list_product",
                            "headers": {
                          ...
                          "delete": {
                            "url": "https://fastapi.dryutil.1mn.io/client/api/i/ona/supplier_pdt?action=delete_product",
                            "headers": {
                              "accept": "application/json",
                              "Content-Type": "application/json",
                              "Authorization": "{localStorage.token}"
