import { g as N, s as _, c as B, a as E, b as C, i as g, N as b, e as V, f as h, F as M, S as j, C as U, h as F, T as H, j as c, k as S, m as L, l as O, n as P, o as I, p as D, q as W, r as G, t as K, u as q, v as J, w as Q, x as X, y as Y, z as Z, A as ee, B as te, d as re, D as ie } from "./runtime-dom.esm-bundler-TRF-LAC0.js";
function ne(e, t) {
  t === void 0 && (t = {});
  var i = t.insertAt;
...
function se(e, t) {
  ...
  for (let r in e) {
    ...
    r.startsWith("."))
      continue;
    const n = e[r];
    r.startsWith("^") && (r = r.slice(1)), r === "class" || r === "className" ? i += ` class="${de(n)}"` : r === "style" ? i += ` style="${fe(n)}"` : i += le(r, n, t);
  }
  return i;
}
function le(e, t, i) {
...
function k(e, t) {
  ...
  if (V(i)) {
    ...
    (!e.render || e.render === b) && !e.ssrRender && !i.ssrRender && h(i.template) && (i.ssrRender = he(i.template));
...
function w(e, t, i, r) {
  ...
  switch (s && (t.props = be(t, d, s)), n) {
    ...
    case M:
      ...
      break;
    default:
      o & 1 ? we(e, t, i, r) : o & 6 ? e(T(t, i, r)) : o & 64 ? ye(e, t, i, r) : o & 128 && w(e, t.ssContent, i, r);
  }
}
function y(e, t, i, r) {
