import { g as B, s as _, f as N, h as E, i as C, j as b, N as y, k as V, l as u, F as M, S as j, C as H, m as L, T as U, n as f, p as S, q as F, t as I, u as O, v as P, w as D, x as G, y as W, z as K, A as q, B as J, D as Q, E as X, G as Y, H as Z, I as ee, J as te, d as re, c as oe, e as ie, K as ae, a as ne, L as le } from "./runtime-dom.esm-bundler-BQkxs8ZT.js";
function se(e, t) {
  t === void 0 && (t = {});
  var o = t.insertAt;
...
function pe(e, t) {
  let o = "";
  for (let r in e) {
    if (de(r) || P(r) || t === "textarea" && r === "value" || // force as property (not rendered in SSR)
    r.startsWith("."))
      continue;
    const i = e[r];
...
async function $(e, t = {}) {
  ...
  o.appContext = e._context, e.provide(C, t);
