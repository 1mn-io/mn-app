...
function dr(e) {
  try {
    ...
    Pe = -1, ue.length = 0, zt(), Qt = null, (ue.length || ut.length) && dr();
  }
}
let De = null, pr = null;
function Pt(e) {
...
function at(e, t, s, n, r = !1) {
  ...
  const i = n.shapeFlag & 4 ? tn(n.component) : n.el, l = r ? null : i, { i: c, r: f } = e, d = t && t.r, a = c.refs === Q ? c.refs = {} : c.refs, m = c.setupState, w = /* @__PURE__ */ B(m), E = m === Q ? Vn : (F) => dn(a, F) ? !1 : W(w, F), K = (F, z) => !(z && dn(a, z));
  if (d != null && d !== f) {
    if (pn(t), re(d))
...
function El(e) {
  ...
  if (Os = !0, i)
    for (const $ in i) {
      const M = i[$], ee = N(M) ? M.bind(s, s) : N(M.get) ? M.get.bind(s, s) : He, jt = !N(M) && N(M.set) ? M.set.bind(s) : He, Ze = oo({
        get: ee,
        set: jt
      });
...
function Hr(e, t) {
  ...
  const {
    ...
    let I;
    if (h && Qe(h, !1), (I = O.onVnodeBeforeUpdate) && Se(I, h, u, o), P && Re(u, o, h, "beforeUpdate"), h && Qe(h, !0), (C.innerHTML && O.innerHTML == null || C.textContent && O.textContent == null) && a(T, ""), y ? H(
      o.dynamicChildren,
      y,
      T,
      h,
