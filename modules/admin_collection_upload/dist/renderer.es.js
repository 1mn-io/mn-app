import { j as B, i as E, k as N, s as _, l as C, m as g, N as b, p as V, q as u, F as M, S as j, C as H, u as L, T as O, v as c, x as P, y as U, z as S, A as F, B as I, D, E as G, G as W, H as K, I as q, J, K as Q, L as X, M as Y, O as Z, P as ee, Q as te, d as re, e as ie, c as oe, R as ne } from "./runtime-dom.esm-bundler-C0Lv14Pw.js";
function se(e, t) {
  t === void 0 && (t = {});
  var r = t.insertAt;
...
function de(e, t) {
  ...
  for (let i in e) {
    ...
    i.startsWith("."))
      continue;
    const o = e[i];
    i.startsWith("^") && (i = i.slice(1)), i === "class" ? r += ` class="${pe(o)}"` : i === "style" ? r += ` style="${ce(o)}"` : i === "className" ? o != null && (r += ` class="${c(String(o))}"`) : r += fe(i, o, t);
  }
  return r;
}
function fe(e, t, r) {
...
function ye(e, t, r, i) {
  const o = t.type;
  let { props: n, children: s, shapeFlag: a, scopeId: d } = t, p = `<${o}`;
  n && (p += de(n, o)), d && (p += ` ${d}`);
  let f = r, l = t;
  for (; f && l === f.subTree; )
  ...
  if (i && (p += ` ${i}`), e(p + ">"), !U(o)) {
    let h = !1;
    n && (n.innerHTML ? (h = !0, e(n.innerHTML)) : n.textContent ? (h = !0, e(c(n.textContent))) : o === "textarea" && n.value && (h = !0, e(c(n.value)))), h || (a & 8 ? e(c(s)) : a & 16 && y(
      e,
      s,
      r,
      i
