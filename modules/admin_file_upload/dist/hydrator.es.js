import { r as ot, g as hr, o as Gr, n as rt, w as ko, a as Q, b as et, d as tt, c as Jo, e as Xo, f as Yo, h as br, t as nt, F as at, i as it } from "./runtime-dom.esm-bundler-faV4Hw4m.js";
...
const N0 = Ho("string"), L = Ho("function"), be = Ho("number"), So = (o) => o !== null && typeof o == "object", z0 = (o) => o === !0 || o === !1, Do = (o) => {
  if (Mo(o) !== "object")
    return !1;
  const r = dr(o);
...
function qo(o, r, e) {
  ...
  function d(f, h, p) {
    ...
    if (f && !p && typeof f == "object") {
      ...
      else if (u.isArray(f) && bg(f) || (u.isFileList(f) || u.endsWith(h, "[]")) && (y = u.toArray(f)))
    ...
    return Gr(() => {
      (async () => {
        ...
        (async () => _0("child:msg", async (f) => {
          ...
          document.head.appendChild(h), h.innerHTML = l, setTimeout(async () => {
            const p = await m.set({
              data: s
            });
            console.log(p);
